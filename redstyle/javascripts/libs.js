...
Tc.Config = {
     ...
     */
    dependencyPath: {
        library: 'js/libraries/dynamic/default.htm',
        plugin: 'js/plugins/dynamic/default.htm',
        util: 'js/utils/dynamic/default.htm'
    }
};
  ...
  Foundation.libs.dropdown = {
    ...
    css : function (dropdown, target) {
      ...
      if (this.small()) {
        ...
        dropdown.css(Foundation.rtl ? 'right':'left', '2.5_25');
      } else {
