...
jQuery(document).ready(function() {	
	...
	var interval = getRandomInt(5000, 30000);
	setInterval(animate_call, interval);
	
	
	function animate_call() {				
		$( "#snake" ).effect("shake");
	}
});
...
/*jQuery(document).ready(function() {
	...
	$(".member").rotate({
	  ...
	  {
		mouseover : function() {
		$(this).find("img").rotate({animateTo:90, duration:2000})			
	  },
	  mouseout : function() {
		$(this).find("img").rotate({animateTo:0, duration:2000})
		}
	  }
