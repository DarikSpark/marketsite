...
<html class='no-js'>
  ...
  <head>
    ...
    -->
    <title>404</title>
    <link href="framework.css" media="screen" rel="stylesheet" type="text/css" />
	<link rel="stylesheet" href="../../../code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
	<link href="animate.css" media="screen" rel="stylesheet" type="text/css" />
    <link href="style.css" media="screen" rel="stylesheet" type="text/css" />
    <link href="skins.css" media="screen" rel="stylesheet" type="text/css" />
    <link href="fontello.css" media="screen" rel="stylesheet" type="text/css" />
    ...
    <script>
      ...
      (function($) {
          $(document).ready(function() {
              ...
              var config = {
                dependencyPath: {
                  plugin: '../javascripts/default.htm'
                }
              }
...
<div class='footer-news'>
  <h3><a href="../../novosti/sistemyi-onlajn-oplatyi/default.htm">Системы онлайн оплаты</a></h3>
	...
	<script type="text/javascript" src="../javascripts/elevator.min.js"></script>
	<script>
	...
	<!-- {/literal} END JIVOSITE CODE -->
	 ...
	 <a href="Copyright%20(C)%202014%20by%20original%20authors%20_40%20fontello.com#modal" class="overlay_modal" id="modalWindow" onclick="resets()"></a>
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		<h2 id="head">Оставить заявку</h2>
		<a href="Copyright%20(C)%202014%20by%20original%20authors%20_40%20fontello.com" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
