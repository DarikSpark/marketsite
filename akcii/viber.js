...
<div class='footer-news'>
  <h3><a href="novosti/sistemyi-onlajn-oplatyi/">Системы онлайн оплаты</a></h3>
	...
	<!-- {/literal} END JIVOSITE CODE -->
	 ...
	 <a href="/akcii/viber.js#modal" class="overlay_modal" id="modalWindow" onclick="resets()"></a>
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		<h2 id="head">Оставить заявку</h2>
		<a href="/akcii/viber.js" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
