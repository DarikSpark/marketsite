...
<html class='no-js'>
  ...
  <head>
    ...
    <script>
      ...
      (function($) {
          $(document).ready(function() {
              ...
              var config = {
                dependencyPath: {
                  plugin: '//redline.by/redstyle/javascripts/'
                }
              }
	...
	<link href='//fonts.googleapis.com/css?family=Tinos:400italic&subset=latin,cyrillic' rel='stylesheet' type='text/css'>
...
<div class="phone-block2">
  ...
  <span itemprop="telephone" class="skype"><i class="fa fa-skype"></i><a href="skype:redlineby.ivanov?chat">redlineby.ivanov</a></span>
</div>
<div class="call-back">
<div id="snake">
...
<li>
  <a class="active" href='portfolio/'>Наши работы <span class="caret"></span></a>
...
<li class='has-dropdown'>
  <a class="active" href='uslugi/'>Наши услуги <span class="caret"></span></a>
  <ul class='dropdown m-menu'><li><div class="row">
	<div class="medium-3 column">
  <h3><a href='uslugi/razrabotka-sajtov/'>Разработка сайтов</a></h3>
  <ul>
	<li>
...
<li>
  <a href='uslugi/razrabotka-sajtov/korporativnyij-sajt/'>Корпоративный сайт</a>
</li>
<li>
...
<div class="medium-3 column">
  <h3><a href='uslugi/prodvizhenie-sajtov/'>Продвижение сайтов</a></h3>
  <ul>
	<li>
...
<div class="medium-3 column">
  <h3><a href='uslugi/dizajn-i-grafika/'>Дизайн и графика</a></h3>
  <ul>
	<li>
  <a href='uslugi/dizajn-i-grafika/razrabotka-firmennogo-stilya/'>Фирменный стиль</a>
</li>
<li>
...
<li>
  <a class="active" href='novosti/'>Наш блог <span class="caret"></span></a>
...
<a href="akcii.html" class="action-btn">Акции!</a>
	...
	<div class='full padding-bottom-0 '>
	  ...
	  <ul class="B_crumbBox"><li class="B_firstCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_homeCrumb" itemprop="url" rel="Home" href="http://redline.by/"><span itemprop="title">Главная</span></a></li>
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">404</li></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div >
				<div class="mistake centered-text">
             	 	<h1>404</h1>
					<p>Запрашеваемая страница не найдена :(</p>
					<a class="one_click button" onclick="javascript:history.back();">&larr; назад</a>
				</div>
            </div>
          </div>
...
<div class='footer-news'>
  <h3><a href="novosti/sistemyi-onlajn-oplatyi/">Системы онлайн оплаты</a></h3>
</div>
        </div>
        ...
        <div class='medium-6 large-6 columns centered-text'>
          ...
          <div class='socials centered-text'>
			...
			<a href="http://redline.by/rss-novostej.rss" title="RSS REDLINE">
        ...
        <div class="medium-3 large-3 columns">
			...
			<h3 class="footer-title">Публичные договоры</h3>
				<div class="footer-news">
					...
					<h3 style="text-align: left;"><a href="vakansii/">Вакансии <span class="caret"></span></a></h3>
	...
	<!-- {/literal} END JIVOSITE CODE -->
	 ...
	 <a href="/akcii/odnoklassniki.js#modal" class="overlay_modal" id="modalWindow" onclick="resets()"></a>
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		<h2 id="head">Оставить заявку</h2>
		<a href="/akcii/odnoklassniki.js" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="">
		  ...
		  <input type="hidden" name="place" value="404">
