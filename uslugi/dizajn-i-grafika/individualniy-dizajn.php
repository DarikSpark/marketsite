...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Разработка индивидуального дизайна сайта специалистами нашей компании включает стилевой единство цветовой гаммы, шрифтов и изображений. Мы продумаем каждую мелочь и учтем все Ваши пожелания." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Заказать разработку индивидуальный дизайна веб сайта | студия REDLINE</title>
...
<div class="medium-3 column">
  <h3><a href='default.htm'>Дизайн и графика</a></h3>
  <ul>
	<li>
  <a href='razrabotka-firmennogo-stilya/default.htm'>Фирменный стиль</a>
</li>
<li>
  <a href='razrabotka-logotipa.html'>Логотип</a>
</li>
<li>
  <a href='razrabotka-dizajn-maketa-v-psd.html'>Разработка дизайна</a>
</li>
<li>
  <a href='sozdanie-statichnyix-bannerov.html'>Создание баннеров</a>
</li>
  </ul>
</div><!--end of .column-->
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="Дизайн и графика" href="default.htm"><span itemprop="title">Дизайн и графика</span></a></li>
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Индивидуальный дизайн</li></li>
</ul>

	   <div class='special-title centered-text'>
          <!--<i class='fa fa-desktop'></i>-->
          <h1>Индивидуальный дизайн</h1>
          <p> Разработка индивидуальный дизайн веб  сайта</p>
          <p class='shortline'></p>
        </div>
		  ...
		  <!--<div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                  ...
                  <img alt='Индивидуальный дизайн' src='../../assets/cache_image/resources/news/16/03/bg_1600x400_c45.jpg'>
                
              </p>
              <p align="justify">Именно внешний вид сайта заставляет клиента задержаться и рассмотреть Ваши предложения – поэтому так важно создать стильный и запоминающийся дизайн. Готовые шаблоны не всегда справляются с такой задачей, к тому же существует риск встретить сайт-двойник. Только разработка индивидуального дизайна позволяет:</p>
<ul>
<li>Сохранить узнаваемый корпоративный стиль</li>
<li>Сделать навигацию интуитивно понятной пользователю</li>
<li>Предусмотреть все нюансы создания сайта Вашей тематики</li>
<li>Гармонично сочетать информационную наполненность с эргономикой и навигацией</li>
<li>Гарантированно получить сайт, разработанный с помощью самых современных технологий</li>
</ul>
<p align="justify">Эксклюзивный дизайн положительно влияет на имидж компании, а фирменный логотип дает возможность легко узнать Вас среди анонимных конкурентов. Разработка индивидуального дизайна сайта специалистами нашей компании включает стилевой единство цветовой гаммы, шрифтов и изображений. Мы продумаем каждую мелочь и учтем все Ваши пожелания. Опытный дизайнер и грамотный маркетолог посоветуют наиболее эффективное решение дизайна сайта. В разработке индивидуального дизайна мы придерживаемся правил лаконичности, удобства и респектабельности. Каждый информационный блок займет нужное место. Легкость восприятия обеспечит оптимальное сочетание изображений и текста. Оптимизированный индивидуальный дизайн повысит Вашу конкурентоспособность.</p>
<blockquote>
<h4 align="justify">Разработка индивидуального дизайна это долгосрочное вложение в рекламу и эффективность Вашего бизнеса.</h4>
</blockquote>
            </div>
          </div>
	...
	<div class='full padding-top-0'>
      <div class='row'>
        <div class='large-10 small-centered columns'>
          <div class='special-title centered-text'>
            <i class='icon-mail'></i>
            <h2>Заказать сайт</h2>
            <p>Вы можете заказть сайт используя форму ниже, либо связаться с нами по указанным телефонам.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class='full form-bg'>
	  ...
	  <a name='form_button'></a>
        <div class='row'>
          ...
          <form method='POST' action="#form_button">
            ...
            <div class='medium-6 large-6 columns'>
              ...
              <input class='required' name='name' placeholder='ВАШЕ ИМЯ' type='text' value=""/>
				
              <input class='required email' name='email' placeholder='ВАШ EMAIL' type='text' value=""/>
				
              <input class='required' name='subject' type='text'  value="Индивидуальный дизайн" readonly='readonly'/>
            ...
            <div class='medium-6 large-6 columns'>
              ...
              <input class='button white' type='submit' value="Заказать">
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="individualniy-dizajn.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Индивидуальный дизайн">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='individualniy-dizajn.html';
