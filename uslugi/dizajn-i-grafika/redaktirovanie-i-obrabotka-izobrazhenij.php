...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Зачастую, сайты содержат не только текстовый но и графический контент. Изображения приковывают внимание посетителя, заставляя подольше оставаться на сайте, и в конечном итоге совершить покупку. В распоряжении нашей студии множество специалистов, которые имеют большой опыт работы с популярными фоторедакторами, такими как:  Adobe Photoshop; CorelDRAW и некоторыми другими." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Услуга - Редактирование и обработка изображений | студия веб дизайна Redline</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/03/01/Редактирование и обработка изображений.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Работа с изображениями"/>
<meta property="og:url" content="http://redline.by/uslugi/dizajn-i-grafika/redaktirovanie-i-obrabotka-izobrazhenij.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Работа с изображениями</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Редактирование и обработка изображений на сайте</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='redaktirovanie-i-obrabotka-izobrazhenij.html'>
                  <img alt='Работа с изображениями' src='../../assets/cache_image/resources/news/16/03/01/ _25D0_25B8 _25D0_25BE_25D0_25B1_25D1_2580_25D0_25B0_25D0_25B1_25D0_25BE_25D1_2582_25D0_25BA_25D0_25_095F6E7770'>
                </a>
              </p>
              <p align="justify">Зачастую, сайты содержат не только текстовый но и графический контент. Изображения приковывают внимание посетителя, заставляя подольше оставаться на сайте, и в конечном итоге совершить покупку. В распоряжении нашей студии множество специалистов, которые имеют большой опыт работы с популярными фоторедакторами, такими как:</p>
<ul>
<li>Adobe Photoshop;</li>
<li>CorelDRAW и некоторыми другими.</li>
</ul>
<p align="justify">Заказав редактирование и обработку изображений в нашей веб-студии, мы:</p>
<ul>
<li>Устраним все шумы и дефекты;</li>
<li>Устраним битые пиксели;</li>
<li>Отредактируем тон;</li>
<li>Удалим лишние объекты;</li>
<li>Применим различные спецэффекты, а также многое другое.</li>
</ul>
<p align="justify">На выходе, вы получите изображения, которые будут привлекать потенциального клиента, что положительно отразится на поведенческих факторах сайта, а это, в свою очередь, обеспечит высокое ранжирование ресурса в поисковых системах.</p>
			  <p><a class="button" onclick="sub_name('Работа с изображениями','pikt')" href="#modalWindow">Заказать  обработку изображений</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="redaktirovanie-i-obrabotka-izobrazhenij.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Работа с изображениями">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='redaktirovanie-i-obrabotka-izobrazhenij.html';
