...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Презентация – один из самых старых и распространенных маркетинговых ходов. Мы предлагаем услугу по созданию продающих презентаций" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Создание продающих презентаций</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/business-presentation-banner.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Создание продающих презентаций"/>
<meta property="og:url" content="http://redline.by/uslugi/dopolnitelnyie-uslugi/sozdanie-prodayushhix-prezentaczij.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Создание продающих презентаций</li></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='sozdanie-prodayushhix-prezentaczij.html'>
                  <img alt='Создание продающих презентаций' src='../../assets/cache_image/resources/news/16/02/17/business-presentation-banner_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Презентация – один из самых старых и распространенных маркетинговых ходов. Как правило, презентации бывают следующих видов:</p>
<ul>
<li>Бумажные;</li>
<li>Электронные;</li>
<li>В виде публичного выступления.</li>
</ul>
<p align="justify">Основным минусом большинства презентаций становится переизбыток неинтересной информации, которая никак не поможет вам продать товар или услугу. Неправильно составленная презентация не только отпугнет потенциальных клиентов, но и может навредить имиджу вашей компании.</p>
<p align="justify">Специально для таких случаев, мы предлагаем услугу по созданию продающих презентаций. Наши презентации помогут создать положительный имидж и увеличить продажи. Специалисты нашей веб-студии используют только самые актуальные маркетинговые ходы, анализируют целевую аудиторию и уровень конкуренции, что позволяет получить на выходе продукт, который заставит потенциальных клиентов обратиться именно к вам.</p>
			  <p><a class="button" onclick="sub_name('Создание продающих презентаций','pikt')" href="#modalWindow">Заказать создание продающей презентации</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="sozdanie-prodayushhix-prezentaczij.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Создание продающих презентаций">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='sozdanie-prodayushhix-prezentaczij.html';
