...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Техническая поддержка сайта включает комплекс работ - Наполнение сайтов, администрирование сайтов, сопровождение сайтов, доработка сайтов, наполнение сайта контентом. Веб студия REDLINE" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Техническая поддержка сайта - Наполнение сайтов, администрирование сайтов, сопровождение сайтов  | веб студия REDLINE</title>
...
<li class='has-dropdown'>
  ...
  <h3><a href='../razrabotka-sajtov/default.htm'>Разработка сайтов</a></h3>
  <ul>
	<li>
  <a href='../razrabotka-sajtov/sajt-vizitka.html'>Сайт визитка</a>
</li>
<li>
  <a href='../razrabotka-sajtov/lending.html'>Landing Page</a>
</li>
<li>
  <a href='../razrabotka-sajtov/internet-magazin.html'>Интернет-магазин</a>
</li>
<li>
  <a href='../razrabotka-sajtov/korporativnyij-sajt/default.htm'>Корпоративный сайт</a>
</li>
<li>
  <a href='../razrabotka-sajtov/adaptivnaya-verstka.html'>Мобильная адаптация</a>
</li>
  </ul>
</div><!--end of .column-->
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Поддержка сайтов" href="podderzhka-sajtov.html"><span itemprop="title">Поддержка сайтов</span></a></li>
</ul>

	   <div class='special-title centered-text'>
          <!--<i class='fa fa-desktop'></i>-->
          <div class="main-title">
			  <h1>Техническая поддержка сайтов</h1>
		  </div>
          <p class='shortline'></p>
        </div>
	  ...
	  <div class='row'>
            <div class='large-4 columns'>
              <img alt='' class='fadeinleft' src='../../redstyle/stylesheets/images/support.png'>
            </div>
            <div class='large-8 columns fadeinright'>    
                <p>
                    Залог успешного функционирования сайта заключается в его своевременной и профессиональной поддержке. Обусловлено это тем, что абсолютно любой сайт нуждается в систематическом обновлении информации, модернизации функционала и оперативном реагировании на изменения алгоритмов актуальных поисковых систем.                 
    			</p>
    			<div class='spacing'></div>
    			<a class='button' href='#modalWindow' onclick="sub_name('Заказ сайта - Счетчик','count')">Поддержать сайт!</a>    
            </div>	
     </div> 
    ...
    <div class='full white'>
          <div class='row'>
            <div class='medium-12 large-12 columns'>
              <div class='special-title centered-text'>
                  <h2>Информационная поддержка и техническая</h2>
                  <p></p>
        		  <p class='shortline'></p>
                  <div class='two spacing'></div>
              </div>
              ...
              <!--=== Tabs ===-->
              <div class='members tabs-member'>      
                  <div class='full no-padding'>
                    <div class='row'>
                      <div class='medium-6 large-6 columns'>
                        <div class='member centered-text active' data-target='#support-1'>
                          <h4><i class="fa fa-cogs"></i>&ensp; Техническая поддержка</h4>
                          <p class='active-line'></p>
                        </div>
                      </div>
                      <div class='medium-6 large-6 columns'>
                        <div class='member centered-text' data-target='#support-2'>
                          <h4><i class="fa fa-life-ring"></i>&ensp; Информационная поддержка</h4>
                          <p class='active-line'></p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class='full no-padding'>
                    <div class='two spacing'></div>
                    <div class='row'>
                          <div class='member-intro active' id='support-1'>
                            <div class='columns'>
                              <p>
                                Под технической поддержкой понимают:<br />
                                - размещение сайтов на надежных серверах, заслуживающих доверия;<br />
                                - сохранение и периодическое обновление информации и данных на внешних носителях;<br />
                                - систематический анализ работоспособности программного обеспечения и скриптов;<br />
                                - контроль работы сайта и мгновенное реагирование на перерывы в работе.<br /><br />
                                Однако техническая поддержка без информационной будет недостаточно результативной. Для эффективной работы сайта с постоянным поддержанием его в топовых позициях необходимо проводить информационную поддержку.
                              </p>
    						  <a class='button' href='#modalWindow' onclick="sub_name('Заказ сайта - Счетчик','count')">Заказать услугу</a>
                            </div>
                            
                          </div>
                          <div class='member-intro' id='support-2'>
                            <div class='columns'>
                              <p>
                                Наша фирма заключает договора на разовую информационную поддержку либо абонентское обслуживание.<br />
                                Такое сопровождение включает в себя:<br />                                
                                    - возможность периодического обновления контента на сайте (новостные ленты, каталоги продукции и услуг, сезонные акции, реализация на особых условиях);<br />
                                    - совершенствование навигации, структуры, добавление новых модулей и функционала;<br />
                                    - закрепление за сайтом специального менеджера, полностью отвечающего за данный проект.<br /><br />                          
                                Что вы получаете при заказе информационной поддержки?<br />                                
                                    - добавление на ваш сайт уникального и востребованного контента, своевременное обновление данных;<br />
                                    - персонального управляющего, ведущего ваш проект;<br />
                                    - модернизацию сайта посредством графического и функционального редактирования. 
                              </p>
    						  <a class='button' href='#modalWindow' onclick="sub_name('Заказ сайта - Счетчик','count')">Заказать услугу</a>
                            </div>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="podderzhka-sajtov.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Поддержка сайтов">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='podderzhka-sajtov.html';
