...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Удобная система расчета позволит выделиться среди других интернет-магазинов. В отличие от банковских переводов, большинство платежных систем позволяют моментально получить денежные средства." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Подключение платежной системы для сайта</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/robo.gif"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Подключение платежной системы для сайта"/>
<meta property="og:url" content="http://redline.by/uslugi/dopolnitelnyie-uslugi/podklyuchenie-platezhnoj-sistemyi-dlya-sajta.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Подключение платежной системы для сайта</li></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='podklyuchenie-platezhnoj-sistemyi-dlya-sajta.html'>
                  <img alt='Подключение платежной системы для сайта' src='../../assets/cache_image/resources/news/16/02/17/robo_1600x487_132.gif'>
                </a>
              </p>
              <p align="justify">Если у вас есть сайт, с помощью которого вы собираетесь продавать товары или услуги, то вам обязательно потребуется прикрутить к нему одну из платежных систем. С помощью нее, вы предоставляете возможность клиентам оплатить определенный товар или пополнить счет в личном кабинете. Для большего удобства посетителей вы можете подключить сразу несколько платежных систем.</p>
<p align="justify">Очень важно подобрать правильную систему, которая подойдет именно для вашего проекта. Ведь удобная система расчета позволит выделиться среди других интернет-магазинов. Кроме того, в отличие от банковских переводов, большинство платежных систем позволяют моментально получить денежные средства.</p>
<p style="text-align: center;" align="justify"><img title="Подключение платежной системы для сайта" src="../../resources/news/16/02/17/6a9c31a9c1.jpg" alt="Подключение платежной системы для сайта" width="500" height="283" /></p>
<p align="justify">Обратившись в нашу веб-студию, мы установим надежную систему оплаты и ответим на все возникшие вопросы в режиме живого диалога.</p>
			  <p><a class="button" onclick="sub_name('Подключение платежной системы для сайта','pikt')" href="#modalWindow">Подключить платежную систему</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="podklyuchenie-platezhnoj-sistemyi-dlya-sajta.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Подключение платежной системы для сайта">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='podklyuchenie-platezhnoj-sistemyi-dlya-sajta.html';
