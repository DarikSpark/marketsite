...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Мы поможем наполнить сайт уникальным, качественным и, самое главное, полезным контентом, который позволит привлечь дополнительную целевую аудиторию и, соответственно, увеличить ваши доходы.  " />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Услуги копирайтинга и рерайтинга</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/copywriting.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Услуги копирайтинга и рерайтинга"/>
<meta property="og:url" content="http://redline.by/uslugi/dopolnitelnyie-uslugi/uslugi-kopirajtinga-i-rerajtinga.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Услуги копирайтинга и рерайтинга</li></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='uslugi-kopirajtinga-i-rerajtinga.html'>
                  <img alt='Услуги копирайтинга и рерайтинга' src='../../assets/cache_image/resources/news/16/02/17/copywriting_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Основой успеха любого сайта является полезный контент. Однако не каждый способен писать статьи для своего проекта самостоятельно, так как этот процесс отнимает много времени и сил. Кроме того, нужно не просто добавлять контент, но и делать его оптимизированным для поисковых систем, иначе ваши тексты просто никто не увидит. Именно для таких случаев, мы предлагаем воспользоваться нашей услугой по наполнению сайтов. Мы работаем с двумя традиционными видами текстов - копирайт и рерайт.</p>
<ol>
<li><strong> Рерайт</strong> – уникальный для поисковых систем текст, который переписан из различных источников. </li>
<li><strong>Копирайт</strong> – уникальный для поисковых систем текст, который пишется с нуля.</li>
</ol>
<p align="justify">Как правило, рерайт выглядит менее качественным в глазах поисковиков, поэтому мы рекомендуем выбрать написание текста с нуля. Однако, если ваш бюджет ограничен, то рерайт станет оптимальным выбором. Стоит отметить, что мы создаем контент, который нравится не только поисковым системам, но и посетителям вашего ресурса. Именно качественный контент заставляет пользователя подольше задержаться на сайте и побуждает совершить определенное действие (например, покупку товара).</p>
<p align="justify">Обратившись в нашу веб-студию, мы поможем наполнить сайт уникальным, качественным и, самое главное, полезным контентом, который позволит привлечь дополнительную целевую аудиторию и, соответственно, увеличить ваши доходы.  </p>
			  <p><a class="button" onclick="sub_name('Услуги копирайтинга и рерайтинга','pikt')" href="#modalWindow">Заказать услуги копирайтинга и рерайтинга</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="uslugi-kopirajtinga-i-rerajtinga.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Услуги копирайтинга и рерайтинга">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='uslugi-kopirajtinga-i-rerajtinga.html';
