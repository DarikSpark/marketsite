...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="В нашей компании работают профессиональные переводчики, которые имеют за спиной большой опыт перевода разнообразного контента, начиная от общетематических текстов и заканчивая узкоспециализированными." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Перевод с иностранных языков</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/AAEAAQAAAAAAAAbdAAAAJGEwZTlkYjVjLTRjNjUtNDQwMC1iYzZkLTU1NjIwMmYyYTBmOA.png"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Перевод с иностранных языков"/>
<meta property="og:url" content="http://redline.by/uslugi/dopolnitelnyie-uslugi/perevod-s-inostrannyix-yazyikov.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Перевод с иностранных языков</li></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='perevod-s-inostrannyix-yazyikov.html'>
                  <img alt='Перевод с иностранных языков' src='../../assets/cache_image/resources/news/16/02/17/AAEAAQAAAAAAAAbdAAAAJGEwZTlkYjVjLTRjNjUtNDQwMC1iYzZkLTU1NjIwMmYyYTBmOA_1600x487_9c7.png'>
                </a>
              </p>
              <p align="justify">Мы предлагаем услуги перевода с иностранных языков. В нашей компании работают профессиональные переводчики, которые имеют за спиной большой опыт перевода разнообразного контента, начиная от общетематических текстов и заканчивая узкоспециализированными. Кроме того, мы не только переводим тексты, но и делаем их оптимизированными для поисковых систем. Наши переводчики имеют опыт работы с:</p>
<ul>
<li>Техническими текстами;</li>
<li>Юридическими;</li>
<li>Финансовыми;</li>
<li>Строительными;</li>
<li>Медицинскими;</li>
<li>Художественными и многими другими.</li>
</ul>
<p align="justify">Кроме того, мы занимаемся редактированием уже существующих текстов, а также их форматированием (добавление подзаголовков, маркированных списков, выделение ключевых моментов в тексте и др.).</p>
<p style="text-align: center;" align="justify"><img title="Перевод с иностранных языков" src="../../resources/news/16/02/17/_25D0_25A3_25D1_2581_25D0_25BB_25D1_2583_25D0_25B3_25D0_25B8%20_25D0_25BF_25D0_25B5_25D1_2580_25D0_25B5_25D0_25B2_25D0_25BE_25D0_25B4_25D0_25B0.jpg" alt="Перевод с иностранных языков" width="620" height="374" /></p>
<p align="justify">Переводчики нашей веб-студии смогут перевести текст на любой язык. В первую очередь, это необходимо для продвижения ваших услуг на зарубежном рынке. Если необходим перевод каких-либо страниц сайта, то мы переведем все элементы (включая всплывающие окна). При написании текстов мы учитываем особенности целевой аудитории и индивидуально подходим к каждому клиенту. Благодаря нам, ваш проект получит дополнительную аудиторию из-за рубежа, что, свою очередь, положительно отразится на ваших доходах.</p>
			  <p><a class="button" onclick="sub_name('Перевод с иностранных языков','pikt')" href="#modalWindow">Заказать услугу перевода</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="perevod-s-inostrannyix-yazyikov.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Перевод с иностранных языков">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='perevod-s-inostrannyix-yazyikov.html';
