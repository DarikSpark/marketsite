...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Студия REDLINE оказывает услуги по созданию веб сайтов, продвижению сайтов в поисковых системах,настраивает контекстную рекламу Яндекс.Директ и Google AdWords. Лучшие цены. Звоните! " />
    <meta name="keywords" content="услуги по разработке сайтов,разработка сайтов,создание сайтов в Минске,создание сайтов в Витебске, создание и продвижение сайтов, seo оптимизация и продвижение сайтов,создание и разработка сайтов, сайт в кредит, создание интернет магазина, контекстная реклама, контекстно-медийная реклама, баннерная реклама" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Создание и разработка сайтов, настройке контекстной рекламы, SEO продвижение | Студия веб дизайна REDLINE</title>
			     ...
			     <!-- <div class='medium-3 columns icon-text fadein' data-delay='400'>					  
				   <h2>Дополнительные услуги</h2>
					   ...
					   <ul style="list-style-type: disc;">		
						   ...
						   <li><a href="dopolnitelnyie-uslugi/uslugi-kopirajtinga-i-rerajtinga.php">Услуги копирайтинга и рерайтинга</a></li>
						   <li>Написание продающих текстов</li>
						   <li><a href="dopolnitelnyie-uslugi/sozdanie-prodayushhix-prezentaczij.php">Создание продающих презентаций</a></li>
						   <li><a href="dopolnitelnyie-uslugi/perevod-s-inostrannyix-yazyikov.php">Перевод текстов</a></li>
						   <li>Разработка скриптов и модулей</li>  
						   <li>Написание технического задания</li>  
						   <li><a href="dopolnitelnyie-uslugi/razrabotka-mobilnoj-versii-sajta.php">Создание мобильной версии сайта</a></li>
						   <li>Интеграция сайта с 1С, Яндекс.Маркет, Мой склад</li>
						   <li><a href="dopolnitelnyie-uslugi/podklyuchenie-platezhnoj-sistemyi-dlya-sajta.php">Подключение платежных систем на сайт</a></li>
						   <li><a href="dopolnitelnyie-uslugi/podderzhka-sajtov.php">Техническое сопровождение сайта</a></li>
						   <li>Наполнение сайтов и интернет-магазинов</li>
						   <li>Разработка коммерческих предложений</li>
