...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Регистрация в поисковиках является необходимым условием успешной работы сайта" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Регистрация сайта в поисковиках Яндекс, Google </title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/./google-logo1.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Регистрация в поисковиках Яндекс, Google"/>
<meta property="og:url" content="http://redline.by/uslugi/prodvizhenie-sajtov/registracziya-v-poiskovikax-yandeks,-google.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Регистрация в поисковиках Яндекс, Google</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Регистрация сайта в поисковиках Яндекс, Google </h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Регистрация в поисковиках Яндекс, Google
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='registracziya-v-poiskovikax-yandeks,-google.html'>
                  <img alt='Регистрация в поисковиках Яндекс, Google' src='../../assets/cache_image/resources/google-logo1_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Когда Ваш сайт полностью готов, выбраны ключевые запросы для продвижения, проведена внутренняя оптимизация – самое время заявить о себе широкому кругу пользователей. Рано или поздно поисковые роботы обратят внимание на новый ресурс и проиндексируют сайт, но зачем терять драгоценное время. Есть инструменты, позволяющие направить внимание поисковиков на нужные Вам страницы. Наша компания предлагает осуществить регистрацию в поисковиках Яндекс, Google, что не только ускорит процесс индексации сайта. Данный сервис позволяет вести контроль за работой сайта в поисковой системе:</p>
<ul>
<li>Определяет текущий статус и проблемы индексации</li>
<li>Показывает, по каким запросам пользователи находят Ваш сайт</li>
<li>Выявляет внешние ссылки с других веб-ресурсов</li>
<li>Предоставляет возможности для улучшения блока выдачи</li>
</ul>
<p align="justify">Регистрация в поисковиках является необходимым условием успешной работы сайта. Понятный интерфейс существенно облегчает работу с многочисленными данными. Это позволяет специалисту в кратчайшие сроки обнаружит и устранить возникшие ошибки, оптимизировать сайт в реальном времени, ориентируясь на меняющийся потребительский спрос.</p>
			  <p><a class="button" onclick="sub_name('Регистрация в поисковиках Яндекс, Google','pikt')" href="#modalWindow">Заказать регистрацию в поисковых системах</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="registracziya-v-poiskovikax-yandeks,-google.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Регистрация в поисковиках Яндекс, Google">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='registracziya-v-poiskovikax-yandeks,-google.html';
