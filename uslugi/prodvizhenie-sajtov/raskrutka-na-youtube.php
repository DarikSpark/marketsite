...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="YouTube – самый популярный сервис для хранения и просмотра видеороликов. Однако немногие знают, что данный видео хостинг может стать отличной площадкой для раскрутки вашего сайта. Это можно реализовать благодаря размещению ссылки в описании видео. Благодаря этому, ваш сайт сможет привлечь определенное число целевых посетителей. Мы можем помочь вам в этом, благодаря нашей услуге – раскрутка на YouTube." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Раскрутка канала на YouTube - продвижение видео | студия веб дизайна Редлайн</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/YouTube-Transparent-Logo.png"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Раскрутка на YouTube"/>
<meta property="og:url" content="http://redline.by/uslugi/prodvizhenie-sajtov/raskrutka-na-youtube.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Раскрутка на YouTube</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Раскрутка канала на YouTube</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='raskrutka-na-youtube.html'>
                  <img alt='Раскрутка на YouTube' src='../../assets/cache_image/resources/news/16/02/17/YouTube-Transparent-Logo_1600x487_9c7.png'>
                </a>
              </p>
              <p align="justify">YouTube – самый популярный сервис для хранения и просмотра видеороликов. Однако немногие знают, что данный видео хостинг может стать отличной площадкой для раскрутки вашего сайта. Это можно реализовать благодаря размещению ссылки в описании видео. Благодаря этому, ваш сайт сможет привлечь определенное число целевых посетителей. Мы можем помочь вам в этом, благодаря нашей услуге – раскрутка на YouTube.</p>
<p align="justify">Несмотря на кажущуюся простоту, для раскрутки сайта с помощью YouTube необходимо знать множество нюансов сервиса и проделать достаточно большой объем работы. Для того, чтобы ссылка привлекла действительно целевых посетителей, она должна быть размещена под релевантным видео. Кроме того, видео должно содержать корректное название, а также содержать ключевые слова и соответствовать некоторым другим важным показателям.</p>
<p align="justify">Обратившись к нам в студию, наши специалисты продвинут ваш сайт с помощью YouTube, что, в свою очередь, обеспечит поток целевых посетителей и приведет к повышению прибыльности вашего проекта.</p>
			  <p><a class="button" onclick="sub_name('Раскрутка на YouTube','pikt')" href="#modalWindow">Заказать раскрутку на YouTube</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="raskrutka-na-youtube.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Раскрутка на YouTube">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='raskrutka-na-youtube.html';
