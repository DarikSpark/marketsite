...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Невысокая конверсия может быть вызвана самыми разнообразными причинами, однако наша команда профессионалов с легкостью определит и устранит эти негативные факторы" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Увеличение конверсии сайта | студия веб дизайна Редлайн</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/cro-graphic-1.gif"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Увеличение конверсии сайта"/>
<meta property="og:url" content="http://redline.by/uslugi/prodvizhenie-sajtov/uvelichenie-konversii-sajta.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Увеличение конверсии сайта</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Увеличение конверсии сайта</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='uvelichenie-konversii-sajta.html'>
                  <img alt='Увеличение конверсии сайта' src='../../assets/cache_image/resources/news/16/02/17/cro-graphic-1_1600x487_132.gif'>
                </a>
              </p>
              <p align="justify">Вы создали собственный интернет-проект, однако ваша аудитория заходит на сайт и сразу же его покидает? Именно для таких ситуаций в нашей веб-студии есть услуга по увеличению конверсии ресурса. Она необходима для того, чтобы увеличить количество посетителей сайта, которые после его посещения станут вашими клиентами.</p>
<p align="justify">Невысокая конверсия может быть вызвана самыми разнообразными причинами, однако наша команда профессионалов с легкостью определит и устранит эти негативные факторы. Работа наших специалистов заключается в том, чтобы улучшить конверсию и поток лидов. Лиды – это необходимые действия, которые должен совершить пользователь посещая ваш сайт. К ним можно отнести:</p>
<ul>
...
<p align="justify">Наша работа направлена только на целевую аудиторию, то есть на тех людей, которые заинтересованы в использовании услуг вашего сайта. Основная цель нашей работы – увеличение конверсии и лидов, за счет отсеивания нецелевой аудитории. Все это благоприятно отразится на прибыльности вашего бизнеса. Если вы заинтересовались данной услугой, то обратитесь в нашу студию и мы поможем вашему проекту раскрыть весь потенциал.</p>
			  <p><a class="button" onclick="sub_name('Увеличение конверсии сайта','pikt')" href="#modalWindow">Хочу увеличение конверсии сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="uvelichenie-konversii-sajta.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Увеличение конверсии сайта">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='uvelichenie-konversii-sajta.html';
