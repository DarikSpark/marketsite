...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Скорость загрузки – очень важный параметр сайта, который влияет как на посетителей, так и на ранжирование в поисковых системах." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Как увеличить скорость загрузки сайта | веб студия Редлайн</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/Безимени-1.png"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Увеличение скорости загрузки сайта"/>
<meta property="og:url" content="http://redline.by/uslugi/prodvizhenie-sajtov/uvelichenie-skorosti-zagruzki-sajta.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Увеличение скорости загрузки сайта</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Увеличение скорости загрузки сайта</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='uvelichenie-skorosti-zagruzki-sajta.html'>
                  <img alt='Увеличение скорости загрузки сайта' src='../../assets/cache_image/resources/news/16/02/17/-1_1600x487_9c7.png'>
                </a>
              </p>
              <p align="justify">Скорость загрузки – очень важный параметр сайта, который влияет как на посетителей, так и на ранжирование в поисковых системах. Если сайт будет долго грузиться, то пользователь, с большой долей вероятности, покинет его не дождавшись полной загрузки. Кроме того, низкая скорость ресурса учитывается поисковыми системами, которые могут понижать неоптимизированные сайты в поисковой выдаче.</p>
<p align="justify">Низкая скорость загрузки может быть обусловлена самыми разнообразными факторами (вредоносный код, неоптимизированные файлы стилей, избыточное количество активных плагинов, отсутствие кэширования и т.д.). Наши специалисты помогут найти и устранить все причины, которые препятствуют корректной загрузке сайта. Высокая скорость загрузки позволит уменьшить количество отказов, что, в свою очередь, положительно повлияет на прибыльность вашего проекта. Кроме того, быстрые сайты лучше ранжируются поисковыми системами.</p>
<p align="justify">Данную работу стоит доверять только профессионалам, которые не навредят вашему ресурсу. Наши специалисты оптимизируют скорость загрузки, как для популярных, так и для самописных систем управления контентом (CMS). Кроме того, мы работаем со строгим соблюдением всех сроков, а также учитываем пожелания наших клиентов.</p>
			  <p><a class="button" onclick="sub_name('Увеличение скорости загрузки сайта','pikt')" href="#modalWindow">Увеличить скорость загрузки сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="uvelichenie-skorosti-zagruzki-sajta.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Увеличение скорости загрузки сайта">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='uvelichenie-skorosti-zagruzki-sajta.html';
