...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Тизерная реклама – это рекламное объявление, которое содержит завлекающий посетителя текст и картинку. Данный способ продвижения по эффективности немногим уступает контекстной рекламе" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Настройка тизерной рекламы MarketGid, вконтакте, фейсбуке</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
	...
	<meta property="og:image" content="http://redline.by/resources/news/16/02/17/0242.jpg"/>
	<meta property="og:site_name" content="Red Line"/>
	<meta property="og:title" content="Настройка тизерной рекламы"/>
	<meta property="og:url" content="http://redline.by/uslugi/prodvizhenie-sajtov/nastrojka-tizerov-v-marketgid.html"/>
...
<div class="medium-3 column">
  <h3><a href='default.htm'>Продвижение сайтов</a></h3>
  <ul>
	<li>
  <a href='kontekstnaya-reklama.html'>Контекстная реклама</a>
</li>
<li>
  <a href='prodvizhenie-grupp-i-publichnyix-stranicz-v-soczialnyix-setyax.html'>Продвижение в соц.сетях</a>
</li>
  </ul>
</div><!--end of .column-->
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li itemscope="itemscope" class="B_crumb" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_crumb" itemprop="url" rel="Продвижение сайтов" href="default.htm"><span itemprop="title">Продвижение сайтов</span></a></li>
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Настройка тизерной рекламы</li></li>
</ul>
		
		<div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		   <h1>Настройка тизерной рекламы</h1>
		   <p>Настройка тизерной рекламы</p>
		   <p class='shortline'></p>
        </div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='nastrojka-tizerov-v-marketgid.html'>
                  <img alt='Настройка тизерной рекламы' src='../../assets/cache_image/resources/news/16/02/17/0242_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Тизерная реклама – это рекламное объявление, которое содержит завлекающий посетителя текст и картинку. Данный способ продвижения по эффективности немногим уступает контекстной рекламе, а в некоторых случаях и превосходит ее. Тизерная реклама пользуется популярностью, так как она размещается на большом количестве сайтов и охватывает огромную аудиторию (общее число показов рекламы за сутки в MarketGid составляет около 2-ух миллионов). Кроме того, завлекающие заголовки обеспечивают высокую кликабельность объявлений, а также высокую конверсию.</p>
<p align="justify">Правильная разработка и размещение рекламного блока, обеспечит уменьшение потока нецелевой аудитории, а, стало быть, количество неэффективных кликов уменьшиться в разы. Если вы оценили все плюсы использования тизерной рекламы для продвижения ваших товаров или услуг, то мы с радостью вам в этом поможем.</p>
<p style="text-align: center;" align="justify"><strong>Пример тизерной рекламы</strong></p>
<p style="text-align: center;" align="justify"><strong><img title="Настройка тизеров в MarketGid" src="../../resources/news/16/02/17/024.jpg" alt="Настройка тизеров в MarketGid" width="600" height="400" /></strong></p>
<p align="justify">MarketGid - одна из самых лучших и эффективных тизерных рекламных сетей. Именно ее используют специалисты нашей компании. Это достаточно популярная сеть, которая заслужила доверие множества пользователей. Кроме того, она обладает понятным интерфейсом, удобной системой статистики, а также надежно защищена от мошенников. С данной системой работают многие известные новостные порталы.</p>
<p align="justify">Обратившись в нашу веб-студию, вы получите рекламные блоки, которые будут приводить на ваш сайт только целевых посетителей, а значит ваши затраты окупятся в несколько раз.</p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="nastrojka-tizerov-v-marketgid.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Настройка тизерной рекламы">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='nastrojka-tizerov-v-marketgid.html';
