...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Для того, чтобы ваш ресурс, с момента запуска, начал занимать высокие позиции, необходимо подумать о внутренней SEO оптимизации. Внутренняя оптимизация, в совокупности с другими методами продвижения, обеспечит вашему проекту высокие позиции в поисковых системах. К ней можно отнести:" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Поисковая оптимизация сайта - SEO оптимизация сайта | веб студия Redline</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/03/01/seo.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Оптимизация сайта"/>
<meta property="og:url" content="http://redline.by/uslugi/prodvizhenie-sajtov/vnutrennyaya-optimizacziya-sajta.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Оптимизация сайта</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Поисковая оптимизация сайта </h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='vnutrennyaya-optimizacziya-sajta.html'>
                  <img alt='Оптимизация сайта' src='../../assets/cache_image/resources/news/16/03/01/seo_1600x487_490.jpg'>
                </a>
              </p>
              <h2><strong>Внутренняя поисковая оптимизация сайта</strong></h2>
<p>Для того, чтобы ваш ресурс, с момента запуска, начал занимать высокие позиции, необходимо подумать о внутренней SEO оптимизации. Внутренняя оптимизация, в совокупности с другими методами продвижения, обеспечит вашему проекту высокие позиции в поисковых системах. К ней можно отнести:</p>
<ul>
<li>Работу с ключевыми словами</li>
<li>Создание карты сайта</li>
<li><a href="../../novosti/kak-formiruetsya-title-v-rezultatax-vyidachi.html">Оптимизация тайтлов</a></li>
<li>Оптимизация описаний</li>
<li>Настройка robots.txt</li>
<li>Внутренняя перелинковка страниц</li>
</ul>
<p>Работа с ключевыми словами подразумевает сбор релевантных запросов, по которым посетители будут находить ваш сайт. Это очень трудоемкий процесс, поэтому его стоит доверять только профессионалам.</p>
<p>Наша команда состоит только из специалистов с большим опытом работы. Именно благодаря этому, вы можете рассчитывать на то, что ваш сайт окажется в топе поисковой выдачи.</p>
<p>Внутренняя поисковая оптимизация не ограничивается подбором ключевых слов. Кроме того, мы создаем привлекательные тайтлы, которые позволят находить ваш сайт целевой аудитории. А также мы можем настроить robots.txt, сделать внутреннюю перелинковку и создать <a href="../../sitemap.html">карту сайта</a>. Все это приведет к тому, что ваш сайт будет выглядеть привлекательно, как для поисковых систем, так и для людей.</p>
			  <p><a class="button" onclick="sub_name('Оптимизация сайта','pikt')" href="#modalWindow">Заказать оптимизацию сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="vnutrennyaya-optimizacziya-sajta.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Оптимизация сайта">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='vnutrennyaya-optimizacziya-sajta.html';
