...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Индивидуальный ресурс отлично подойдет тем, кто хочет получить абсолютно эксклюзивный проект, который полностью настроен под ваши потребности." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Создание сайтов по индивидуальным требованиям заказчика</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/17/slider1.png"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Индивидуальные проекты"/>
<meta property="og:url" content="http://redline.by/uslugi/razrabotka-sajtov/sozdanie-individualnyix-sajtov.html"/>
...
<a href="../../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><li itemscope="itemscope" class="B_currentCrumb" itemtype="http://data-vocabulary.org/Breadcrumb">Индивидуальные проекты</li></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Создание сайтов по индивидуальным требованиям заказчика</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='sozdanie-individualnyix-sajtov.html'>
                  <img alt='Индивидуальные проекты' src='../../assets/cache_image/resources/news/16/02/17/slider1_1600x487_9c7.png'>
                </a>
              </p>
              <p align="justify">Индивидуальный ресурс создается, как правило, с чистого листа (без использования CMS), с учетом любых пожеланий заказчика. Для его реализации вам нужно описать видение вашего ресурса и придумать общую концепцию, а наша команда профессионалов воплотит эти идеи в жизнь.</p>
<p align="justify">Сроки и стоимость рассчитываются индивидуально, так как зависят от сложности реализации проекта.</p>
<p align="justify">Индивидуальный ресурс отлично подойдет тем, кто хочет получить абсолютно эксклюзивный проект, который полностью настроен под ваши потребности.</p>
<p align="justify">Для вашего сайта будет создан индивидуальный программный код, который обеспечит максимально простое и удобное управление проектом. При желании, индивидуальный ресурс может быть разработан с помощью систем управления контентом (CMS). Все зависит от поставленных задач и вашего бюджета. Для разработки сайтов используются следующие языки программирования и разметки:</p>
<ul>
<li>PHP5, CodeIgniter, Kohana</li>
<li>MySQL, PostgreSQL, Oracle</li>
<li>JavaScript, jQuery, jQueryUI</li>
<li>jQuery Mobile, Bootstrap</li>
<li>Ajax</li>
<li>CSS3, HTML5</li>
</ul>
<p>Наша команда разработчиков готова дать исчерпывающую консультацию по вопросам, которые могут возникнуть в процессе разработки или эксплуатации сайта.</p>
<p style="text-align: center;"><img title="Создание индивидуальных сайтов" src="../../resources/news/16/02/17/aboutus-banner.png" alt="Создание индивидуальных сайтов" width="500" height="154" /></p>
<p><strong>В разработку индивидуального сайта включено:</strong></p>
<ul>
<li>Удобное управление сайтом, которое заточено под ваши потребности</li>
<li>Создание абсолютно уникального дизайна</li>
<li>Использование самых современных инструментов (PHP5, jQuery, Ajax, JavaScript, HTML5, CSS3 и многие другие)</li>
<li>Высокая безопасность (защищен от взлома и вирусных атак)</li>
<li>Стабильная работа даже при большой нагрузке на сервер</li>
<li>Любое количество страниц и разделов</li>
<li>Бесплатный домен (сроком на 1 год)</li>
<li>Базовая техническая поддержка</li>
</ul>
<p><strong>Минимальный функционал:</strong></p>
<ul>
<li>Добавление сайта в различные поисковые системы (Google, Yandex и другие)</li>
<li>Настройка контекстных объявлений (Google AdWords, Яндекс.Директ)</li>
<li>Создание и настройка формы обратной связи</li>
<li>Поиск по сайту</li>
<li>Блоки с новостями</li>
<li>Создание мультимедийных галерей (фото и видео)</li>
<li>Добавление слайдера с изображениями</li>
<li>Возможность отставлять комментарии / отзывы</li>
<li>Карта сайта</li>
<li>Создание почтовой рассылки</li>
<li>Форум</li>
</ul>
<!-- <div class="redblock"><p><strong>Чего ожидать от работы с нами:</strong></p>
<ol>
<li>Проанализируем рынок и конкурентов. Выявим целевую аудиторию и определим ее потребности.</li>
...
<li>К сожалению, мы не беремся за разработку некоторых сайтов. Если мы видим, что проект неперспективный и не принесет прибыли владельцу, то мы отказываемся от выполнения, так как заинтересованы в положительном результате.</li>
			  ...
			  <p><a class="button" onclick="sub_name('Индивидуальные проекты','pikt')" href="#modalWindow">Заказать создание индивидуального сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="sozdanie-individualnyix-sajtov.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../../default.htm">
		  ...
		  <input type="hidden" name="place" value="Индивидуальные проекты">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='sozdanie-individualnyix-sajtov.html';
