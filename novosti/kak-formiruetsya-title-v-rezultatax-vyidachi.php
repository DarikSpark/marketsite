...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Если Вы прописываете тег title для каждой статьи, то можно убедиться, что поисковики не всегда обращают на него внимание и формируют заголовок по своему усмотрению. В рамках данной статьи мы подробно остановимся на причинах, которые влияют на его изменение, а также рассмотрим источники информации, используемые поисковыми системами." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Как формируется  TITLE в результатах выдачи?</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/02/10/tflogofilled.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Как формируется title в результатах выдачи"/>
<meta property="og:url" content="http://redline.by/novosti/kak-formiruetsya-title-v-rezultatax-vyidachi.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Как формируется title в результатах выдачи" href="kak-formiruetsya-title-v-rezultatax-vyidachi.html"><span itemprop="title">Как формируется title в результатах выдачи</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Как формируется title в результатах выдачи</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Как формируется title в результатах выдачи
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='kak-formiruetsya-title-v-rezultatax-vyidachi.html'>
                  <img alt='Как формируется title в результатах выдачи' src='../assets/cache_image/resources/news/16/02/10/tflogofilled_1600x487_490.jpg'>
                </a>
              </p>
              <p><span style="line-height:../1.5em;">Если Вы прописываете тег title для каждой статьи, то можно убедиться, что поисковики не всегда обращают на него внимание и формируют заголовок по своему усмотрению. В рамках данной статьи мы подробно остановимся на причинах, которые влияют на его изменение, а также рассмотрим источники информации, используемые <a href="../uslugi/prodvizhenie-sajtov/default.htm">поисковыми</a> системами.</span></p>
<h2>Основные причины влияющие на изменение заголовка</h2>
<p>Их не так уж и много:</p>
<ul>
<li>Не задан тайтл или он слишком короткий;</li>
<li>Слишком большой тайтл;</li>
<li>Тайтл точь в точь дублирует заголовок на другом ресурсе;</li>
<li>Одинаковый тайтл для всех страниц ресурса.</li>
</ul>
<p>Есть и другие причины, но они менее распространены и мы не будем заострять на них внимание.</p>
<h2>Как изменяют заголовок поисковики</h2>
<p>Здесь все просто. Они корректируют содержимое тайтла или полностью его переписывают. В этой статье мы рассмотрели заголовки из выдачи Google, но для Яндекса не будет принципиальных отличий.</p>
<p><img src="../resources/news/16/02/10/1.png" alt="" width="605" height="251" /></p>
<p> </p>
<h3>1) Добавление названия фирмы в конце заголовка.</h3>
<p> <span style="line-height:../1.5em;">Изначальный заголовок: </span><span style="line-height:../1.5em;">Полимерные печати</span></p>
<p>Результат выдачи: Полимерные печати – «название фирмы»</p>
<p>В этом примере мы можем наблюдать, что Гугл добавил в выдачу название компании. Но где он его взял? Чаще всего поисковый робот обращает внимание на страницу с контактами, страницу «о компании», а также смотрит на анкорный текст ссылок, ведущих на главную страницу. Поэтому если Вы ссылаетесь на морду то нужно указывать название фирмы в анкоре, иначе может произойти следующее:</p>
<p><img src="../resources/news/16/02/10/10.png" alt="" width="590" height="485" /> </p>
<p>Стоит отметить, что название компании подставляется не всегда. Для этого нужно, чтобы размер заголовка был длиннее 512 пикселей. Но в некоторых случаях тайтл автоматически обрезается, а за ним идет название бренда.</p>
<p> <img src="../resources/news/16/02/10/11.png" alt="" width="597" height="230" /></p>
<h3>2) Добавление региональной привязки </h3>
<p>Иногда поисковики добавляют региональную привязку в заголовок.</p>
<p>Изначальный заголовок: Печати и штампы</p>
<p>Результат выдачи: Печати и штампы – «Регион» – «Название фирмы»</p>
<p><img src="../resources/news/16/02/10/3.png" alt="" width="584" height="327" /> </p>
<p>Регион указываться, чтобы дать предварительную информацию пользователю о географическом расположении в том случае, если ниша представлена несколькими фирмами.</p>
<h3>3) Изменение порядка текстовых блоков.</h3>
<p>Зачастую, поисковик просто ставит вперед текстовый блок, который, по его мнению, более важен для посетителя.</p>
<p>Изначальный заголовок: Печати и штампы в Челябинске | Изготовление печатей и штампов</p>
<p>Результат выдачи: Изготовление печатей и штампов: Печати и штампы в …</p>
<p> <img src="../resources/news/16/02/10/4.png" alt="" width="494" height="97" /></p>
<p>В данном случае робот посчитал, что деятельность компании важнее, чем ее географическое расположение.</p>
<p> <img src="../resources/news/16/02/10/5.png" alt="" width="499" height="93" /></p>
<p>Что касается этого примера, то не совсем ясно почему Гугл поставил наименование компании в начало. Единственное предположение – был использован некорректный разделитель в первоначальном варианте.</p>
<h2>Откуда берется информация?</h2>
<p>Так откуда же поисковики черпают информацию для изменений? Постараемся внести некоторую ясность в этот вопрос.</p>
<h3>1) Заголовки.</h3>
<p>В некоторых ситуациях содержимое тега H1 смотрится более привлекательным в глазах поисковика, нежели прописанный тайтл, поэтому тег H1 можно считать основным источником информации. Стоит отметить, что если по тексту встречаются теги другого уровня, то они также могут повлиять на тайтл.</p>
<p><img src="../resources/news/16/02/10/6.png" alt="" width="504" height="217" /> </p>
<p>В примере на скриншоте тайтл был огромным и спамным, поэтому поисковый робот взял информацию из тега H1, а некорректный, по его мнению, заголовок отправился в сниппет.</p>
<h3>2) Каталоги сайтов.</h3>
<p>В каталогах поисковых систем идет строжайшая модерация и попасть туда довольно непросто (даже на платной основе). Поэтому если Вы все-таки умудрились там оказаться, то Ваш ресурс получит значительный прирост авторитетности. В таком случае заголовки могут тянуться именно с каталогов (в частности Dmoz и Яндекс). Если Вы заметили, что они отображается некорректно, то можно повлиять на этот процесс, отключив их при помощи специальных мета-тегов.</p>
<h3>3) Навигационная цепочка.</h3>
<p>Если предыдущие способы не применимы к сайту, то в ход идут так называемые хлебные крошки (иначе говоря навигационная цепочка).</p>
<p> <img src="../resources/news/16/02/10/7.png" alt="" width="504" height="243" /></p>
<p> <img src="../resources/news/16/02/10/8.png" alt="" width="504" height="272" /></p>
<h3>4) Анкорный текст.</h3>
<p>Как уже говорилось ранее, анкорный текст также может служить заголовком для некоторых страниц. В данном примере слово «врачам» вообще нигде не используется за исключением навигации, а URL ведет на данную страницу.</p>
<p> <img src="../resources/news/16/02/10/9.png" alt="" width="505" height="200" /></p>
<h3>5) Другие источники.</h3>
<p>Иногда всех вышеперечисленных вариантов недостаточно и поисковики берут информацию из, казалось бы, совершенно нелогичных источников. Например, теги изображений, текст из футера и других элементов страницы.</p>
<p>Если Вы не уверены в корректности заголовков на Вашем сайте, то обращайтесь в <a href="../default.htm">студию веб-дизайна RedLine</a>. Наши специалисты готовы провести комплексную <a href="optimizacziya-sajta-pod-poiskovyie-sistemyi.html">оптимизацию сайта</a>, что позволит улучшить видимость в поисковых система, и, соответственно, увеличить траффик.</p>
<p> </p>
<p> </p>
			  <p><a class="button" onclick="sub_name('Как формируется title в результатах выдачи','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="kak-formiruetsya-title-v-rezultatax-vyidachi.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Как формируется title в результатах выдачи">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='kak-formiruetsya-title-v-rezultatax-vyidachi.html';
