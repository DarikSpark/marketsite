...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Cписок из 10 наиболее распространенных задач, которые требуют длительного ожидания в Яндексе. Одна из самых главных проблем с которой сталкиваются SEO-оптимизаторы – долгое ожидание результатов. Практически все изменения вносимые на сайт начинают действовать намного позже, чем этого бы хотелось" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>10 задач в SEO, которые требуют времени</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/seo-3.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="10 задач в SEO, которые требуют времени"/>
<meta property="og:url" content="http://redline.by/novosti/10-zadach-v-seo,-kotoryie-trebuyut-vremeni.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="10 задач в SEO, которые требуют времени" href="10-zadach-v-seo,-kotoryie-trebuyut-vremeni.html"><span itemprop="title">10 задач в SEO, которые требуют времени</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>10 задач в SEO, которые требуют времени</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                10 задач в SEO, которые требуют времени
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='10-zadach-v-seo,-kotoryie-trebuyut-vremeni.html'>
                  <img alt='10 задач в SEO, которые требуют времени' src='../assets/cache_image/resources/seo-3_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Одна из самых главных проблем с которой сталкиваются <strong>SEO-оптимизаторы</strong> – долгое ожидание результатов. Практически все изменения вносимые на сайт начинают действовать намного позже, чем этого бы хотелось. Однако в этом есть и свои преимущества (к примеру, можно удалить<strong> качественные ссылки</strong>, но они будут действовать еще некоторое время). Но в основном <strong>медлительность поисковых систем</strong> имеет лишь негативные последствия, так как затрудняется проверка эффективности проделанной работы.</p>
<h2 align="justify">Роботы Google работают быстрее чем роботы Яндекса</h2>
<p align="justify">Причем вышесказанное больше применимо к <strong>Яндексу</strong>, так как поисковые роботы <strong>Google</strong> чаще посещают и сканируют сайты, что, в свою очередь, ведет к быстрой индексации всех изменений. <strong>Яндекс</strong> существенно отстает в этом плане и эффект от большинства изменений приходится ждать около месяца. Из-за этого очень сложно связать конкретные действия по оптимизации с полученными результатами.</p>
<p style="text-align: center;" align="justify"><img title="10 задач в SEO, которые требуют времени" src="../resources/news/16/01/16/image001.jpg" alt="10 задач в SEO, которые требуют времени" width="500" height="271" /></p>
<h2 align="justify"><span>10 наиболее распространенных задач</span></h2>
<p align="justify">Мы собрали список из 10 наиболее распространенных задач, которые требуют длительного ожидания в Яндексе.</p>
<p align="justify"><strong>1) Индексация содержания сайта.</strong></p>
<p align="justify">Чтобы <strong>страницы</strong> вашего сайта <strong>оказались в индексе</strong>, для этого нужно воспользоваться специальным инструментом (проще говоря адурилкой). Также Ваш сайт попадет в индекс, если владелец другого ресурса разместит на него ссылку. После первого апдейта сайт скорей всего пролетит мимо индекса, так как там появляются несвежие страницы. В общем если сайт появится <strong>в течении 30 дней</strong>, то можно считать, что Вам крупно <strong>повезло</strong>.</p>
<p align="justify">Особенно от данной медлительности могут пострадать владельцы ресурсов с сезонным контентом. Поэтому стоит учитывать этот фактор, и заниматься <a href="napolnenie-sajta-kontentom.html">наполнением сайта</a> предварительно.</p>
<p align="justify"><strong>2) Применение запрета на индексацию. </strong></p>
<p align="justify">К сожалению, удалить страницу из поиска бывает гораздо труднее, чем ее туда внести. <strong>Яндек</strong>с предусмотрел форму удаления, однако она не поможет ускорить процесс, который как и в предыдущем случае займет <strong>около месяца</strong>. Помните об этой особенности и вовремя закрывайте от индексации метки и правильно настраивайте зеркала, иначе это негативно скажется на <strong>SEO оптимизации сайта</strong>.</p>
<p align="justify"><strong>3) Индексация новой структуры веб-ресурса.</strong></p>
<p align="justify">Смена структуры сайта связана с изменением URL страниц. Даже если Вы воспользуетесь<strong> редиректом 301</strong> и будете перенаправлять посетителей со старого адреса на новый, то опять же не стоит рассчитывать на результат по прошествии <strong>менее 30 дней</strong>.</p>
<p align="justify">В свою очередь, <strong>Яндекс</strong> не стоит на месте. Предоставляются инструменты, которые позволяют ускорить процесс переиндексации с помощью быстробота. Однако их эффективность не так велика, как хотелось бы. Все из-за того, что существуют факторы на которые нельзя повлиять (интервал апдейтов поисковой системы, а также сохраненной копии страницы). А если Ваш ресурс имеет сложную и глубокую структуру, то можно столкнуться с таким явлением, когда в индексе находятся старые и новые страницы. Причем старые могут находится там в течении нескольких месяцев.</p>
<p align="justify"><strong>4) Изменение основного зеркала.</strong></p>
<p align="justify">Если Вы вдруг надумаете изменить <strong>основное зеркало сайта</strong>, то рекомендуем хорошенько подумать нужно ли это, так как это процесс займет длительное время. <a href="instrukcziya-dlya-rabotyi-s-yandeks.vebmaster.html" target="_blank">Сервис Яндекс.Вебмастер</a> предусматривает специальный инструмент для данной процедуры, который, кстати, очень удобен. Однако на скорость изменения зеркала он никак не повлияет.</p>
<p align="justify"><strong>5) Изменение протокола передачи данных. </strong></p>
<p align="justify">В нынешнее время многие предпочитают использовать <strong>HTTPS</strong> протокол передачи данных, так как он в разы повышает безопасность Вашего сайта. Если Вы все еще пользуетесь <strong>HTTP</strong>, то рекомендуем сменить его на более защищенный аналог. Но стоит учитывать, что данное изменение может стоить небольшой потери трафика, так как происходит смена зеркала и изменяются адреса страниц. Это означает, что в результатах поиска какое-то время будут показываться оба варианта сайта. Как обычно, на решение данной проблемы уйдет <strong>около месяца</strong>.</p>
<p align="justify"><strong>6) Индексация ссылочной массы сайта.</strong></p>
<p align="justify">Вы закупились ссылками, но не наблюдаете их в панели вебмастеров или они появились, но <strong>позиции сайта</strong> остались прежними? Не стоит заморачиваться по этому поводу, так как индексация ссылок еще более мудреный и долгий процесс, нежели индексация контента. Именно поэтому временные ссылки имеют меньшую эффективность по сравнению с вечными. К слову, есть предположение, что Яндекс делает это специально для того, чтобы хитрые веб-мастера не смогли узнать <strong>алгоритмы поисковой системы</strong>, что, в свою очередь, позволит манипулировать результатами выдачи.</p>
<p align="justify"><strong>7) Изменение контента. </strong></p>
<p align="justify"><strong>Оптимизация одностраничных сайтов</strong> – одна из многочисленных задач с которыми сталкивается <strong>SEO-оптимизатор</strong>. Зачастую, невозможно с первого раза подобрать оптимальный заголовок для страницы. А если захочется внести изменения, то снова придется ждать несколько недель, пока не произойдет следующий апдейт. Таким образом, казалось бы простенькая задача растягивается на <strong>длительный промежуток времени</strong>.</p>
<p align="justify">Опять-таки, если после изменения заголовков Вы наблюдаете какой-либо эффект, то нельзя утверждать со стопроцентной уверенностью, что именно Ваши изменения привели к этому.</p>
<p align="justify"><strong>8) Внутренняя оптимизация сайта.</strong></p>
<p align="justify">Если решите заняться <a href="../uslugi/prodvizhenie-sajtov/vnutrennyaya-optimizacziya-sajta.html">внутренней оптимизацией сайта</a>, а в частности <strong>прелинковкой</strong> или улучшением <strong>юзабилити</strong>, то нужно быть готовым, что сначала поисковый робот должен заново проиндексировать содержимое сайта, а затем переписать свои данные. Это вовсе не означает, что не нужно заниматься оптимизацией и пускать все на самотек. Просто будьте готовы к тому, что в SEO не бывает быстрых результатов (по крайней мере в белом).</p>
<p align="justify"><strong>9) Выход из-под «Минусинска».</strong></p>
<p align="justify">Не так давно данный фильтр подкосил позиции не одной тысячи сайтов, которые занимались <a href="../uslugi/prodvizhenie-sajtov/default.htm">поисковым продвижением</a> с помощью покупных ссылок. Единственным <strong>выходом из-под фильтра</strong> является их снятие. А сколько времени уходит на данный процесс мы уже писали немного выше – <strong>несколько месяцев</strong>. Однако это довольно оптимистичный прогноз, так как невозможно абсолютно точно узнать какие ссылки нужно снимать, а какие оставить.</p>
<p align="justify"><strong>10) Выход из-под других фильтров. </strong></p>
<p align="justify">Наложение фильтров не представляло такой опасности, если бы от них можно было избавиться путем внесения быстрых корректировок. Поэтому при использовании нечестных методов продвижения нужно быть готовым к тому, что придется потратить <strong>несколько месяцев</strong> на то, чтобы вновь вернуть доверие <strong>Яндекса</strong>.</p>
<p align="justify">Естественно, это не единственные задачи, которые требуют длительного времени. Словосочетание «быстрый результат» не применимо к SEO, скорее оно больше подходит для <a href="../uslugi/prodvizhenie-sajtov/kontekstnaya-reklama.html">контекстной рекламы</a>, где нужно лишь настроить объявления и они через короткое время начнут приносить целевых посетителей. Вышеперечисленные факторы необходимо принимать во внимание при <strong>планировании стратегий продвижения</strong>.</p>
<p align="justify"><a href="../default.htm">Студия веб-дизайна RedLine</a> имеет в своем распоряжении штат специалистов, включая опытных SEO-оптимизаторов, которые следят за всеми последними изменениями в алгоритмах поисковых систем. Обращаясь к нам, мы продвинем Ваш сайт в ТОП выдачи минимизировав всевозможные риски.  </p>
			  <p><a class="button" onclick="sub_name('10 задач в SEO, которые требуют времени','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="10-zadach-v-seo,-kotoryie-trebuyut-vremeni.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="10 задач в SEO, которые требуют времени">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='10-zadach-v-seo,-kotoryie-trebuyut-vremeni.html';
