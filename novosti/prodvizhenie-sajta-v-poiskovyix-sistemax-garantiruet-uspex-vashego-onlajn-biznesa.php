...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Поисковая оптимизация (продвижение сайта в поисковых системах), выполненная специалистами, поможет передвинуть ваш сайт на высокие позиции и закрепить его там. А доверив нам раскрутку своего сайта, вы ещё долго будете ощущать эффект от выполненной работы." />
    <meta name="keywords" content="Поисковая оптимизация, SEO оптимизация, продвижение сайта" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Продвижение сайта в поисковых системах - схема работы | веб студия Redline</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/./shema-2.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Схема работы при продвижении сайтов"/>
<meta property="og:url" content="http://redline.by/novosti/prodvizhenie-sajta-v-poiskovyix-sistemax-garantiruet-uspex-vashego-onlajn-biznesa.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Схема работы при продвижении сайтов" href="prodvizhenie-sajta-v-poiskovyix-sistemax-garantiruet-uspex-vashego-onlajn-biznesa.html"><span itemprop="title">Схема работы при продвижении сайтов</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Продвижение сайта в поисковых системах - схема работы</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Схема работы при продвижении сайтов
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='prodvizhenie-sajta-v-poiskovyix-sistemax-garantiruet-uspex-vashego-onlajn-biznesa.html'>
                  <img alt='Схема работы при продвижении сайтов' src='../assets/cache_image/resources/shema-2_1600x487_490.jpg'>
                </a>
              </p>
              <p>Сайт вашего интернет-магазина готов. Он имеет презентабельный вид, в ассортименте - востребованный товар по конкурентной цене. Но продажи почему-то <strong>не растут</strong>. В чём же дело? Возможно, пришло время обратиться к специалистам, которые смогут обеспечить <a href="../uslugi/prodvizhenie-sajtov/default.htm">продвижение</a> сайта в поисковых системах.</p>
<h2>Зачем нужно заниматься продвижением сайтов в поисковиках:</h2>
<p>Известно, что практически 100 % пользователей впервые заходят в <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">интернет-магазины</a> или на сайты, предлагающие различные <a href="../uslugi/default.htm">услуги</a>, <strong>через ссылку</strong> в поисковиках. И только потом, оценив дизайн ресурса и разнообразие предложений, становятся постоянными клиентами, добавляют сайт <strong>в закладки</strong>.</p>
<p>А теперь малоизвестные факты. Оказывается, около <strong>80%</strong> пользователей интернета просматривают только<strong> первую</strong> страницу поисковой системы. До <strong>15%</strong> заходят на <strong>вторую</strong>. На <strong>третью</strong> заглядывают лишь <strong>5%.</strong></p>
<p>Теперь вы понимаете, как важно закрепиться на первой странице? И мы готовы вам в этом помочь.</p>
<p>Поисковая оптимизация (продвижение сайта в поисковых системах), выполненная специалистами, поможет передвинуть ваш сайт на <strong>высокие позиции</strong> и<strong> закрепить</strong> его там. А доверив нам <a href="raskrutka-sajta-v-poiskovyix-sistemax.html">раскрутку</a> своего сайта, вы ещё долго будете ощущать эффект от выполненной работы.</p>
<h2>Наша схема работы при продвижении сайтов</h2>
<p>Главное, что нужно знать клиенту о работе наших SEO-специалистов, это то, что они используют <strong>только разрешённые, легальные способы</strong> поисковой оптимизации. Это значит, что ваш сайт не будет подвергнут штрафным санкциям, отфильтрован поисковиками или забанен.</p>
<p>Поисковая оптимизация проводится поэтапно.</p>
<ol>
<li><span style="line-height:../1.5em;">Постановка совместно с заказчиком <strong>целей и задач</strong> кампании по продвижению и определение реального времени, за которое их можно достигнуть.</span></li>
<li><span style="line-height:../1.5em;"><strong>Анализ сайта</strong> и выявление технических и поисковых ошибок – так называемый первичный аудит.</span></li>
<li><span style="line-height:../1.5em;">Определение <strong>семантического ядра</strong> – слов и фраз, по которым пользователи будут находить ваш сайт.</span></li>
<li><span style="line-height:../1.5em;"> <strong>Устранение ошибок</strong>, которые выявлены при первичном аудите.</span></li>
<li><span style="line-height:../1.5em;">Продвижение сайта на <strong>первые позиции</strong>.</span></li>
</ol>
<h2>Почему стоит заказать продвижение сайта в поисковых системах именно у нас!</h2>
<p>Мы готовы предоставить вам <strong>качественную</strong> работу слаженной команды. Обратившись к нам вы сможете рассчитывать на:</p>
<ul>
<li><span style="line-height:../1.5em;">поисковую <strong>оптимизацию сайта</strong> в самых популярных поисковых системах страны с учётом целевых запросов;</span></li>
<li><span style="line-height:../1.5em;">использование только <strong>легальных и стабильных</strong> способов продвижения;</span></li>
<li><span style="line-height:../1.5em;">установление реальных сроков оптимизации и <strong>гарантированный результат</strong> по их истечению;</span></li>
<li><span style="line-height:../1.5em;">удобную и простую систему заказа услуг и фиксированную ежемесячную оплату.</span></li>
</ul>
<p>И главное, не забывайте: развитию любого бизнеса нужна помощь. Интернет-бизнес – не исключение. Доверьте часть забот по его развитию нам. И результат не заставит себя ждать.</p>
			  <p><a class="button" onclick="sub_name('Схема работы при продвижении сайтов','pikt')" href="#modalWindow">Оптимизировать сайт</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="prodvizhenie-sajta-v-poiskovyix-sistemax-garantiruet-uspex-vashego-onlajn-biznesa.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Схема работы при продвижении сайтов">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='prodvizhenie-sajta-v-poiskovyix-sistemax-garantiruet-uspex-vashego-onlajn-biznesa.html';
