...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Юбка допродаж это логическое продолжение воронки продаж" />
    <meta name="keywords" content="юбка допродаж, воронка продаж" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Юбка допродаж</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/yubka.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Юбка допродаж"/>
<meta property="og:url" content="http://redline.by/novosti/yubka-doprodazh.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Юбка допродаж" href="yubka-doprodazh.html"><span itemprop="title">Юбка допродаж</span></a></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='yubka-doprodazh.html'>
                  <img alt='Юбка допродаж' src='../assets/cache_image/resources/yubka_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Многие специалисты в области продаж понимают, что выгоднее <strong>удержать старого</strong> клиента, чем тратить в 10 раз больше средств на <strong>привлечение нового</strong>. Однако мало знать, нужно еще и предпринимать какие-то действия для построения долгосрочных отношений с теми, кто однажды обращался к вам. Работа с состоявшимися клиентами, это логическое продолжение воронки продаж, выражаясь метафорически – юбка допродаж.</p>
<p align="center"><img style="vertical-align: middle;" title="Юбка допродаж" src="../resources/news/16/7/ubka_prodaj.jpg" alt="Юбка допродаж" width="1209" height="843" /></p>
<p align="justify">Как видно на картинке, в юбке допродаж клиент проходит этапы, начиная от обычного покупателя и заканчивая ярым фанатом вашего бренда. Эти этапы можно расписать более подробно:</p>
<p align="justify"><strong>1) Покупатель. </strong>Потенциальный клиент обращается к вам в первый раз и совершает покупку.</p>
<p align="justify"><strong>2) Клиент. </strong>Покупатель совершивший повторную покупку превращается в клиента.</p>
<p align="justify"><strong>3) Постоянный покупатель. </strong>Делает систематические покупки у вас. Однако ему не принципиально важно где совершать покупку – у вас или у ваших конкурентов.</p>
<p align="justify"><strong>4) Приверженец. </strong>Приобретает товар исключительно у вас и не смотрит в сторону конкурентов.</p>
<p align="justify"><strong>5) Адвокат бренда. </strong>Приобретает товар исключительно у вас, не задумывается о конкурентах, а также советует всем своим знакомым обращаться именно к вам.</p>
<p align="justify">Пройдет ли покупатель все этапы до конца зависит от многих специалистов: маркетолог, продавец, менеджер и т.д. Можно бесчисленное множество раз обсуждать деловые правила поведения и говорить, что в бизнесе нет места личному. Но люди остаются людьми. Естественная природа человека мощнее любого свода корпоративных правил.</p>
<p align="justify">Любой человек оценит гуманное отношение, хотя может и не сказать об этом прямо. Всем приятно, когда кто-то может безвозмездно прийти на помощь и поспособствовать решению наших проблем. И тем более, вряд ли найдется человек, который останется равнодушен к любви и признанию его заслуг. Мы ценим все вышеперечисленные качества и стараемся сотрудничать с людьми, которые поддерживают нашу точку зрения.</p>
<p align="justify">С <strong>юбкой</strong> дела обстоят как и в реальной жизни – чем она длиннее, тем более серьезного отношения вы заслуживаете. Женщины не дадут соврать. Поэтому если вы нуждаетесь в <strong>лояльности клиентов</strong>, то советуем одеться по серьезнее.</p>
<p align="justify">К слову, если вам необходима <a href="../uslugi/razrabotka-sajtov/default.htm">качественная торговая площадка</a>, то вы можете обратиться в нашу <a href="../default.htm">веб-студию</a>, и мы поможем создать вам <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">интернет-магазин </a>в Витебске, Минске или в любом другом регионе нашей страны.</p>
			  <p><a class="button" onclick="sub_name('Юбка допродаж','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="yubka-doprodazh.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Юбка допродаж">
