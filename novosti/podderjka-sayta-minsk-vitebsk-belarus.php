...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Поддержка сайта – это совокупность работ, которые обеспечивают корректную функциональность сайта, а также его информационное наполнение." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Техническая, информационная и сервисная поддержка сайтов в Беларуси | веб студия Редлайн</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/support.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Поддержка сайта - техническая, информационная и сервисная"/>
<meta property="og:url" content="http://redline.by/novosti/podderjka-sayta-minsk-vitebsk-belarus.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Поддержка сайта - техническая, информационная и сервисная" href="podderjka-sayta-minsk-vitebsk-belarus.html"><span itemprop="title">Поддержка сайта - техническая, информационная и сервисная</span></a></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Поддержка сайта - техническая, информационная и сервисная
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='podderjka-sayta-minsk-vitebsk-belarus.html'>
                  <img alt='Поддержка сайта - техническая, информационная и сервисная' src='../assets/cache_image/resources/support_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">В наше время каждая серьезная компания осознает возможности, которые открывает для них интернет. Во-первых, благодаря ему Вы сможете в несколько раз увеличить свою целевую аудиторию, а во-вторых, вести деятельность в интернете гораздо удобнее, нежели в оффлайне. Однако <a href="../default.htm">создание сайта</a> – это лишь первая ступень на пути к успешному бизнесу. Каждому ресурсу необходима качественная поддержка, иначе сайт перестанет развиваться и его потеснят конкуренты. Именно поэтому в <a href="../default.htm">веб-студии RedLine</a> предусмотрена услуга по поддержке сайта, которая позволит оставаться Вашему проекту на плаву долгое время.</p>
<p align="center"><strong style="font-size: 18px;">Что такое поддержка сайта?</strong></p>
<p align="justify"><a href="../uslugi/dopolnitelnyie-uslugi/podderzhka-sajtov.html">Поддержка</a> сайта – это совокупность работ, которые обеспечивают корректную функциональность сайта, а также его информационное наполнение. Она необходима в тех случаях, когда не хватает собственных знаний на исправление технических ошибок или когда нет времени заниматься написанием контента. Стоит отметить, что существует несколько видов поддержки:</p>
<ul>
<li>Техническая поддержка;</li>
<li>Информационная поддержка;</li>
<li>Сервисная поддержка.</li>
</ul>
<p>Остановимся более подробно на каждом из них.</p>
<h2 align="center"><strong>Техническая поддержка сайта</strong></h2>
<p align="justify">Рано или поздно любой сайт выходит из строя или на нем что-нибудь ломается. Порой поломка настолько серьезная, что справиться с ней самому не представляется возможным. Именно в таких случаях потребуется услуга технической поддержки сайта. Техническое сопровождение направлено на организацию корректной работы сайта. Сюда можно отнести:</p>
<ul>
<li>Обеспечение бесперебойного функционирования сайта;</li>
<li>Внедрение нового функционала;</li>
<li>Внесение корректировок в дизайн (в том числе и <a href="../uslugi/dizajn-i-grafika/razrabotka-logotipa.html">разработка логотипа</a>);</li>
<li>Обеспечение сохранности базы данных;</li>
<li>Обеспечение правильной работы почты и т.д.</li>
</ul>
<h2 align="center"><strong>Информационная поддержка сайта</strong></h2>
<p align="justify">Под данным понятием подразумевается систематическое обновление информационных разделов сайта. Другими словами – добавление новой информации (как текстовой, так и мультимедийной).</p>
<p align="justify">Систематическое <a href="napolnenie-sajta-kontentom.html">наполнение сайта</a> необходимо ввиду нескольких причин. Во-первых, если ресурс редко обновляется, то его интерес в глазах пользователя падает. Кроме того, редкое обновление негативно сказывается на доверии, так как создается впечатление, что компания безразлична к своим клиентам. Во-вторых, поисковые системы также учитывают частоту обновлений сайта, что отражается на положении сайта в выдаче (чем реже обновления, тем ниже сайт).</p>
<p align="justify">Информационная поддержка сайта – важнейший элемент, который позволит зарекомендовать Вашу компанию, как эксперта в определенной области. Кроме того, можно добавить раздел вопрос-ответ, что позволит значительно сэкономить время агентам технической поддержки.</p>
<h2 align="center"><strong>Сервисная поддержка сайта</strong></h2>
<p align="justify">Данное понятие включает в себя поддержку существующих сервисов сайта, внедрение новых, а также их корректировку в соответствии с пожеланиями пользователей.</p>
<p align="justify">Под поддержкой существующих сервисов понимается обеспечение их корректной работы. Например, если у Вас на сайте имеется почтовая подписка, то нужно сделать так, чтобы письма доходили до всех адресатов. Если к ресурсу прикреплен форум, то нужно обеспечить на нем порядок с помощью модераторов и т.д.</p>
<p align="justify">Кроме сервисной поддержки сайта необходимо не оставлять без внимания различные пожелания Ваших посетителей. Например, кто-то сказал, что на сайте неудобная навигация, а кто-то пожаловался на непонятный каталог товаров. Конечно не стоит слепо вносить изменения после каждого обращения, так как всем мил не будешь, но к мнению большинства все же стоит прислушаться.</p>
<p align="justify">Создание новых сервисов необходимо для того, чтобы завладеть вниманием посетителя, расширить целевую аудиторию и сделать сайт более удобным для пользователя. Если нет никаких идей, то можно взглянуть на сайты конкурентов. Порой находятся достойные решения, которые можно перенять и модернизировать.</p>
<p align="justify">Как видите, поддержка сайта – довольно емкий процесс, который отнимет много времени и сил, а также требующий наличие определенных знаний в верстке и программировании. Именно поэтому мы рекомендуем доверить данный вопрос профессионалам. Просто позвоните нам и специалисты <a href="../default.htm">студии веб-дизайна RedLine</a> займутся наполнением и поддержкой Вашего проекта, что положительно отразится на конверсии и прибыльности сайта.</p>
			  <p><a class="button" onclick="sub_name('Поддержка сайта - техническая, информационная и сервисная','pikt')" href="#modalWindow">Заказать поддержку сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="podderjka-sayta-minsk-vitebsk-belarus.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Поддержка сайта - техническая, информационная и сервисная">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='podderjka-sayta-minsk-vitebsk-belarus.html';
