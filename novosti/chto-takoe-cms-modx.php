...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="MODX – это очередная бесплатная CMS, которая имеет открытый исходный код. Как и для множества других CMS ее работа требует поддержки от сервера PHP и MySQL. Данная система ориентирована на создание сайтов любой сложности, начиная от сайтов-визиток и заканчивая сложными интернет-магазинами." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>MODX - преимущества и недостатки создания веб сайтов на этой CMS | студия веб дизайна RedLine </title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/modx.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="МODx"/>
<meta property="og:url" content="http://redline.by/novosti/chto-takoe-cms-modx.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="МODx" href="chto-takoe-cms-modx.html"><span itemprop="title">МODx</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Преимущество создания сайта на  CMF МODx</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-takoe-cms-modx.html'>
                  <img alt='МODx' src='../assets/cache_image/resources/modx_1600x487_490.jpg'>
                </a>
              </p>
              <p> <strong style="font-size: 1.5em; line-height: 1.5em;">Что такое CMF М</strong><strong style="font-size: 1.5em; line-height: 1.5em;">ODX</strong><strong style="font-size: 1.5em; line-height: 1.5em;">? </strong></p>
<p>MODX – это очередная бесплатная CMS, которая имеет открытый исходный код. Как и для множества других CMS ее работа требует поддержки от сервера PHP и MySQL. Данная система ориентирована на <a href="../uslugi/razrabotka-sajtov/default.htm">создание сайтов</a> любой сложности, начиная от сайтов-визиток и заканчивая сложными интернет-магазинами. Как и большинство систем управления, MODX поддерживает дополнительные модули и сниппеты, которые позволяют расширить функциональность сайта. MODX не так распространена как, например, Wordpress или Joomla, однако это не делает ее хуже. Данная система не раз признавалась самой перспективной и входит в тройку лучших по версии журнала CMSmagazine.  </p>
<h3><strong>Преимущества сайта на </strong><strong>MODX</strong></h3>
<p>Данная CMS обладает действительно уникальными преимуществами, которыми не смогут похвастаться другие системы управления контентом.</p>
<p><strong>1) Гибкость.</strong></p>
<p>Сайты на MODX обладают нереальной гибкостью. Пожалуй, это главное преимущество данной системы по сравнению с Wordpress и Joomla. С помощью различных дополнений и особенностей строения движка, Вы сможете изменить любой элемент сайта до неузнаваемости.</p>
<p><strong>2) Скорость.</strong></p>
<p>Согласно статистическим данным, если сайт загружается дольше 5 секунд, то посетитель просто покидает его. Кроме того, с недавнего времени скорость сайта стала влиять на расположение сайта в поисковой выдаче. Если Вы не хотите столкнуться с данными проблемами, то MODX станет прекрасным выбором.</p>
<p><strong>3) СЕО оптимизированность.</strong></p>
<p><a href="../uslugi/prodvizhenie-sajtov/default.htm">CЕО оптимизация</a> движка – очередной приятный плюс, о котором необходимо упомянуть. Вы можете прописать мета-теги для каждой страницы, а использование ЧПУ только усилит эффект.</p>
<p><strong>4) Надежность.</strong></p>
<p>Сайты на MODX отличаются своей надежностью и стабильностью. Кроме того, существует русскоязычное сообщество, где Вы можете задать любой вопрос по данной системе и получить квалифицированный ответ.</p>
<p><strong>5) Удобство. </strong></p>
<p>Владельцу сайта не обязательно знать языки программирования, чтобы вносить изменения на сайт. Интуитивно понятный интерфейс позволит управлять сайтом даже человеку далекому от сайтостроения.</p>
<h3><strong>Недостатки сайта на </strong><strong>MODX</strong></h3>
<p>Как и все CMS, MODX имеет свои недостатки.</p>
<p><strong>1) Молодость системы.</strong></p>
<p>Данный недостаток выражается в том, что до сих пор отсутствуют некоторые функции, в некоторых местах код движка не совсем оптимизирован, недостаточно развито русскоязычное сообщество (например, как у Wordpress или Joomla). Однако система постоянно развивается и это лишь вопрос времени.</p>
<p><strong>2) Слабая документация.</strong></p>
<p>Отсутствует толковая русскоязычная документация, да и в англоязычной есть некоторые упущения. Существуют небольшие статьи на русском языке, однако с помощью них Вы не получите комплексное представление о системе. </p>
<h2><strong>Разработка сайта на </strong><strong>MODX</strong><strong> в студии веб-дизайна </strong><strong>RedLine</strong><strong>.</strong></h2>
<p><a href="../default.htm">Наши сотрудники</a> работают с различными системами управления, MODX – одна из них. Обратившись к нам, мы предложим различный функционал на основе задач и целей бизнеса, а Вам останется лишь сделать выбор в пользу конкретных решений. Кроме того, мы создадим <a href="../uslugi/razrabotka-firmennogo-stilya.html">уникальный дизайн</a>, а при необходимости займемся разработкой логотипа, что позволит клиентам с легкостью идентифицировать Вашу деятельность в сети. В результате Вы получите качественный и привлекательный сайт на MODX, который, в скором времени, превратится в стабильный источник дохода.</p>
<p><strong> </strong></p>
<p> </p>
			  <p><a class="button" onclick="sub_name('МODx','pikt')" href="#modalWindow">Заказать сайт на MODX </a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-takoe-cms-modx.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="МODx">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-takoe-cms-modx.html';
