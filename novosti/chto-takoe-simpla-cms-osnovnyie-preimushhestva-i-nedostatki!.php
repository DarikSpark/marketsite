...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Simpla – очередная система управления контентом, которая позволит Вам создать интернет-магазин. Она имеет открытый исходный код, но в отличие от OpenCart она не бесплатна. Для ее установки необходимо, чтобы веб-сервер поддерживал работу с PHP и MySQL, что в наше время не является проблемой" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Что такое Simpla CMS? Основные преимущества и недостатки!</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/simpla.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Simpla"/>
<meta property="og:url" content="http://redline.by/novosti/chto-takoe-simpla-cms-osnovnyie-preimushhestva-i-nedostatki!.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Simpla" href="chto-takoe-simpla-cms-osnovnyie-preimushhestva-i-nedostatki!.html"><span itemprop="title">Simpla</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Что такое Simpla CMS? Основные преимущества и недостатки!</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-takoe-simpla-cms-osnovnyie-preimushhestva-i-nedostatki!.html'>
                  <img alt='Simpla' src='../assets/cache_image/resources/simpla_1600x487_490.jpg'>
                </a>
              </p>
              <h2><strong>Что такое </strong><strong>Simpla CMS</strong><strong>?</strong></h2>
<p>Simpla – очередная система управления контентом, которая позволит Вам <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">создать интернет-магазин</a>. Она имеет открытый исходный код, но в отличие от OpenCart она не бесплатна. Для ее установки необходимо, чтобы веб-сервер поддерживал работу с PHP и MySQL, что в наше время не является проблемой. Основным преимуществом данной системы является направленность на русскоязычную аудиторию, чем не может похвастаться OpenCart. Как и в большинстве CMS, ее создатели предусмотрели возможность поддержи системы сторонними разработчиками. Благодаря этому Вы можете расширять функциональность сайта на Simpla с помощью специальных модулей. Кроме того, присутствует возможность интеграции с русскоязычными программами ведения отчетности, а также возможность произведения оплаты с помощью различных платежных систем (WebMoney, PayPal, Яндекс.Деньги и т.д.).</p>
<h3><strong>Преимущества сайта на </strong><strong>Simpla</strong></h3>
<p>Как и любая система управления Simpla обладает своими преимуществами:</p>
<p><strong>1) Простота управления.</strong></p>
<p>Панель управления тщательно продумана и разобраться с ней не составит труда. С помощью нее Вы сможете разграничивать права менеджеров, сортировать товары с помощью перетаскивания, заниматься наполнением контента, а автоматическая проверка правописания избавит Вас нудного процесса вычитки текстов.</p>
<p><strong>2) Интеграция с 1</strong><strong>C</strong><strong>, МойСклад и Класс365.</strong></p>
<p>Огромным преимуществом сайтов на Simpla является то, что Вы можете интегрировать их с русскоязычными CMR сервисами – Класс365, МойСклад, а также 1С.</p>
<p><strong>3) Функциональность.</strong></p>
<p>Данная система позволяет создавать каталог товаров со сложной структурой, добавлять им свойства и отображать похожие. Кроме того, посетители смогут оставить отзыв о покупке, а также имеется возможность отображения водяных знаков для товаров.</p>
<p><strong>4) Гибкий дизайн.</strong></p>
<p>Вы можете настроить дизайн темы не прибегая к редактированию кода. Для этих целей существует специальный редактор с выделением синтаксиса, который находится в административной панели.</p>
<p><strong>5) Разнообразие платежных систем. </strong></p>
<p>Как уже говорилось ранее, сайты на Simpla предоставляют широкие возможности покупателям для совершения оплаты товара. Система позволяет интегрировать самые популярные платежные системы (англоязычные и русскоязычные). Это позволит практически мгновенно совершать любую покупку.</p>
<p><strong>6) Поисковая оптимизация.</strong></p>
<p>Разработчики позаботились о <a href="../uslugi/prodvizhenie-sajtov/default.htm">СЕО оптимизации системы</a>. Она способна в автоматическом режиме генерировать мета-теги, создавать карту сайта для поисковиков, а также имеет возможность настройки ЧПУ.</p>
<p><strong>7) Надежность.</strong></p>
<p>Данная система прекрасно защищена от взлома и различного рода атак (в том числе и SQL-инъекций). Кроме того, имеется встроенная система резервного копирования, которая позволит избежать потери данных в случае технических неполадок. Также она пригодится при переезде к другому хостинг провайдеру.</p>
<p><strong>8) Высокая скорость.</strong></p>
<p>Она обеспечивается грамотной оптимизацией кода движка. Как утверждают разработчики, в среднем, размер потребляемой памяти не превышает 3 мб. Именно поэтому данная система отлично установится даже на самый дешевый тарифный план хостинга.</p>
<p><strong>Недостатки сайта на </strong><strong>Simpla</strong></p>
<p><strong>1) Коммерческое распространение.</strong></p>
<p>Самый главный недостаток, который может перекрыть все плюсы – коммерческое распространение. Однако если Вы собираетесь делать серьезный и качественный проект, то ее цена окупится во много раз.</p>
<p><strong>2) Недостаточная распространенность.</strong></p>
<p>Из-за недостаточной распространенности и молодости системы невозможно реализовать некоторый функционал. Кроме того, Simpla предлагает всего одну тему оформления, в отличие от других CMS. Однако ее можно отредактировать с помощью встроенных инструментов.</p>
<h2><strong>Разработка сайта на </strong><strong>Simpla</strong><strong> в веб-студии </strong><strong>RedLine</strong></h2>
<p>Наши специалисты имеют опыт <a href="../uslugi/razrabotka-sajtov/default.htm">разработки сайтов</a> с использованием различных систем управления, включая CMS Simpla. Обратившись в <a href="../default.htm">студию веб-дизайна RedLine</a>, мы тщательно оговорим все детали, касающиеся функциональности Вашего будущего проекта. Мы предоставим на выбор несколько вариантов дизайна, а Вам лишь останется выбрать наиболее подходящий. Если потребуется <a href="../uslugi/razrabotka-firmennogo-stilya.html">разработка фирменного стиля</a>, то это не станет для нас проблемой. В итоге вы получите полнофункциональный интернет-магазин, который будет не только привлекательным и удобным для пользователя, но и станет стабильным источником Вашей прибыли.</p>
			  <p><a class="button" onclick="sub_name('Simpla','pikt')" href="#modalWindow">Заказать интернет-магазин на Simpla CMS</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-takoe-simpla-cms-osnovnyie-preimushhestva-i-nedostatki!.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Simpla">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-takoe-simpla-cms-osnovnyie-preimushhestva-i-nedostatki!.html';
