...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Два полезных инструмента Google Analytics, которые позволят увидеть процесс приобретения товара совершенно под другим углом" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Google Analytics - как происходит покупка товара</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/google-analytics.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Google Analytics - как происходит покупка товара"/>
<meta property="og:url" content="http://redline.by/novosti/google-analytics-kak-proisxodit-pokupka-tovara.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Google Analytics - как происходит покупка товара" href="google-analytics-kak-proisxodit-pokupka-tovara.html"><span itemprop="title">Google Analytics - как происходит покупка товара</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Google Analytics - как происходит покупка товара</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Google Analytics - как происходит покупка товара
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='google-analytics-kak-proisxodit-pokupka-tovara.html'>
                  <img alt='Google Analytics - как происходит покупка товара' src='../assets/cache_image/resources/google-analytics_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">В данной статье речь пойдет о двух полезных инструментах Google Analytics, которые позволят увидеть процесс приобретения товара совершенно под другим углом. Если быть более конкретным, то мы поговорим об ассоциированных конверсиях и о том, для чего они необходимы.</p>
<p align="justify">Стоит отметить, для того, чтобы Вы смогли в полной мере применить знания полученные из данной статьи, Вам пригодится счетчик Google Analytics и настроенные цели внутри него. Произведя настройку придется немного подождать, так как данные появятся спустя некоторое время (начиная от пары дней и заканчивая несколькими месяцами – зависит от количества трафика). После этого можно начинать.</p>
<h3 align="center"><strong>Ассоциированные конверсии: что это такое</strong></h3>
<p align="center"><img title="Ассоциированные конверсии" src="../resources/news/16/01/08/2/image001.jpg" alt="Ассоциированные конверсии" width="600" height="200" /></p>
<p align="center"><em>В большинстве случаев, покупатели не сразу совершают покупку, а делают несколько касаний, т.е. переходят на Ваш веб-ресурс или видят рекламу Вашей компании в других источниках.</em></p>
<p align="justify">Если посетитель приходил по различным каналам, а прибрел товар придя через третий, то конверсия зачтется именно по нему. А предыдущим двум каналам зачтутся <strong>ассоциированные конверсии</strong>, так как они значительно поспособствовали покупке товара.</p>
<p align="justify">Разберем следующий пример: Вы вкладываете 30$ для продвижения с помощью <a href="../uslugi/prodvizhenie-sajtov/kontekstnaya-reklama.html">контекстной рекламы</a> Яндекс, Вконтакте и <a href="../uslugi/prodvizhenie-sajtov/e-mail-marketing.html">почтовой рассылки</a>. Однако вся конверсия происходит только с переходов из Яндекс.Директ. Логично предположить, что в таком случае необходимо деактивировать почтовую рассылку и рекламу Вконтакте (или же как-то ее подкорректировать). Но Вы можете совершить катастрофическую ошибку, особенно если Вы вкладывали не 30$, а, к примеру, 3000$.</p>
<p align="justify">Ошибка заключается в том, что Вы просто не учли каким образом совершена покупка. Представьте, что все покупатели принимают мгновенное решение о покупке (или об отказе от нее). Но ведь на самом деле это далеко не так.</p>
<h3 align="center"><strong>Как происходит покупка</strong></h3>
<p align="center"><img title="Как происходит покупка" src="../resources/news/16/01/08/2/image002.jpg" alt="Как происходит покупка" width="528" height="167" /></p>
<p align="center"><em>В действительности, нужно учесть все касания. Это поможет более точно оценить расходы и распределить используемый бюджет.</em></p>
<p align="justify">Когда посетитель не готов совершить покупку сразу, то он начинает спорить сам с собой, анализировать другие предложения на рынке, дожидаться зарплаты и т.д. Во всех перечисленных случаях конверсия не произойдет в данный момент или в этот же день. На это потребуется некоторое время. Если провести параллели с покупкой автомобиля или недвижимости, то 90% приобретений требуют определенного времени и изучения информации о приобретаемом товаре.</p>
<p align="justify">Для того, чтобы подтолкнуть «думающих» посетителей на приобретение необходимого товара, было придумано множество разнообразных инструментов, к ним можно отнести:</p>
<div align="justify">
<ul>
<li><a href="../default.htm">Создание сайта</a> или блога;</li>
<li>Почтовый маркетинг с привлекающими акциями;</li>
<li><a href="../uslugi/prodvizhenie-sajtov/prodvizhenie-grupp-i-publichnyix-stranicz-v-soczialnyix-setyax.html">Паблики и группы в социальных сетях</a>;</li>
<li><a href="retargeting-v-yandeks.direkt.-poshagovaya-instrukcziya-po-nastrojke.html">Ремаркетинг</a> и т.д.</li>
</ul>
</div>
<p align="justify">Однако существует одна проблема, которая обусловлена разнообразными источниками трафика – <strong>невозможность понять, кто принес пользу определенного вида. </strong>А если быть точнее, то благодаря кому случилась прямая конверсия (клик –&gt; приобретение товара), а благодаря кому ассоциированная (клик –&gt; выход, клик -&gt; приобретение товара). Но ее решили в Google Analytics.</p>
<h3 align="center"><strong>Процесс приобретения и анализ отчета</strong></h3>
<p align="center"><img title="Процесс приобретения и анализ отчета" src="../resources/news/16/01/08/2/image003.jpg" alt="Процесс приобретения и анализ отчета" width="900" height="286" /></p>
<p align="center"><em>Один из отчетов ассоциированных конверсий в </em><em>Google</em><em>Analytics</em><em>.</em></p>
<p align="justify">Google Analytics хранит путь приобретения покупателя в течение одного месяца. Взглянуть на вспомогательные конверсии Вы сможете открыв вкладку «Конверсии», затем кликнуть на «Многоканальные последовательности» и перейди к подзаголовку «Ассоциированные конверсии». В первую очередь, необходимо установить главные настройки отчета, в них входят: цели для анализа, тип трафика, и время, которое потребовалось для совершения покупки.</p>
<p align="justify">Теперь, с помощью таблицы (ее скриншот расположен выше), можно определить сколько ассоциированных конверсий приносит тот или иной канал. В том случае, если Вы указали ценность цели или добавили модуль электронной торговли, то в таблице учтется примерная сумма средств с каждой конверсии. Кроме того, в столбце «Ценность ассоциированных конверсий» отобразятся данные о их прибыльности.</p>
<p align="justify">Также стоит учитывать данные из столбца «Ассоциированные конверсии / конверсии по последнему клику или прямому взаимодействию». В нем указываются цифровые значения. Если они приближаются к нулевой отметке, то канал ближе к прямому источнику продаж, а если значение &gt;1, то он имеет вспомогательную роль. Единичка в данной графе означает, что канал равносильно оказывает помощь и продает сам.</p>
<p align="justify">Работая с данным отчетом можно прибегнуть к принципу Парето. Если рейтинг канала &lt;1.25, то для него нужно выделить около 80% рекламных средств, а для канала с рейтингом &gt;1.25 предоставляется 20% средств.</p>
<p align="justify">Мы лишь вкратце описали возможности данного отчета, для более глубокого понимания рекомендуем воспользоваться справкой Google.</p>
<p align="justify"><strong>Подытожим </strong></p>
<p align="justify">Товары, приобретаемые в интернете можно разделить на 2 вида:</p>
<div align="justify">
<ul>
<li>Моментальные;</li>
<li>Отложенные.</li>
...
<p align="justify">Для определения корректной прибыльности канала необходимо произвести <a href="../uslugi/prodvizhenie-sajtov/default.htm">настройку</a> счетчика аналитики и проанализировать полученные данные по ассоциированным конверсиям.</p>
<p align="justify">Обратившись в нашу <a href="../default.htm">студию веб-дизайна</a> мы поможем произвести настройку Google Analytics, а также проведем все необходимы работы, которые позволят увеличить конверсию Вашего сайта.</p>
			  <p><a class="button" onclick="sub_name('Google Analytics - как происходит покупка товара','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="google-analytics-kak-proisxodit-pokupka-tovara.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Google Analytics - как происходит покупка товара">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='google-analytics-kak-proisxodit-pokupka-tovara.html';
