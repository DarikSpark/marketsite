...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Одностраничный сайт имеет множество преимуществ. Благодаря минималистичному дизайну он смотрится гораздо привлекательнее, а отсутствие ненужной информации позволяет добиться высоких показателей конверсии.Примеры одностраничных сайтов разработанных студией эффективного веб дизайна RedLine" />
    <meta name="keywords" content="Landing page, Лендинг, Одностраничный сайт" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Одностраничные сайты - лучшие примеры</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/./lp-2.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Одностраничные сайты - лучшие примеры"/>
<meta property="og:url" content="http://redline.by/novosti/odnostranichnie-sajti-primeri.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Одностраничные сайты - лучшие примеры" href="odnostranichnie-sajti-primeri.html"><span itemprop="title">Одностраничные сайты - лучшие примеры</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Одностраничные сайты - лучшие примеры</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='odnostranichnie-sajti-primeri.html'>
                  <img alt='Одностраничные сайты - лучшие примеры' src='../assets/cache_image/resources/lp-2_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">В настоящее время лендинги приобрели огромную популярность среди веб-мастеров. Они используются, как для создания собственных проектов, так и для продвижения клиентских товаров и услуг.</p>
<p align="justify">Одностраничный сайт имеет множество преимуществ. Благодаря минималистичному дизайну он смотрится гораздо привлекательнее, а отсутствие ненужной информации позволяет добиться высоких показателей конверсии.</p>
<p align="justify">Одностраничник – это лучший вариант для старта небольшого интернет-бизнеса, так как на его создание уходит немного времени и средств. Однако сайты с одной страницей подойдут не для всех случаев. В данной статье мы более подробно разберем ситуации, когда нужно прибегать к созданию лендинга, а когда стоит воздержаться от этой затеи. Кроме того, мы приведем примеры одностраничного сайта и разберем их особенности.</p>
<h3 align="center"><strong>Хватит ли одной страницы?</strong></h3>
<p align="justify">Для того, чтобы ответить на этот вопрос, нужно учесть некоторые детали. Прежде, чем <a href="../uslugi/razrabotka-sajtov/lending.html">заказать лендинг</a> ответьте себе на следующие вопросы:</p>
<p align="justify"><strong>1) Вы занимаетесь продажей какого-либо товара или услуги?</strong></p>
<p align="justify">Если ответ утвердительный, то одностраничный сайт может стать отличной платформой для реализации разнообразных товаров, начиная от книг и заканчивая пластиковыми окнами.</p>
<p align="justify"><strong>2) Как много будет информации размещено на Вашем веб-ресурсе?</strong></p>
<p align="justify">Сайты с объемным контентом - не самое оптимальное решение. Если сайт имеет больше 10 полноценных страниц, то лучше смотреть в сторону <a href="../uslugi/razrabotka-sajtov/korporativnyij-sajt/default.htm">корпоративного сайта</a>.</p>
<p align="justify"><strong>3) Не навредит ли применение </strong><strong>Ajax</strong><strong> и </strong><strong>JavaScript</strong><strong>?</strong></p>
<p align="justify">Зачастую, на лендингах используют JavaScript для реализации навигации по сайту, а также для оформления иных элементов. Это является наиболее подходящим вариантом для тех случаев, когда на страницу необходимо поместить достаточно много информации.</p>
<p align="justify"><strong>4) Есть ли логическая связь между информацией?</strong></p>
<p align="justify">Если Вы размещаете несвязанную по смыслу информацию на одной странице, то это только введет пользователя в заблуждение. Нужно максимально четко структурировать текст по смыслу или придется размещать его на отдельных страницах.</p>
<h2 align="center">Примеры одностраничных сайтов из нашего портфолио</h2>
<p align="justify">Убирая лишние элементы в дизайне и оставляя в текстах самую суть, Вы в разы повышаете конверсию лендинга. Кроме того, стоит позаботиться о том, чтобы весь контент загружался синхронно. При использовании плавных переходов между разделами одностраничного сайта нужно определиться с объемом отображаемой информации, так как могут появиться подвисания (в первую очередь из-за избытка графической информации).</p>
<p align="justify">5 отображаемых разделов – это золотой стандарт, который позволит сайту мгновенно загружаться. Для некоторых сайтов и вовсе будет достаточно двух или трех. Крайне не рекомендуется использовать 10 и более разделов. Во-первых это замедлит загрузку лендинга, а во-вторых, полоса прокрутки станет слишком огромной, а это создаст значительные неудобства для посетителей.</p>
<p align="center"><img title="пример одностраничного сайта с тремя отображаемыми разделами" src="../resources/news/16/01/08/image001.jpg" alt="пример одностраничного сайта с тремя отображаемыми разделами" width="623" height="356" /></p>
<p align="center"><!--noindex--><a href="../../vozimgruz.by/default.htm" rel="nofollow"><em>http://vozimgruz.by</em></a><!--/noindex--><em> – пример одностраничного сайта <em>созданного нами </em> с тремя отображаемыми разделами.</em></p>
<h3 align="center"><strong>Сайты использующие горизонтальную прокрутку</strong></h3>
<p align="justify">Естественно, что далеко не все сайты имеющие горизонтальную прокрутку – одностраничники. Но все же это достаточно оригинальный и необычный вариант, который может оказаться приемлемым для использования на некоторых ресурсах.</p>
<p align="justify">Основным плюсом горизонтальной прокрутки можно считать скорость загрузки, которая будет немного выше, даже если страница под завязку наполнена контентом. А элементы на JavaScript добавят динамичности и позволят <a href="../uslugi/dizajn-i-grafika/razrabotka-firmennogo-stilya/default.htm">разработать фирменный</a> стиль ресурса.</p>
<p align="center"><img title="пример лендинга с горизонтальным слайдером" src="../resources/news/16/7/2016-08-02_15-59-48.png" alt="пример лендинга с горизонтальным слайдером" width="624" height="364" /></p>
<p align="center"><!--noindex--><em><a href="../../m-press.by/default.htm" rel="nofollow" target="_blank">m-press.by</a> – пример нашего сайта, с горизонтальным слайдером.</em></p>
<h3 align="center"><strong>Сайты использующие вертикальную прокрутку</strong></h3>
<p align="justify">Данный метод прокрутки гораздо более популярен, так как для большинства сайтов он будет более удобным и практичным. Кроме того, по сути, вся прокрутка сводится к минимуму, благодаря кнопкам навигации, с помощью которых происходит перемещение по странице, а также кнопке «вверх», которая возвратит пользователя на главный экран.</p>
<p align="center"><img title="пример лендинг пейдж с использованием вертикальной прокрутки" src="../resources/news/16/7/2016-08-02_15-38-54.png" alt="пример лендинг пейдж с использованием вертикальной прокрутки" width="624" height="431" /></p>
<p align="center"><em><a href="../../salon-anturage.by/default.htm" rel="nofollow" target="_blank">http://salon-anturage.by/ </a>– пример нашего сайта, с использованием вертикальной прокрутки.</em></p>
<h3 align="center"><strong>Использование большого и яркого бэкграунда</strong></h3>
<p align="justify">Данное решение используется во всех видах дизайна веб-ресурса, но <a href="../uslugi/razrabotka-sajtov/lending.html">разработка landing page</a> предоставляет более широкие возможности для использования различных вариаций оформления. Иногда большие изображения применяются для зонирования разделов сайта, но несмотря на это они будут иметь единый стиль.</p>
<p align="justify">Например, стартовый экран начинается с неба, пролистав ниже, происходит плавный переход к земле (здания, люди, автомобили), а в самом низу Вас ждет подземный мир со всеми его обитателями. Простор для фантазии просто безграничен.</p>
<p align="center"><img title="Пример сайта с большим, ярким и многоуровневым бэкграундом" src="../resources/news/16/01/08/image004.jpg" alt="Пример сайта с большим, ярким и многоуровневым бэкграундом" width="624" height="356" /></p>
<p align="center"><!--noindex--><em>http://www.septicdom.by</em><!--/noindex--><em> – пример созданного нами сайта с большим, ярким и многоуровневым бэкграундом.</em></p>
<h3 align="center"><strong>Применение эффектов на </strong><strong>JavaScript</strong><strong> и </strong><strong>Ajax</strong></h3>
<p align="justify">Если информации слишком много, но необходимо все уместить на одну страницу, то можно воспользоваться инструментами Ajax и JavaScript. На данный момент наиболее широкое распространение получили слайдеры и всплывающие окна.</p>
<p align="center"><img title="пример сайта, на котором используется всплывающее окно" src="../resources/news/16/7/2016-08-02_15-46-45.png" alt="пример сайта, на котором используется всплывающее окно" width="624" height="231" /></p>
<p align="center"><!--noindex--><em><a href="../../orbita.of.by/default.htm" rel="nofollow" target="_blank">orbita.of.by</a> – пример нашего сайта, на котором используется всплывающее окно. </em></p>
<p align="justify">Мы продемонстрировали наиболее распространенные тенденции в лендингах на примере нашего портфолио. Обращаясь к нам и Вы сможете заказать лендинг, а мы, в свою очередь, реализуем его с учетом всех Ваших пожеланий. Специалисты <a href="../default.htm">веб студии RedLine</a> имеют большой опыт создания и <a href="../uslugi/prodvizhenie-sajtov/default.htm">SEO продвижения сайтов</a>, поэтому в процессе работы с нами не возникнет никаких проблем.</p>
			  <p><a class="button" onclick="sub_name('Одностраничные сайты - лучшие примеры','pikt')" href="#modalWindow">Заказать разработку Лендинг Пейдж</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="odnostranichnie-sajti-primeri.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Одностраничные сайты - лучшие примеры">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='odnostranichnie-sajti-primeri.html';
