...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Рекомендации по сбору ключевых слов с помощью сервиса Яндекс.Вордстат и размещения их в статье" />
    <meta name="keywords" content="Ключевые слова, Продвижение сайта, написание сео-статей, оптимизированные статьи" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Где брать ключевые слова и как их использовать | Веб студия Redline</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/keywords.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Где брать ключевые слова и как их использовать"/>
<meta property="og:url" content="http://redline.by/novosti/gde-brat-klyuchevyie-slova-i-kak-ix-ispolzovat.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Где брать ключевые слова и как их использовать" href="gde-brat-klyuchevyie-slova-i-kak-ix-ispolzovat.html"><span itemprop="title">Где брать ключевые слова и как их использовать</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Где брать ключевые слова и как их использовать</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Где брать ключевые слова и как их использовать
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='gde-brat-klyuchevyie-slova-i-kak-ix-ispolzovat.html'>
                  <img alt='Где брать ключевые слова и как их использовать' src='../assets/cache_image/resources/keywords_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">В данной статье мы продемонстрируем на примерах откуда берутся ключевые слова и дадим советы по их эффективному использованию.</p>
<h2 align="center"><strong>Самый распространенный способ подбора ключевиков </strong></h2>
<p align="justify">Все очень просто. Ключевые слова нам поможет подобрать Яндекс.Вордстат (о данном сервисе <a href="instrukciya-dlya-raboti-v-yandeks.wordstat.html">мы писали ранее</a>). Для этого нужно авторизироваться в своем аккаунте (или зарегистрировать новый, если его нет) и зайти на страницу сервиса.</p>
<p align="center"><a href="../../convertmonster.ru/wp-content/uploads/Podbor-kluchevih-slov-dlya-seo-wordstat.png" target="_blank"><img src="../resources/news/151218/image001.png" alt="Так происходит подбор ключевых слов для оптимизации контента с помощью Яндекс.Вордстат." width="624" height="374" /></a></p>
<p align="center"><em>Так происходит подбор ключевых слов для оптимизации контента с помощью Яндекс.Вордстат.</em></p>
<p align="justify">В строку поиска вводим словосочетание, для которого мы ищем ключевики. Кликаем на кнопку «Подобрать» и сервис выдает нам список запросов, которые люди искали в последнее время. Стоит отметить, что достаточно часто встречаются <strong>мусорные запросы</strong>, которые нельзя использовать при <a href="../uslugi/prodvizhenie-sajtov/default.htm">SEO-оптимизации контента</a>. Поэтому нужно очень тщательно проверять весь список на наличие таких слов и <strong>отсеивать</strong> все ненужное. Для этого есть несколько способов:</p>
<ol>
<li>Удалять лишние слова прямо на странице сервиса (может периодически появляться капча).</li>
<li>Скопировать все запросы в Excel и очистить мусор с помощью фильтра.</li>
</ol>
<p align="justify">Для первого варианта нужно использовать специальный <strong>префикс</strong> перед запросом (без пробела). Слова, как обычно, разделяются пробелом. Для большей наглядности посмотрите на скриншот:</p>
<p align="center"><img src="../resources/news/151218/image002.png" alt="Убираем лишние слова при подборе ключевиков" width="633" height="394" /></p>
<p align="center"><em>Убираем лишние слова при подборе ключевиков.</em></p>
<p align="justify">В итоге мы сможем собрать самые необходимые ключевые слова, которые пригодятся нам для оптимизации контента. О том, как их использовать вы сможете прочесть далее.</p>
<h2 align="center"><strong>Как избежать переспама ключевыми словами?</strong></h2>
<p align="justify">Яндекс.Вордстат сортирует ключевые слова начиная от самых популярных и заканчивая самыми редкими. Для того, чтобы создать статью, которая будет отвечать на высокочастотный запрос, мы должны отсеять <strong>20 лучших</strong> запросов с первой страницы. Если необходимо обеспечить поток посетителей по низкочастотным запросам, то нужно листать в низ выдачи и использовать слова имеющие вплоть до 5 показов.</p>
<h2 align="center"><strong>Как правильно использовать ключевики в статье?</strong></h2>
<p align="justify">Продемонстрируем это на данной статье. Для того, чтобы поисковый робот посчитал текст релевантным поисковому запросу, он должен <strong>в неизменном виде</strong> использоваться в статье. То есть в таком же числе и в таком же склонении. Как на вот этой картинке:</p>
<p align="center"><img src="../resources/news/151218/image003.png" alt="Использование ключевиков в оптимизированном тексте" width="640" height="172" /></p>
<p align="center"><em>Использование ключевиков в оптимизированном тексте.</em></p>
<p align="center"><img src="../resources/news/151218/image004.png" alt="Добавляем ключевики в начале текста" width="639" height="125" /></p>
<p align="center"><em>Добавляем ключевики в начале текста.</em></p>
<p align="justify">Разбивать ключевую фразу другими словами можно, но желательно делать это в пределах <strong>одного предложения</strong>.</p>
<h2 align="center"><strong>Полезные рекомендации по использованию ключевиков в тексте</strong></h2>
<ol>
<li>При написании оптимизированной статьи, клaючевые запросы рекомендуется использовать в <strong>начале</strong> текста.</li>
<li>Не стоит злоупотреблять точным вхождением ключевой фразы. Возможно употребление различных словоформ.</li>
<li>Не используйте один и тот же ключ <strong>много раз</strong>. Поисковая система может посчитать это за переспам и наложить на ваш ресурс фильтр.</li>
</ol>
<p align="justify">И самое главное, нужно помнить, что попадая на вашу статью, пользователь должен получить лучший ответ на введенный запрос. Качественная статья положительно скажется на поведенческих факторах, что, в свою очередь, поможет сайту занять <strong>высокие места</strong> в поисковой выдаче.</p>
<blockquote>
<p class="justifyfull" align="justify"><strong>Стоит отметить, что оптимизированные статьи не дают стопроцентной гарантии, что ваш сайт окажется высоко в выдаче (особенно по конкурентным запросам). <a href="../default.htm">Наша веб-студия</a> поможет вывести ваш ресурс в топ, используя комплексные методы продвижения. </strong></p>
</blockquote>
			  <p><a class="button" onclick="sub_name('Где брать ключевые слова и как их использовать','pikt')" href="#modalWindow">Заказать сбор семантического ядра</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="gde-brat-klyuchevyie-slova-i-kak-ix-ispolzovat.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Где брать ключевые слова и как их использовать">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='gde-brat-klyuchevyie-slova-i-kak-ix-ispolzovat.html';
