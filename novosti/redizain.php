...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Редизайн -  это изменение внешнего вида сайта (дизайн-шаблон, шрифт, фон). Модернизация более широкое понятие, которое может включать в себя изменения в дизайне, в функциональной и в технической составляющей веб-ресурса." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Когда нужен редизайн или модернизация сайта?</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/./1234974.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Когда нужен редизайн или модернизация сайта?"/>
<meta property="og:url" content="http://redline.by/novosti/redizain.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Когда нужен редизайн или модернизация сайта?" href="redizain.html"><span itemprop="title">Когда нужен редизайн или модернизация сайта?</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Когда нужен редизайн или модернизация сайта?</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Когда нужен редизайн или модернизация сайта?
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='redizain.html'>
                  <img alt='Когда нужен редизайн или модернизация сайта?' src='../assets/cache_image/resources/1234974_1600x487_490.jpg'>
                </a>
              </p>
              <p>Каждые 2-3 года перед владельцем стабильно должен вставать<strong> вопрос о редизайне</strong> или <strong>модернизации сайта</strong>: технологии идут вперед, все меняется, веб-сайты созданные несколько лет назад кажутся смешными, некрасивыми и неудобными, а пятилетней давности воспринимаются как музейный экспонат.</p>
<h2>Чем же отличается понятие редизайна от модернизации?</h2>
<p><strong>Редизайн</strong> - это изменение внешнего вида сайта (дизайн-шаблон, шрифт, фон). <strong>Модернизация</strong> более широкое понятие, которое может включать в себя изменения в дизайне, в функциональной и в технической составляющей веб-ресурса. Не всегда ощущение того, что веб-сайту необходимы изменения, приходит вовремя. Особенно, если часто им пользуешься, все кажется понятным, привычным и удобным. Помните ли Вы эти популярные площадки в первоначальном виде?</p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" title="Редизайн и модернизация веб сайтов" src="../resources/_25D0_2591_25D0_25B5_25D0_25B7_25D1_258B_25D0_25BC_25D1_258F_25D0_25BD_25D0_25BD_25D1_258B_25D0_25B9.JPG" alt="редизайн популярных интернер ресурсов и сайтов" width="461" height="978" /></p>
<p>После такого наглядного доказательства, каждый владелец интернет-ресурса задумается: а все ли в порядке с моим сайтом или уже есть необходимость что-то менять?</p>
<h2>Главные причины модернизирования:</h2>
<ul>
<li><strong>Плохое юзабилити</strong></li>
</ul>
<p>А если говорить проще, любой веб-ресурс, в первую очередь, должен быть удобным для посетителей, иметь понятную структуру и удобную навигацию. Если эти качества технической и функциональной части веб-проекта не выполняются, пользователи быстро уходят и заказы не поступают.</p>
<ul>
<li><strong><a href="../uslugi/prodvizhenie-sajtov/default.htm">Веб-сайт содержит ошибки</a></strong></li>
</ul>
<p>Например, не работают ссылки или не загружаются картинки – необходим редизайн графики и перелинковка страниц.</p>
<ul>
<li> <strong>Развитие или смена деятельности компании.</strong></li>
</ul>
<p>Стоит обратить внимание, что информация на веб-сайте создает имидж компании во всемирной сети, поэтому нельзя обойтись без ее своевременного обновления.</p>
<ul>
<li><strong>Сайт морально устарел</strong></li>
</ul>
<p>Это одна из самых распространенных причин. По правилам, редизайн рекомендуется делать раз в 3-5 лет, а модернизацию – раз в 2-3 года.</p>
<p>Специалисты компании <a href="../default.htm">RedLine </a>помогут улучшить Ваш интернет-ресурс, сделают анализ технической и функциональной составляющей, разработают план преобразования и проведут апгрейд. Чтобы узнать цены на <a href="../uslugi/default.htm">услуги </a>напишите нам .</p>
			  <p><a class="button" onclick="sub_name('Когда нужен редизайн или модернизация сайта?','pikt')" href="#modalWindow">Заказать редизайн сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="redizain.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Когда нужен редизайн или модернизация сайта?">
