...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Если Вам кажется, что Ваш веб-ресурс недостаточно функционален или имеет устаревший дизайн, то специально для таких случаев в нашем арсенале есть услуга по модернизации сайта." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Модернизация сайта - какие работы входят</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/redesign.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Модернизация сайта - какие работы входят"/>
<meta property="og:url" content="http://redline.by/novosti/modernizacziya-sajta-kakie-rabotyi-vxodyat.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Модернизация сайта - какие работы входят" href="modernizacziya-sajta-kakie-rabotyi-vxodyat.html"><span itemprop="title">Модернизация сайта - какие работы входят</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Модернизация сайта - какие работы входят</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Модернизация сайта - какие работы входят
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='modernizacziya-sajta-kakie-rabotyi-vxodyat.html'>
                  <img alt='Модернизация сайта - какие работы входят' src='../assets/cache_image/resources/redesign_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">В наше время веб-технологии развиваются очень стремительно. И то, что приносило прибыль вчера, может стать неэффективным сегодня. Особенно это применимо к интернет ресурсам различных компаний. Очень важно, чтобы<strong> сайт был удобным</strong> и отвечал последним требованиям поисковых систем, иначе Вы рискуете потерять часть своей аудитории, что, в свою очередь, негативно скажется на доходах. Если Вам кажется, что Ваш веб-ресурс недостаточно функционален или <strong>имеет устаревший дизайн</strong>, то специально для таких случаев в нашем арсенале есть услуга по <strong>модернизации сайта</strong>.</p>
<h2 align="center"><strong>Какие работы входят в модернизацию сайта?</strong></h2>
<h3 align="justify"><strong>1) Корректировка дизайна. </strong></h3>
<p align="justify">Яркий и продуманный <a href="../uslugi/dizajn-i-grafika/default.htm">дизайн</a> позволит привлекать намного больше посетителей, чем прежде. Очень важно, чтобы сайт был <strong>адаптирован под мобильные устройства</strong>. Это существенно поспособствует снижению количества отказов. Кроме того, <strong>мобильная версия сайта</strong> положительно скажется на ранжировании Вашего ресурса.</p>
<h3 align="justify"><strong>2) Установка более функциональной </strong><strong>CMS</strong><strong>.</strong></h3>
<p align="justify">Мы не редко видим, что многие владельцы сайтов перестают их обновлять или делают это не часто, а ведь <strong>свежий и уникальный контент</strong> является важнейшим составляющим эффективности сайта. Основными причинами этого можно считать:</p>
<div align="justify">
<ul>
<li>Нет специализированного сотрудника для данной работы;</li>
<li>Сложная административная панель;</li>
<li>Невозможность внесения корректировок.</li>
</ul>
</div>
<p align="justify">Если вышеперечисленные пункты применимы к Вашему сайту, то обращайтесь в <a href="../default.htm">студию веб-дизайна</a> RedLine и мы с легкостью решим данные проблемы.</p>
<h3 align="justify"><strong>3) Наполнение сайта контентом.</strong></h3>
<p align="justify">Как уже говорилось ранее, <a href="napolnenie-sajta-kontentom.html">контент</a> – важнейший элемент, от которого зависит посещаемость сайта, конверсия и множество других важных показателей. Очень важно, чтобы контент был оптимизирован для поисковых систем, иначе Ваш сайт будет занимать низкие места в поисковой выдаче. Обратившись в нашу веб-студию, мы наполним сайт качественным контентом или займемся переработкой старого материала.</p>
<h2 align="center"><strong>Почему стоит доверить модернизацию сайта именно в </strong><strong>RedLine</strong><strong>?</strong></h2>
<h3 align="justify"><strong>1) Прогрессивность. </strong></h3>
<p align="justify">При доработке сайта мы пользуемся только новейшими и проверенными инструментами, которые помогут достичь высокой эффективности Вашему проекту.</p>
<h3 align="justify"><strong>2) Комплексный подход.</strong></h3>
<p align="justify">Мы проводим модернизацию сайта с учетом потребностей целевой аудитории Вашего ресурса. Кроме того, мы учитываем ситуацию на рынке и деятельность конкурентов.</p>
<h3 align="justify"><strong>3) Уникальность.</strong></h3>
<p align="justify">Дизайн Вашего сайта будет не только уникальным и привлекательным, но и будет подталкивать посетителя на покупку, благодаря используемым маркетинговым приемам.</p>
<h3 align="justify"><strong>4) Надежность.</strong></h3>
<p align="justify">Большое внимание уделяется надежности. С нами Вы будете защищены от любых вирусных атак. Кроме того, мы позаботимся о высоком быстродействии и стабильной работе ресурса.</p>
<h3 align="justify"><strong>5) Опыт.</strong></h3>
<p align="justify">Наши разработчики готовы провести доработку сайта любой сложности. Это возможно, благодаря многолетнему опыту, которым обладают наши специалисты. Кроме того, Ваш сайт будет корректно отображаться с любого устройства (телефон, планшет, персональный компьютер и т.д.).</p>
<h3 align="justify"><strong>6) Квалифицированность.</strong></h3>
<p align="justify">Мы имеем большой штат специалистов, которые готовы оказать консультацию по любому волнующему Вас вопросу.</p>
<p align="justify"><span style="line-height:../1.5em;">Обратившись в студию веб-дизайна RedLine, мы добросовестно и качественно проведем модернизацию сайта, учитывая все требования. Стоит отметить, что модернизация обойдется гораздо дешевле, нежели создание сайта с нуля. Ваш ресурс обретет «вторую жизнь» и с новой силой начнет <a href="../uslugi/prodvizhenie-sajtov/default.htm">привлекать целевую аудиторию</a>.</span></p>
			  <p><a class="button" onclick="sub_name('Модернизация сайта - какие работы входят','pikt')" href="#modalWindow">Заказать модернизацию сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="modernizacziya-sajta-kakie-rabotyi-vxodyat.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Модернизация сайта - какие работы входят">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='modernizacziya-sajta-kakie-rabotyi-vxodyat.html';
