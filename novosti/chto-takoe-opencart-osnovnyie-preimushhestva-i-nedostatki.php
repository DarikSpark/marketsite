...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="OpenCart – это система администрирования сайта, которая предназначается для создания интернет-магазинов. Данный движок для своей работы использует PHP и базы данных MySQL, что позволит без труда установить его на любой веб-сервер. Благодаря новейшей архитектуре MVC, страницы будут загружаться за считанные мгновения." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>OpenCart - основные приемущества и недостатки | веб студия REDLINE</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/opencart.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="OpenCart"/>
<meta property="og:url" content="http://redline.by/novosti/chto-takoe-opencart-osnovnyie-preimushhestva-i-nedostatki.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="OpenCart" href="chto-takoe-opencart-osnovnyie-preimushhestva-i-nedostatki.html"><span itemprop="title">OpenCart</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Что такое OpenCart? Основные преимущества и недостатки</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-takoe-opencart-osnovnyie-preimushhestva-i-nedostatki.html'>
                  <img alt='OpenCart' src='../assets/cache_image/resources/opencart_1600x487_490.jpg'>
                </a>
              </p>
              <h2 style="font-size: 18px;"> Что такое OpenCart?</h2>
<p>OpenCart – это система администрирования сайта, которая предназначается для <a href="../uslugi/razrabotka-sajtov/internet-magazin.html" target="_blank">создания интернет-магазинов</a>. Данный движок для своей работы использует PHP и базы данных MySQL, что позволит без труда установить его на любой веб-сервер. Благодаря новейшей архитектуре MVC, страницы будут загружаться за считанные мгновения. Кроме того, как и в других популярных CMS, предусмотрена возможность расширения функционала с помощью специальных модулей. Также предусмотрен выбор разнообразных тем оформления, которые можно просмотреть в админке.</p>
<p>OpenCart, как Wordpress и Joomla, имеет открытый исходный код и за ее установку не нужно платить. Данная система управления превосходно подойдет для создания интернет-магазина, так как Вы можете добавить большинство платежных систем (в том числе WebMoney и Robokassa). Кроме того, движок поддерживает 23 языка, включая русский и украинский.</p>
<h3><strong>Преимущества сайта на </strong><strong>OpenCart</strong></h3>
<p>Данная CMS имеет огромное количество преимуществ по сравнению с другими системами, созданными для управления интернет-магазином (например, PrestaShop).</p>
<p><strong>1) Простота.</strong></p>
<p>Сайтами на OpenCart очень просто управлять, так как все элементы административной панели логично структурированы. С появлением OpenCart, Вы можете управлять интернет-магазином без наличия опыта в веб-строительстве или программировании.</p>
<p><strong>2) Платежные системы.</strong></p>
<p>Как уже упоминалось выше, сайты на OpenCart позволяют клиенту оплачивать покупки через различные платежные системы. При необходимости их количество можно увеличить с помощью дополнений. Доступны такие русскоязычные системы как WebMoney, Robokassa, Яндекс.Деньги и LiqPay.</p>
<p><strong>3) Функциональность.</strong></p>
<p>Благодаря открытому исходному коду множество разработчиков могут реализовать свой творческий потенциал создавая дополнения и плагины. На данный момент их количество превышает 10 000. Часть из них платные, но встречается множество качественных и бесплатных решений, способных реализовать требуемый функционал.</p>
<p><strong>4) Встроенные отчеты.</strong></p>
<p>Система оснащена детальными отчетами с разнообразными настройками. Это позволит вести отчетность с учетом всех Ваших потребностей и задач. Большим плюсом является то, что Вы можете добавлять разнообразные скидки и акции в режиме реального времени.</p>
<p><strong>5) </strong><strong>СЕО </strong><strong>оптимизация.</strong></p>
<p>Данный движок отлично <a href="../uslugi/prodvizhenie-sajtov/default.htm" target="_blank">индексируется поисковыми системами</a>, благодаря высокой скорости загрузки и возможности прописать мета-теги не прибегая к установке дополнительных расширений.</p>
<p><strong>6) Поддержка.</strong></p>
<p>OpenCart имеет сообщества на различных языках (в том числе и на русском), а это значит, что при возникновении какой-либо проблемы Вам, скорей всего, смогут помочь.</p>
<p><strong>7) Многообразие.</strong></p>
<p>Данная система управления мультиязычна, а также работает с различными валютами, курс которых Вы можете устанавливать вручную или в автоматическом режиме.</p>
<h3><strong>Недостатки сайта на </strong><strong>OpenCart</strong></h3>
<p>Несмотря на огромное количество преимуществ данная CMS не лишена недостатков. Ниже приведен список наиболее весомых из них.</p>
<p><strong>1) Дублирование контента.</strong></p>
<p>До сих пор осталась не решенной проблема с дублированием контента (товар доступен по различным URL), особенно если при наполнении сайта получается глубокая структура.</p>
<p><strong>2) Плохая локализация.</strong></p>
<p>OpenCart, в первую очередь – система рассчитанная на зарубежных покупателей. Поэтому придется самостоятельно разбираться со всеми способами доставки и платежными системами.</p>
<p><strong>3) Нет поддержки </strong><strong>Excel </strong><strong>и 1С.</strong></p>
<p>Для некоторых большим минусом может стать отсутствие возможности импортировать данные из Excel и 1С, так как это наиболее распространенные русскоязычные программы для ведения отчетности.</p>
<p><strong>4) Неудобное добавление плагинов.</strong></p>
<p>Если Вы захотите расширить возможности системы и установить какое-либо расширение, то Вам придется перелопатить не одну страницу документации, так как стандартная процедура добавления не предусмотрена (в отличие от того же Wordpress, например).</p>
<h2><strong>Создание сайта на </strong><strong>OpenCart</strong><strong> в студии веб-дизайна </strong><strong>RedLine</strong></h2>
<p><a href="../default.htm" target="_blank">Наши специалисты</a> могут создать сайт на множестве популярных CMS, в том числе и OpenCart. Как правило, он используется для создания интернет-магазинов, но мы готовы разработать и другие сервисы со схожим функционалом:</p>
<ul>
<li>Сайт агентства недвижимости;</li>
<li>Сайт по продаже билетов и т.д.</li>
</ul>
<p>По своему опыту мы знаем, что большая часть клиентов имеет смутное представление о функционале их интернет-магазина. Обратившись к нам мы предоставим на выбор различные модули, опишем их функционал, а Вам лишь останется выбрать необходимы ли они для Вашего бизнеса или нет. Кроме того, мы предоставим на выбор несколько вариантов дизайна, а при необходимости<a href="../uslugi/razrabotka-firmennogo-stilya.html" target="_blank"> разработаем фирменный стиль</a>.</p>
<p>В итоге Вы получите привлекательный и функциональный сайт на OpenCart, который будет не только исправно работать, но и станет источником стабильного дохода.  </p>
			  <p><a class="button" onclick="sub_name('OpenCart','pikt')" href="#modalWindow">Заказать интернет-магазин на OpenCart</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-takoe-opencart-osnovnyie-preimushhestva-i-nedostatki.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="OpenCart">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-takoe-opencart-osnovnyie-preimushhestva-i-nedostatki.html';
