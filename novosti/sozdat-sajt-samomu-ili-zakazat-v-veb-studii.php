...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Существует несколько вариантов создания сайта - cделать сайт самому или заказать сайт в веб-студии. Давайте разберем их более подробно." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Заказать сайт в веб студии или создать самому? Что выбрать | веб студия редлайн</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/web-develop.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Создать сайт самому или заказать в веб студии"/>
<meta property="og:url" content="http://redline.by/novosti/sozdat-sajt-samomu-ili-zakazat-v-veb-studii.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Создать сайт самому или заказать в веб студии" href="sozdat-sajt-samomu-ili-zakazat-v-veb-studii.html"><span itemprop="title">Создать сайт самому или заказать в веб студии</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Создать сайт самому или заказать в веб-студии. Что лучше?</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Создать сайт самому или заказать в веб студии
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='sozdat-sajt-samomu-ili-zakazat-v-veb-studii.html'>
                  <img alt='Создать сайт самому или заказать в веб студии' src='../assets/cache_image/resources/web-develop_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Наверняка Вы могли заметить, что все больше и больше компаний выбирают интернет в качестве площадки для ведения бизнеса. Причем это применимо не только к крупным компаниям, но и к мелким фирмам. Даже обычный человек, который занимается какой-либо коммерческой деятельностью (например, фотосъемка) может создать свою интернет страничку, приносящую ему дополнительных клиентов. Все это происходит неспроста, так как в интернете сконцентрировано огромное количество пользователей заинтересованных в Вашем товаре или услуге. Нужно лишь их найти. Первым шагом является <a href="../default.htm">создание сайта</a>. Однако к кому обратиться с данным вопросом? В рамках данной статьи мы постараемся на него ответить.</p>
<p align="justify">Существует несколько вариантов создания сайта:</p>
<p align="justify">1) Сделать сайт самому.</p>
<p align="justify">2) Заказать сайт в веб-студии.</p>
<p align="justify">Давайте разберем их более подробно.</p>
<h2 align="center"><strong>Создание сайта</strong><strong> самому</strong></h2>
<p align="justify">Еще несколько лет назад такой вопрос поставил бы в тупик любого новичка, который никогда не занимался сайтостроением. Однако прогресс не стоит на месте, а веб-технологии и вовсе развиваются семимильными шагами. Появляются множество способов, которые позволяют создавать сайты не имея никаких знаний в верстке и программировании. Один из таких способов – создание сайта на готовой CMS (система управления контентом).</p>
<p align="justify">Возьмем, к примеру, наиболее популярную – Wordpress. Стоит только установить ее на хостинг (делается в несколько кликов), затем зарегистрировать свой домен и все - Ваш сайт готов. К слову, управление тоже не требует каких-то специальных навыков. Вы можете легко заниматься <a href="napolnenie-sajta-kontentom.html">наполнением сайта</a>, а также, при необходимости, менять дизайн, так как большинство систем управления имеют свой каталог тем. Опять-таки, для их установки потребуется сделать лишь несколько кликов.</p>
<p align="justify">Кроме того, если вам мало стандартных возможностей Wordpress, то вы можете установить специальные плагины, добавляющие необходимый функционал. Их настолько много, что Вы сможете создать сайт любого типа, начиная от <a href="../uslugi/razrabotka-sajtov/sajt-vizitka.html">сайта-визитки</a> и заканчивая <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">разработкой интернет-магазина</a>.</p>
<p align="justify">Казалось бы, что еще нужно для полного счастья? Но данный вариант таит в себе множество неочевидных с первого взгляда минусов.</p>
<p align="justify"><strong>1) Неуникальный дизайн. </strong></p>
<p align="justify">Во-первых, что касается дизайна. Несмотря на то, что в каталогах большинства CMS есть разнообразные темы оформления, подходящие для компаний различной направленности, есть огромная вероятность того, что данную тему использует кто-то другой. А это совсем не хорошо, так как компания должна выделяться на рынке и иметь свой <a href="../uslugi/razrabotka-firmennogo-stilya.html">фирменный стиль</a>, чтобы пользователь мог связать конкретный товар с Вашим брендом.</p>
<p align="justify"><strong>2) Проблемы с точной реализацией необходимого функционала. </strong></p>
<p align="justify">Во-вторых, несмотря на то, что в репозитории Wordpress огромное количество плагинов, позволяющих прикрутить любой функционал, есть вероятность что могут возникнуть проблемы с их установкой, так как сложные плагины требуют тонкой настройки и в некоторых случаях могут конфликтовать друг с другом.</p>
<p align="justify"><strong>3) Отсутствие поддержки. </strong></p>
<p align="justify">В-третьих, если сайт внезапно перестанет работать, то вы попадете в тупиковое положение. Для решения технических проблем нужны специальные знания, которых у Вас нет, а это значит, что придется обращаться за помощью в веб-студию, которая занимается поддержкой сайтов, что выльется в определенные денежные затраты.</p>
<p align="justify"><strong>4) Отсутствие продвижения. </strong></p>
<p align="justify">Ну и в-четвертых, мало только создать сайт, нужно еще его как-то продвигать в поисковых системах, иначе Ваш ресурс просто не будет иметь посетителей. <a href="../uslugi/prodvizhenie-sajtov/default.htm">SEO продвижение сайта</a> – это очень сложный процесс, который требует глубоких знаний работы поисковых алгоритмов, которые, к слову, постоянно совершенствуются.</p>
<p align="justify">Таким образом, можно сделать вывод, что самостоятельное создание сайта подойдет лишь тем, кто планирует вести некоммерческую деятельность в интернете (например, вести личный блог). Для серьезных компаний однозначно нужно делать выбор в пользу разработки сайта в веб-студии.</p>
<h2 align="center"><strong>Заказать сайт в веб студии </strong><strong>RedLine</strong></h2>
<p align="justify">Разобравшись с плюсами и минусами создания сайта собственными силами, можно приступать к следующему варианту. Не будем ходить вокруг да около, а сразу перейдем к плюсам работы с веб-студией.</p>
<p align="justify"><strong>1) Профессионализм.</strong></p>
<p align="justify">В <a href="../default.htm">студии веб-дизайна RedLine</a> работают исключительно профессионалы с многолетним опытом работы, что, в свою очередь, гарантирует корректную и бесперебойную работу Вашего сайта.</p>
<p align="justify"><strong>2) Поддержка.</strong></p>
<p align="justify">Если с сайтом что-то случилось, то не стоит беспокоится. Воспользуйтесь услугой по сопровождению и поддержке сайта и наши специалисты починят его в короткие сроки.</p>
<p align="justify"><strong>3) Поисковая оптимизация.</strong></p>
<p align="justify">Наш штат содержит разноплановых специалистов, в том числе и SEO-оптимизаторов, которые проведут <a href="optimizacziya-sajta-pod-poiskovyie-sistemyi.html">комплексную оптимизацию сайта</a>, что позволит ему наполнится целевой аудиторией.</p>
<p align="justify"><strong>4) Функциональность.</strong></p>
<p align="justify">Кроме того, мы готовы реализовать любой функционал с учетом всех Ваших потребностей, что бывает затруднительно при использовании готовых решений.</p>
<p align="justify"><strong>5) Уникальный дизайн. </strong></p>
<p align="justify">Наша команда дизайнеров разработает качественный и уникальный дизайн, который не только будет эстетически приятен посетителю, но и поспособствует дополнительным продажам, благодаря использованию последних маркетинговых наработок.</p>
<p align="justify">Обращайтесь к специалистам студии RedLine и вы получите качественный сайт, который позволит грамотно выделиться на фоне Ваших конкурентов. </p>
			  <p><a class="button" onclick="sub_name('Создать сайт самому или заказать в веб студии','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="sozdat-sajt-samomu-ili-zakazat-v-veb-studii.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Создать сайт самому или заказать в веб студии">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='sozdat-sajt-samomu-ili-zakazat-v-veb-studii.html';
