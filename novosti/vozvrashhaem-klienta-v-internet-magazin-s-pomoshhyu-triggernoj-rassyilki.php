...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Триггерный почтовый маркетинг – это то, что действительно минимизирует Ваши потери и значительно повысит конверсию." />
    <meta name="keywords" content="Триггерная рассылка, повышение конверсии, возвращение клиентов" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Триггерная рассылка как инструмент для снижения потерь</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/trigger.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Возвращаем клиента в интернет-магазин с помощью триггерной рассылки"/>
<meta property="og:url" content="http://redline.by/novosti/vozvrashhaem-klienta-v-internet-magazin-s-pomoshhyu-triggernoj-rassyilki.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Возвращаем клиента в интернет-магазин с помощью триггерной рассылки" href="vozvrashhaem-klienta-v-internet-magazin-s-pomoshhyu-triggernoj-rassyilki.html"><span itemprop="title">Возвращаем клиента в интернет-магазин с помощью триггерной рассылки</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Возвращаем клиента в интернет-магазин с помощью триггерной рассылки</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Возвращаем клиента в интернет-магазин с помощью триггерной рассылки
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='vozvrashhaem-klienta-v-internet-magazin-s-pomoshhyu-triggernoj-rassyilki.html'>
                  <img alt='Возвращаем клиента в интернет-магазин с помощью триггерной рассылки' src='../assets/cache_image/resources/trigger_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Взглянув на <strong>воронку продаж</strong> можно заметить, что до основания воронки добирается лишь небольшая часть лидов. Поэтому вопрос о <strong>снижении потерь</strong> остро стоит для любого интернет-маркетолога. В рамках данной статьи мы постараемся решить эту проблему с помощью <strong>триггерной рассылки</strong>.</p>
<h2 align="center"><strong>Триггерная рассылка как инструмент для снижения потерь</strong></h2>
<p align="justify">Триггерный <a href="../uslugi/prodvizhenie-sajtov/e-mail-marketing.html">почтовый маркетинг</a> – это то, что действительно минимизирует Ваши потери и значительно <strong>повысит конверсию</strong>. Как правило, на первых этапах воронки, данный инструмент бесполезен, но ближе к кульминации его эффективность очень высока. Триггерная рассылка широко используется в работе маркетологов <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">интернет-магазинов</a>. В следующей части статьи мы более подробно узнаем о том как это работает.</p>
<p><strong>В данном случае триггером является:</strong></p>
<ul>
<li>Временной промежуток (например, посетитель не был на сайте несколько дней);</li>
<li>Определенные действия (например, посетитель заходил на страницу товара несколько раз);</li>
<li>Источник посещения (таргетированная или контекстная реклама).</li>
</ul>
<p>Стоит отметить, что <strong>автоматизированный почтовый маркетинг</strong> также эффективен и для других сфер деятельности. Чтобы было понятно приведем доступный пример.</p>
<p align="justify">Предположим, что у Вас запланирован вебинар на 1-ое июля. Естественно, было приглашено определенное количество участников из числа Ваших e-mail подписчиков. Но кто-то произведет регистрацию 21 мая, а кто-то 29 июня. А если в промежутке между моментом приглашения и самим вебинаром пользователь не получал никаких писем, то вероятность того, что он вспомнит про вебинар крайне мала. В таких случаях пригодится <strong>автоцепочка писем</strong>, которая подогреет интерес и даст какую-либо полезную информацию о мероприятии.</p>
<h2 align="center"><strong>Повышаем конверсию в интернет-магазине</strong></h2>
<p>Если вы собираете информацию о своих посетителях (с помощью специальных инструментов аналитики), то триггерный почтовый маркетинг позволит значительно <strong>повысить конверсию</strong>.</p>
<p>По статистике более половины людей, зашедших на торговую площадку, <strong>не совершают покупку</strong>. Как правило, это происходит ввиду следующих причин:</p>
<ul>
<li>Посетитель произвел регистрацию, но больше не заходит на сайт;</li>
<li>Добавил товар в корзину и закрыл страницу;</li>
<li>Много раз просматривал страницу с товаром, но не совершил покупку;</li>
<li>Приобрел товар и больше не возвращался.</li>
</ul>
<p>Очень важно понять какой из этих пунктов приносит наибольшие <strong>потери</strong> для Вашего бизнеса. А сейчас рассмотрим грамотные <strong>способы возврата</strong> в воронку на примере известных русскоязычных интернет-магазинов.</p>
<h3 align="center"><strong>Пользователь произвел регистрацию, но не заходит на сайт</strong></h3>
<p align="center"><img title="Пользователь произвел регистрацию, но не заходит на сайт" src="../resources/news/16/01/11/1/image001.jpg" alt="Пользователь произвел регистрацию, но не заходит на сайт" width="623" height="675" /></p>
<p align="justify">Вот такой грамотный способ использует Ozon.ru. Вдобавок мы видим интересное предложение, которое составлено по всем канонам интернет-маркетинга (напомнили о магазине, указали на дефицит времени, а также предоставили заманчивую скидку).</p>
<h3 align="center"><strong>Посетитель добавил товар в корзину и ушел</strong></h3>
<p align="center"><img title="Посетитель добавил товар в корзину и ушел" src="../resources/news/16/01/11/1/image002.jpg" alt="Посетитель добавил товар в корзину и ушел" width="441" height="329" /></p>
<p align="center"><img title="Посетитель добавил товар в корзину и ушел" src="../resources/news/16/01/11/1/image003.jpg" alt="Посетитель добавил товар в корзину и ушел" width="599" height="380" /></p>
<p>Очередное грамотное решение от Ozone.ru. Опять-таки, не забыли упомянуть про дефицит товара. Кроме того, Вы можете увидеть забытый товар и прямо из письма перейти к его оформлению.</p>
<h3 align="center"><strong>Посетитель просматривал товар, но не совершил покупку</strong></h3>
<p align="center"><img title="Посетитель просматривал товар, но не совершил покупку" src="../resources/news/16/01/11/1/image004.jpg" alt="Посетитель просматривал товар, но не совершил покупку" width="614" height="786" /></p>
<p>Вот такое письмо приходит от Lamoda.ru. Как и в случае с Озоном, акцент делается на дефиците (в данном случае времени).</p>
<h3 align="center"><strong>Покупатель приобрел товар и больше не возвращался</strong></h3>
<p align="center"><img title="Посетитель просматривал товар, но не совершил покупку" src="../resources/news/16/01/11/1/image005.jpg" alt="Посетитель просматривал товар, но не совершил покупку" width="624" height="613" /></p>
<p>А вот так завлекает к себе клиентов магазин Pudra.ru. Внимание посетителя акцентируется на выгодных способах доставки, которые действуют определенное время (без дефицита никуда).</p>
<h2 align="center"><strong>Нужна ли мне триггерная рассылка?</strong></h2>
<p>Данный инструмент станет мощнейшим оружием в Ваших руках, если:</p>
<p><strong>1) Вы продаете товары, покупку которых необходимо обдумать.</strong></p>
<p>Идеальный вариант, когда решение о покупке товара принимается на протяжении длительного времени (7 дней и больше).</p>
<p><strong>2) Вы имеете обширную базу подписчиков или есть возможность ее создать.</strong></p>
<blockquote>Если Вы имеете неплохую посещаемость (500+ человек в сутки) или Ваша подписная база насчитывает более 1к подписчиков, то триггерная рассылка определенно заслуживает Вашего внимания.</blockquote>
<p>Если Вы только начинаете свой путь в продажах, то обращайтесь в студию веб-дизайна RedLine. Мы поможем создать интернет-магазин, который будет приносить Вам стабильный доход.</p>
			  <p><a class="button" onclick="sub_name('Возвращаем клиента в интернет-магазин с помощью триггерной рассылки','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="vozvrashhaem-klienta-v-internet-magazin-s-pomoshhyu-triggernoj-rassyilki.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Возвращаем клиента в интернет-магазин с помощью триггерной рассылки">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='vozvrashhaem-klienta-v-internet-magazin-s-pomoshhyu-triggernoj-rassyilki.html';
