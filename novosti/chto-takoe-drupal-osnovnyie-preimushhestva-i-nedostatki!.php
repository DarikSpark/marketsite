...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Drupal – удобная система, позволяющая создавать и администрировать различные сайты, а благодаря наличию специального фреймворка, Вы можете использовать ее для создания веб-приложений, что выгодно отличает данную CMS от других бесплатных аналогов.  Движок написан на языке программирования PHP и использует для своей работы базы данных MySQL и PostgreSQL" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Drupal - Основные преимущества и недостатки! Что можно разработать на Drupal </title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/drupal.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Drupal"/>
<meta property="og:url" content="http://redline.by/novosti/chto-takoe-drupal-osnovnyie-preimushhestva-i-nedostatki!.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Drupal" href="chto-takoe-drupal-osnovnyie-preimushhestva-i-nedostatki!.html"><span itemprop="title">Drupal</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Drupal - Основные преимущества и недостатки!</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-takoe-drupal-osnovnyie-preimushhestva-i-nedostatki!.html'>
                  <img alt='Drupal' src='../assets/cache_image/resources/drupal_1600x487_490.jpg'>
                </a>
              </p>
              <h2 style="font-size: 16px;"> <strong style="font-size: 1.5em; line-height: 1.5em;">Что такое </strong><strong style="font-size: 1.5em; line-height: 1.5em;">Drupal?</strong></h2>
<p>Drupal – удобная система, позволяющая создавать и администрировать различные сайты, а благодаря наличию специального фреймворка, Вы можете использовать ее для создания веб-приложений, что выгодно отличает данную CMS от других бесплатных аналогов.</p>
<p>Движок написан на языке программирования PHP и использует для своей работы базы данных MySQL и PostgreSQL. Drupal полностью бесплатен и имеет открытый исходный код, а это значит, что развитием и доработкой данной системы управления может заниматься любой желающий. Как и многие CMS, Drupal имеет возможность расширения функциональности, благодаря установке дополнительных модулей. С помощью них Вы сможете <a href="../uslugi/razrabotka-sajtov/sajt-vizitka.html">разработать сайт-визитку</a>, а также иные разновидности веб-ресурсов.</p>
<p>За 15 лет существования Drupal обрел свои характерные преимущества и недостатки. Остановимся на них более подробно.</p>
<h3><strong>Преимущества сайта на </strong><strong>Drupal</strong></h3>
<p><strong>1) Бесплатность.</strong></p>
<p>Данная CMS распространяется бесплатно также как и другие популярные аналоги (Wordpress, Joomla и т.д.). Это одна из причин, благодаря которой движок получил широкое распространение. Кроме того, он обладает открытым исходным кодом, что предоставляет безграничные возможности по расширению функциональности сайта на Drupal.</p>
<p><strong>2) Профессиональная направленность.</strong></p>
<p>Изначально Drupal планировалась, как система управления для профессиональных разработчиков. Данный пункт является скорее отличительной особенностью, нежели преимуществом.</p>
<p><strong>3) Гибкость.</strong></p>
<p>Профессиональная направленность данного движка позволяет <a href="../uslugi/razrabotka-sajtov/default.htm">создать сайт</a> абсолютно любой сложности, что является несомненным плюсом по сравнению с другими бесплатными решениями.</p>
<p><strong>4) Скорость работы.</strong></p>
<p>Очередным плюсом сайта на Drupal является высокая скорость загрузки страниц. Движок оснащен встроенной системой кэширования, что отличает ее от Wordpress и Joomla, где для работы кэширования необходима установка дополнительных расширений.</p>
<p><strong>5) Модули.</strong></p>
<p>Благодаря открытому исходному коду любой энтузиаст может развивать данную систему управления. За длительное время существования CMS Drupal появилось множество различных модулей, которые позволят внедрить практически любой функционал.</p>
<p><strong>6) Безопасность.</strong></p>
<p>В отличие от Joomla, сайты на Drupal имеют более продуманную систему защиты, которую будет достаточно сложно взломать.</p>
<p><strong>7) Профессиональное сообщество.</strong></p>
<p>Как и все качественные CMS, Drupal имеет свое сообщество. Естественно, что по количеству участников оно уступает Wordpress и Joomla, но это компенсируется наличием множества профессиональных разработчиков.</p>
<h3><strong>Недостатки сайта на </strong><strong>Drupal</strong></h3>
<p><strong>1) Сложность использования.</strong></p>
<p>Данный недостаток вытекает из ее профессиональной направленности. Если Вы никогда не работали с админками других CMS, то полное освоение Drupal может занять длительное время.</p>
<p><strong>2) Сложный интерфейс.</strong></p>
<p>Очередной минус – сложный интерфейс по сравнению с тем же Wordpress, что, естественно, не способствует ее быстрому изучению для новичка.</p>
<p><strong>3) Прожорливость.</strong></p>
<p>Высокие системные требования также можно отнести к минусам сайта на Drupal. Поэтому имейте ввиду, что разместить ресурс на самом дешевом хостинге вряд ли получится.</p>
<p><strong>4) Дефицит тем оформления.</strong></p>
<p>В репозитории Wordpress имеется огромное количество бесплатных тем оформления. К сожалению, данным достоинством не может похвастаться Drupal. Одной из причиной этого является то, что многие пользователи предпочитают заниматься созданием дизайна самостоятельно.</p>
<p><strong>5) Сложность обновления.</strong></p>
<p>В большинстве CMS предусмотрен процесс обновления модулей и движка прямо из административной панели. В Drupal нет такой возможности и для того, чтобы установить обновления нужно прибегнуть к помощи FTP.</p>
<h2><strong>Разработка сайта на </strong><strong>Drupal</strong><strong> в веб-студии </strong><strong>RedLine</strong></h2>
<p>Наши специалисты имеют большой опыт работы с различными CMS, в том числе и Drupal. Профессиональная направленность данного движка позволяет создавать сайты различной сложности. Обратившись в <a href="../default.htm">студию веб-дизайна RedLine</a>, мы более подробно расскажем о всех функциях данной CMS, а Вам лишь останется выбрать те, которые наиболее удовлетворяют потребности Вашего бизнеса. Кроме того, мы разработаем уникальный и эстетически привлекательный дизайн, который поспособствует высокой конверсии. Для особо крупных компаний, мы готовы заняться <a href="../uslugi/razrabotka-firmennogo-stilya.html">разработкой фирменного стиля</a>.</p>
<p>В итоге Вы получите полнофункциональный сайт, который станет мощным инструментом привлечения дополнительных клиентов для Вашего бизнеса.</p>
<p> </p>
			  <p><a class="button" onclick="sub_name('Drupal','pikt')" href="#modalWindow">Заказать портал на Drupal</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-takoe-drupal-osnovnyie-preimushhestva-i-nedostatki!.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Drupal">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-takoe-drupal-osnovnyie-preimushhestva-i-nedostatki!.html';
