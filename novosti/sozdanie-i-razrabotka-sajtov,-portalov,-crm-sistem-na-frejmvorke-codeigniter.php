...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="CodeIgniter – это очередной многофункциональный фреймворк написанный на PHP, с помощью которого можно реализовать полноценные веб-системы, сайты и приложения. Как и Laravel он имеет открытый исходный код и за его пользование не нужно платить, так как он распространяется под MIT лицензией." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Основные преимущества и недостатки разработки веб сайтов на фреймворке Codeigniter</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/CodeIgniter.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Фреймворк CodeIgniter"/>
<meta property="og:url" content="http://redline.by/novosti/sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-codeigniter.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Фреймворк CodeIgniter" href="sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-codeigniter.html"><span itemprop="title">Фреймворк CodeIgniter</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Основные преимущества и недостатки фреймворка CodeIgniter</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-codeigniter.html'>
                  <img alt='Фреймворк CodeIgniter' src='../assets/cache_image/resources/CodeIgniter_1600x487_490.jpg'>
                </a>
              </p>
              <h2><strong style="line-height: 1.5em;">Что такое фреймворк </strong><strong style="line-height: 1.5em;">CodeIgniter?</strong></h2>
<p>CodeIgniter – это очередной многофункциональный фреймворк написанный на PHP, с помощью которого можно реализовать полноценные веб-системы, сайты и приложения. Как и Laravel он имеет открытый исходный код и за его пользование не нужно платить, так как он распространяется под MIT лицензией.</p>
<p>Применение фреймворков необходимо в том случае, когда системы управления контентом не подходят для решения поставленных задач. Например, необходимо создание сайта с нестандартным функционалом или планируется создание посещаемого портала. В CMS существует набор инструментов вшитых по умолчанию, от которых нельзя избавиться даже, если они не нужны для конкретного проекта. Фреймворк, в свою очередь, составляется из различных компонентов, необходимых для каждого конкретного случая.</p>
<h3><strong>Преимущества </strong><strong>сайта </strong><strong>на</strong><strong> CodeIgniter</strong></h3>
<p><strong>1) Простота.</strong></p>
<p>CodeIgniter прост в освоении, так как предусмотрена обширная документация и существует развитое сообщество пользователей. Кроме того, можно найти множество видео материалов по работе с системой (как на официальном сайте разработчика, так и на сторонних сайтах). Однако большинство информации предоставлено на английском языке.</p>
<p><strong>2) Низкие требования к ресурсам.</strong></p>
<p>CodeIgniter не прихотлив в работе и будет работать даже на самом дешевом тарифном плане хостинга с поддержкой PHP 5.1. На данный момент это один из самых быстрых фреймворков, размер дистрибутива которого слегка превышает 2 мегабайта.</p>
<p><strong>3) Скорость работы.</strong></p>
<p>Как уже говорилось выше, его легковесность обеспечивает высокую скорость работы, которой сможет похвастаться далеко не каждый фреймворк.</p>
<p><strong>4) Функциональность.</strong></p>
<p>Возможности сайтов на CodeIgniter с легкость могут расширятся с помощью использования дополнительных библиотек, классов, а также системных хуков.</p>
<p><strong>5) Оптимизация. </strong></p>
<p><a href="../uslugi/prodvizhenie-sajtov/default.htm">СЕО оптимизация </a>– одна из отличительных особенностей данного фреймворка. В частности он генерирует дружелюбные к поисковым системам адреса страниц.</p>
<h2><strong>Разработка сайта на </strong><strong>CodeIgniter</strong><strong> в студии </strong><strong>RedLine</strong></h2>
<p>Специалисты студии веб-дизайна RedLine имеют большой опыт <a href="../uslugi/razrabotka-sajtov/default.htm" target="_blank">разработки сайтов</a> с использованием системы CodeIgniter, что, в свою очередь, обеспечивает качественную реализацию всех поставленных задач.</p>
<p>При выполнении работ наши программисты учтут все особенности Вашего бизнеса и реализуют необходимый функционал отвечающий их требованиям. Кроме того, мы разработаем уникальный дизайн, который будет не только эстетически привлекателен для посетителя, но и подтолкнет его на совершение необходимых действий. Кроме того, для крупных порталов мы занимаемся разработкой <a href="../uslugi/dizajn-i-grafika/razrabotka-firmennogo-stilya/default.htm" target="_blank">фирменного дизайна</a>.</p>
<p>Обращаясь в <a href="../default.htm" target="_blank">веб-студию RedLine</a>, Вы получаете качественный сайт, разработанный с использованием новейших веб-технологий.</p>
			  <p><a class="button" onclick="sub_name('Фреймворк CodeIgniter','pikt')" href="#modalWindow">Заказать разработку сайта на фреймворке</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-codeigniter.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Фреймворк CodeIgniter">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-codeigniter.html';
