...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Продающие сайты являются одним из самых эффективных инструментов для реализации практически любого товара или услуги." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Продающий сайт - лучшие примеры</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/prodayuschiy-site.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Продающий сайт - лучшие примеры"/>
<meta property="og:url" content="http://redline.by/novosti/prodaushiy-sait-primer.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Продающий сайт - лучшие примеры" href="prodaushiy-sait-primer.html"><span itemprop="title">Продающий сайт - лучшие примеры</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Продающий сайт - лучшие примеры</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='prodaushiy-sait-primer.html'>
                  <img alt='Продающий сайт - лучшие примеры' src='../assets/cache_image/resources/prodayuschiy-site_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Продающие сайты являются одним из самых эффективных инструментов для реализации практически любого товара или услуги. Их огромная популярность обусловлена множеством преимуществ перед другими видами продвижения. Простота дизайна – одно из главных достоинств любого лендинга. Именно благодаря ему пользователь концентрируется только на самой важной информации, что способствует увеличению конверсии.</p>
<p align="justify">Продающий сайт станет оптимальным вариантом для малого бизнеса с ограниченным бюджетом, так как он обойдется гораздо дешевле нежели <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">создание интернет-магазина</a> или корпоративного сайта. Кроме того, разработка простых лендингов может занять всего несколько дней.</p>
<p align="justify">Однако лендинги можно использовать далеко не всегда. В рамках данной статьи мы поговорим о том, каким должен быть идеальный одностраничник, а также приведем примеры продающих сайтов на основе нашего портфолио.</p>
<h3 align="center"><strong>Составляющие идеального лендинга</strong></h3>
<p align="justify">Чтобы landing page имел высокую эффективность необходимо следовать некоторым принципам, которые способны увеличить конверсию в несколько раз.</p>
<p align="justify"><strong>1) Удобная навигация по сайту.</strong></p>
<p align="justify">Меню должно располагаться на видном месте, иметь четкую структуру. Кроме того, структура не должна быть слишком глубокой, так как это негативно отразится не только на удобстве посетителей, но и на <a href="optimizacziya-sajta-pod-poiskovyie-sistemyi.html">оптимизации сайта</a>.</p>
<p align="justify"><strong>2) Компактность меню.</strong></p>
<p align="justify">Продающий сайт должен содержать только самую необходимую информацию. Поэтому не стоит делать переизбыток ссылок или других элементов, так как это только рассеивает внимание посетителя и отвлекает его от самого важного.</p>
<p align="justify"><strong>3) Минимальное количество графики. </strong></p>
<p align="justify">Не стоит злоупотреблять использованием графики на продающем сайте, так как это может негативно отразиться на скорости его загрузки. Исключением являются сайты профессиональных фотографов, художников и т.д. В таких случае можно прибегнуть к кэшированию. Кроме того, не стоит забывать прописывать мета-теги к изображением. Эта простая процедура позволит привлечь дополнительных клиентов.</p>
<p align="justify"><strong>4) Продающий дизайн.</strong></p>
<p align="justify">Дизайн играет важнейшую роль в конверсии одностраничника. Именно продуманные элементы дизайна позволяют притягивать взгляд посетителя к нужным блокам. При его разработке следует уделить особое внимание важным разделам сайта (например, форме подписки). Их необходимо выделять яркими цветами, однако они должны гармонично сочетаться с другими составляющими ресурса.</p>
<h2 align="center"><strong>Примеры продающих сайтов</strong><strong> из нашего портфолио</strong></h2>
<p align="justify">Как уже говорилось ранее, главной отличительной особенностью лендинга является отсутствие ненужной информации. Использование 3-5 пунктов меню обеспечит ресурсу быструю загрузку, а также позволит избежать путаницы. Кроме того, использование более 5-ти информационных блоков увеличивает полосу прокрутки, что негативно сказывается на удобстве пользователей.</p>
<p align="center"><img title="Пример продающего сайта, который имеет 3 информационных блока." src="../resources/news/16/01/25/image001.jpg" alt="Пример продающего сайта, который имеет 3 информационных блока." width="800" height="456" /></p>
<p align="center"><em><a href="../../vozimgruz.by/default.htm" rel="nofollow" target="_blank">http://vozimgruz.by</a></em><em> – пример продающего сайта, который имеет 3 информационных блока.</em></p>
<p>К слову, прокрутка на одностраничных сайтах бывает двух видов:</p>
<ul>
<li>Горизонтальная;</li>
<li>Вертикальная.</li>
</ul>
<p align="justify">Горизонтальная прокрутка используется достаточно редко, однако она подойдет для использования на ресурсах определенной тематики. Основным преимуществом горизонтальной прокрутки является высокая скорость загрузки даже если страница содержит множество информационных блоков.</p>
<p align="center"><img title="пример продающего сайта, на котором используется горизонтальный слайдер." src="../resources/news/16/7/2016-08-02_15-46-45.png" alt="пример продающего сайта, на котором используется горизонтальный слайдер." width="820" height="304" /></p>
<p align="center"><em><a href="../../orbita.of.by/default.htm" rel="nofollow" target="_blank">orbita.of.by</a></em><em> – пример продающего сайта, на котором используется горизонтальный слайдер. </em></p>
<p align="justify">Гораздо чаще используется вертикальная прокрутка, так как такой способ более удобен. Кроме того, благодаря кнопке «вверх» не придется листать длинные страницы вручную и переход к основной навигации осуществляется за секунду.</p>
<p align="center"><img title="Пример продающего сайта, с реализацией вертикальной прокрутки" src="../resources/news/16/01/25/image005.jpg" alt="Пример продающего сайта, с реализацией вертикальной прокрутки" width="800" height="456" /></p>
<p align="center"><em><a href="../../www.fiamm.by/default.htm" rel="nofollow" target="_blank">http://www.fiamm.by</a></em><em> – пример продающего сайта, с реализацией вертикальной прокрутки.</em></p>
<p align="justify">Вот так выглядят одностраничные сайты на примере портфолио <a href="../default.htm">веб-студии RedLine</a>. Понравились наши работы? Тогда звоните нам! Мы предоставляем возможность <a href="../uslugi/razrabotka-sajtov/lending.html">заказать landing page</a> любой направленности, с применением последних маркетинговых технологий, которые помогут максимально увеличить конверсию Вашего сайта.</p>
			  <p><a class="button" onclick="sub_name('Продающий сайт - лучшие примеры','pikt')" href="#modalWindow">Заказать разработку Лендинга</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="prodaushiy-sait-primer.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Продающий сайт - лучшие примеры">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='prodaushiy-sait-primer.html';
