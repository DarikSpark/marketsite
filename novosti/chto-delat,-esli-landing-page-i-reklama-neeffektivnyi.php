...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="В этой статье речь пойдет о том, как проанализировать эффективность работы посадочной страницы (Landing Page) и рекламы, ведущей на ее. А также о том, какие необходимо внести правки в систему привлечения клиентов на основе проведенного анализа." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Что делать, если Landing Page и реклама неэффективны? | Redline </title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news-555.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Что делать, если Landing Page и реклама неэффективны?"/>
<meta property="og:url" content="http://redline.by/novosti/chto-delat,-esli-landing-page-i-reklama-neeffektivnyi.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Что делать, если Landing Page и реклама неэффективны?" href="chto-delat,-esli-landing-page-i-reklama-neeffektivnyi.html"><span itemprop="title">Что делать, если Landing Page и реклама неэффективны?</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Что делать, если Landing Page и реклама неэффективны?</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Что делать, если Landing Page и реклама неэффективны?
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-delat,-esli-landing-page-i-reklama-neeffektivnyi.html'>
                  <img alt='Что делать, если Landing Page и реклама неэффективны?' src='../assets/cache_image/resources/news-555_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">В этой статье речь пойдет о том, как проанализировать <strong>эффективность работы</strong> посадочной страницы (<a href="../uslugi/razrabotka-sajtov/lending.html">Landing Page</a>) и <a href="../uslugi/prodvizhenie-sajtov/kontekstnaya-reklama.html">рекламы</a>, ведущей на ее. А также о том, какие необходимо внести правки в систему <strong>привлечения клиентов</strong> на основе проведенного анализа.</p>
<ul>
<li><span style="line-height:../1.5em;">Вы разместили <strong>Landing Page</strong> – страницу, представляющую Ваш товар или услугу.</span></li>
<li><span style="line-height:../1.5em;">Установили на сайт <strong>счетчики</strong> аналитики (Яндекс.Метрика, Google AdWords) и умеете с ними работать (выводить отчеты, сегментировать данные, анализировать данные).</span></li>
<li><span style="line-height:../1.5em;">Добавили <strong>рекламу</strong>, ведущую на Вашу посадочную страницу, или провели целую рекламную кампанию.<br /></span></li>
</ul>
<p align="justify">Однако в результате <strong>не получили</strong> требуемое количество целевых <strong>посетителей</strong>, а соответственно, улучшения продаж и увеличения прибыли. <br />В этом случае Вам стоит обратить внимание на следующую пошаговую <strong>инструкцию</strong>. Мы рекомендуем:</p>
<ul>
<li><span style="line-height:../1.5em;">Провести анализ трафика</span></li>
<li><span style="line-height:../1.5em;">Сегментировать отчеты</span></li>
<li><span style="line-height:../1.5em;">Более глубоко проанализировать каждый источник</span></li>
</ul>
<p align="justify">Рассмотрим каждый шаг подробно:</p>
<h2 align="center"><strong>АНАЛИЗ ТРАФИКА</strong></h2>
<p align="justify">1. В самом начале <strong>сформируйте отчет</strong> по источникам Вашего трафика. Для анализа выбирайте относительно длительный период времени, в течение которого на сайте не было серьезных изменений, связанных с корректировками содержимого и рекламы. Попробуйте оценить обобщенную структуру трафика.</p>
<p align="justify"><img src="../resources/_25D1_2581_25D0_25B2_25D0_25BE_25D0_25B4_25D0_25BA_25D0_25B0.jpg" alt="" width="1718" height="499" /></p>
<p align="justify"><em>Пример отчета по источникам<br /></em><br />2. На втором этапе <strong>изучите конверсию</strong>. Для этого в отчете необходимо выбрать: «Выберите цель» -&gt; «Конверсионные». Таким образом, Вы настроите отображение целевых данных по конверсии, которые выполняют свои функции.</p>
<p align="justify"><img src="../resources/_25D1_2586_25D0_25B5_25D0_25BB_25D0_25B8.jpg" alt="" width="378" height="335" /><br /><em><br />Настройка целей на конверсию в Яндексе</em></p>
<p align="justify">Сейчас можно оценить источники конверсий и рассчитать коэффициент конверсии. Вы поймете, какая реклама приносит конверсию, а какая показала свою неэффективность. Например, обнаружите, что реклама в социальных сетях нуждается в доработке.</p>
<p align="justify">3. На третьем этапе оцените 1 - глубину просмотра страниц, 2 - время, проведенное на сайте, 3 - отказы. Сравнивая данные показатели со средними значениями, Вы сможете выяснить, какие источники работают лучше (процент отказов ниже, глубина просмотра и время, проведенное на сайте, больше).</p>
<p align="justify"><img src="../resources/pokazateli.jpg" alt="" width="414" height="484" /></p>
<p align="justify"><em>Сравнение показателей по визитам<br /></em><br />Результатом проведенного анализа должны стать <strong>выводы о трафике</strong> из различных источников. Вы поймете, равномерно ли распределяется трафик или имеются серьезные недоработки по отдельным сегментам.</p>
<h2 align="center"><strong>СЕГМЕНТИРОВАНИЕ ОТЧЕТОВ</strong></h2>
<p align="justify">1. На этом шаге Вам необходимо вывести отчеты отдельно для источников, лидирующих по трафику, и отдельно для явно неэффективных. Выберите во вкладке «Сегментировать» сегментирование по меткам UTM (source, medium, campaign, content, term).</p>
<p align="justify"><img src="../resources/_25D0_25A1_25D0_25B5_25D0_25B3_25D0_25BC_25D0_25B5_25D0_25BD_25D1_2582_25D1_258B65.jpg" alt="" width="847" height="729" /></p>
<p align="justify"><em>Сегментирование в Яндекс по меткам UTM</em></p>
<p align="justify">2. Начните с построения отчета по типам устройства</p>
<p align="justify"><img src="../resources/_25D0_25A3_25D1_2581_25D1_2582_25D1_2580_25D0_25BE_25D0_25B9_25D1_2581_25D1_2582_25D0_25B2_25D0_25B0.jpg" alt="" width="1081" height="322" /></p>
<p align="justify"><em>Отчет по типам устройств в Яндексе<br /></em><br />На этом этапе Вы можете выявить технические либо стратегические проблемы. Так, например, анализируя показатели посещаемости с отдельных типов устройств (вплоть до конкретных моделей), можно обнаружить несовместимость <a href="../uslugi/razrabotka-sajtov/adaptivnaya-verstka.html">мобильной версии</a> Вашего веб-ресурса с определенным устройством. Возможно, у Вас получится разрешить технические проблемы работы сайта на мобильном устройстве, в противном случае, придется отключать мобильную версию. В некоторых случаях разрешить задачи помогут стратегические корректировки в продвижении на смартфонах и планшетах.</p>
<p align="justify">3. Постройте отчет по браузерам</p>
<p align="justify"><img src="../resources/_25D0_2591_25D1_2580_25D0_25B0_25D1_2583_25D0_25B7_25D0_25B5_25D1_2580_25D1_258B.jpg" alt="" width="1086" height="377" /></p>
<p align="justify"><em>Отчет по браузерам в Яндексе<br /></em><br />Проведите, так называемую, <strong>кроссбраузерную проверку</strong>. Она поможет выявить совместимость Вашего сайта со всеми популярными браузерами. Самыми показательными в этом случае являются повышение процента отказов и короткое время пребывания на сайте. Такие результаты могут свидетельствовать о технических несовершенствах, которые, однако, можно разрешить. Также рекомендуем построить отчет <strong>по разрешению дисплея</strong> для проверки корректности отображения.</p>
<p align="justify">4. Выведите отчет по возрасту и полу</p>
<p align="justify"><img src="../resources/_25D0_259F_25D0_25BE_25D0_25BB_25D0_2592_25D0_25BE_25D0_25B7_25D1_2580_25D0_25B0_25D1_2581_25D1_2582.jpg" alt="" width="1083" height="449" /></p>
<p align="justify"><em>Отчет по возрасту и полу в Яндексе</em></p>
<p align="justify">Такой отчет наглядно покажет Вам характеристику поведения на сайте пользователей различного возраста и пола. Вы сможете проверить, соответствуют ли посетители веб-ресурса Вашей целевой аудитории, на которую непосредственно направляется действие рекламы и посадочной страницы.</p>
<h2 align="center"><strong>УГЛУБЛЕННЫЙ АНАЛИЗ ПО ИСТОЧНИКАМ</strong></h2>
<p align="justify">Может потребоваться провести для каждого источника <strong>углубленный анализ</strong>, позволяющий выявить проблемы в настройках рекламы. Этот шаг не обязателен, однако рекомендуется для более детального разграничения источников происхождения трафика.</p>
<p align="justify"><strong>Выведите отчеты</strong> (рекомендуем пользоваться отчетами по меткам UTM) для каждого полученного источника по ключевым словам, объявлениям, постам, таргетингам и проч. Все это преследует одну цель: понять, например, какие письма e-mail маркетинга стали причиной появления источников с высокой конверсией. Вы сможете оценить показатели по отношению к средним значениям.</p>
<p align="justify">1. Ваша задача – обнаружить <strong>неработающие ключи</strong> и <strong>некачественные объявления</strong>. Посетители, переходящие по таким путям, не заинтересованы сайтом и представленным на нем продуктом и быстро покидают его. Как следствие, возникает высокий процент отказов и малое время пребывания на сайте. В этом случае, рекомендовано провести <a href="../uslugi/prodvizhenie-sajtov/default.htm">оптимизацию ключевых запросов</a>, переформулировать объявления, чтобы повысить их релевантность сайту.</p>
<p align="justify">2. Проведите анализ всех кампаний и выявите нуждающиеся в доработке. Возможно, некоторые из кампаний придется остановить на определенное время и направить высвободившиеся денежные средства в другое русло. Помните, что настройка кампаний требует обдуманного подхода, здесь важно все: стратегия, временной таргетинг, регион показа объявлений и проч.</p>
<p align="justify">Итак, главными задачи на третьем шаге являются: <strong>анализ происхождения трафика</strong> и <strong>поиск недоработок в рекламе</strong>.</p>
<p align="justify">С пониманием структуры своего трафика Вы сможете объективно оценить, какие рычаги воздействия будут иметь положительный эффект.</p>
			  <p><a class="button" onclick="sub_name('Что делать, если Landing Page и реклама неэффективны?','pikt')" href="#modalWindow">Заказать аудит сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-delat,-esli-landing-page-i-reklama-neeffektivnyi.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Что делать, если Landing Page и реклама неэффективны?">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-delat,-esli-landing-page-i-reklama-neeffektivnyi.html';
