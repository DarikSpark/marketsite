...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="С помощью сервиса Yandex Wordstat можно составить структуру, которая будет удобна в использовании, логично составлена и отвечать вопросам актуальности на данный момент." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Строение сайта и отдельных страниц на основе Yandex.Wordstat</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/7/image.png"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Строение сайта и отдельных страниц на основе Yandex.Wordstat"/>
<meta property="og:url" content="http://redline.by/novosti/stroenie-sajta-i-otdelnyix-stranicz-na-osnove-yandex.wordstat.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Строение сайта и отдельных страниц на основе Yandex.Wordstat" href="stroenie-sajta-i-otdelnyix-stranicz-na-osnove-yandex.wordstat.html"><span itemprop="title">Строение сайта и отдельных страниц на основе Yandex.Wordstat</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Строение сайта и отдельных страниц на основе Yandex.Wordstat</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Строение сайта и отдельных страниц на основе Yandex.Wordstat
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='stroenie-sajta-i-otdelnyix-stranicz-na-osnove-yandex.wordstat.html'>
                  <img alt='Строение сайта и отдельных страниц на основе Yandex.Wordstat' src='../assets/cache_image/resources/news/16/7/image_1600x487_9c7.png'>
                </a>
              </p>
              <p>Существуют различия в разработке структуры сайта и целевой страницы.</p>
<p>Стоит помнить, что строение сайта, лендинга и навигация должны быть максимально приближены к ожиданиям пользователя, так как удобство использования – это основное требование.</p>
<p>Отличие состоит в расположении материала на странице. Целевая страница не берет в расчет количество и частоту запросов в поисковиках, так как лендинг в общем-то не стремится к поисковой оптимизации.</p>
<p>Но при этом на сайте, например, <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">интернет-магазина</a>, все категории должны располагаться по убыванию: сначала более популярный запрос, потом – менее. Именно такая структура будет выгоднее при продвижении сайта в рейтинге поисковых систем. С помощью сервиса <a href="../../https@wordstat.yandex.com/default.htm" rel="nofollow" target="_blank">Yandex Wordstat</a> можно составить структуру, которая будет удобна в использовании, логично составлена и отвечать вопросам актуальности на данный момент.</p>
<h2>Соответствие между запросами и страницами сайта</h2>
<p>Перед тем, как начать разрабатывать структуру сайта, который в дальнейшем будет оптимизирован под SEO, необходимо создать семантическое ядро. Ведь именно с него начинается продвижение сайта. Для начала необходимо определить запросы, которые описывают содержание сайта. Их в свою очередь можно поделить на две группы: информационные и коммерческие.</p>
<p>В первую очередь учитываются коммерческие запросы. Ведь именно их задают потенциальные покупатели, так как они связаны с покупкой, продажей, арендой - всего того, что может иметь значение для эффективности данного сайта.</p>
<p>Во вторую очередь учитываются информационные запросы, которые чаще всего носят общий характер.</p>
<p>Коммерческие запросы лучше разместить на страницах, где осуществляется продажа товара, на страницах категорий. А информационные запросы, например «Как настроить Wi Fi» или «Как научиться играть на гитаре» лучше разместить на странице, где находится данная статья на эту тему.</p>
<p>Внимание! Чтобы правильно распределить список запросов между страницами сайта, не стоит их смешивать. Каждая страница должна быть релевантна с выбранными ключевыми словами, по которым идет ее продвижение.</p>
<h2>Составление структуры коммерческого раздела</h2>
<ul>
<li><span style="line-height:../1.5em;">Иерархия</span></li>
</ul>
<p><strong>Грамотная организация структуры сайта</strong> – важный этап в его оптимизации. Существует два основных вида иерархии – блоговая и книжная.</p>
<p>Блоговая структура является более распространенной и ее главная особенность заключается в динамике построения страниц – идет постоянная смена контента, появляются новые посты на смену старым. Данная иерархия пользуется у пользователей большей популярностью, так как включается в себя удобства поиска и просмотра различных материалов, а также дает возможность вывода анонсов.</p>
<p><strong>Книжная иерархия</strong> – стандартная организация структуры сайта. В отличие от блоговой, контент в рубриках данной структуры никогда не меняется.</p>
<ul>
<li><span style="line-height:../1.5em;">Категории</span></li>
</ul>
<p>Любой товар имеет свои разновидности и категории. Под разновидностью подразумеваются его форма, цвет, производитель и т.д. Поэтому есть смысл все запросы разделить на эти отдельные категории, а затем в каждой выделить самый высокочастотный.  Затем сравнить частотность и выбрать наиболее приоритетную рубрику.</p>
<p>С помощью A/B тестирования можно детально изучить поведение пользователей на сайте, поэтому рубрики можно составить с точки зрения эффективности и наибольшего количества запросов.</p>
<h3>Приоритет коммерческого раздела</h3>
<p>При создании сайта, который должен быть в топе и благоприятно влиять на ранжирование, нужно грамотно составить его структуру. Что это значит? Например, более популярные запросы ставить в начале страницы, а затем уже располагать менее популярные.</p>
<p>Структура коммерческой страницы</p>
<p>Любая страница сайта имеет тэги: TITLE, H1, навигационные цепочки, футер.</p>
<p>Самый популярный запрос должен стоять в TITLE. Далее по порядку сверху вниз: в заголовках, самом тексте и, наконец, в футере.</p>
<p>Например, у нас есть landing page, которая соответствует запросу «купить ноутбук». Yandex Wordstat автоматически подбирает запросы по введенным данным. Результат: 351 015 показов в месяц. Можно заметить, что в первую очередь пользователей интересуют цены, а также и компьютеры. К категории «купить ноутбук» можно отнести запросы  «ноутбуки цены» - 150 947 и  «купить компьютер» - 206 743.</p>
<p>Значит, в тэге TITLE будет стоять самый популярный запрос. В данном случае: «<em>купить ноутбук</em>».</p>
<p>В H1 – «<em>купить компьютер</em>»</p>
<p>В цепочках -  «<em>ноутбуки цены</em>».</p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" title="Структура коммерческой страницы" src="../resources/news/16/03/01/_25D0_2591_25D0_25B5_25D0_25B7_25D1_258B_25D0_25BC_25D1_258F_25D0_25BD_25D0_25BD_25D1_258B_25D0_25B9.png" alt="" width="628" height="391" /></p>
<h2>Структура информационного блога</h2>
<p>С точки зрения удобства восприятия информации, категории лучше разместить в левой части сайта, а блог – в правой. Названия рубрик в блоге соответствуют виду коммерческой деятельности, так как информационное содержание сайта эффективно выдвигает в топ коммерческие страницы.</p>
<p>Запросы и названия рубрик тоже взаимосвязаны. Наиболее высокочастотные запросы по теме рубрики ставятся в TITLE страницы. При продвижении сайта это правило всегда действует. Рубрика, которая стоит выше всех в меню, связана с самым популярным запросом. Остальные рубрики располагаются по убыванию частоты запросов.</p>
<p><strong>Продвижение сайта</strong> – это не только поисковая оптимизация, а также много факторов: внешние и внутренние (ссылочное ранжирование, HTML-разметка и др.) Мы можем помочь вам в плане <a href="../uslugi/prodvizhenie-sajtov/vnutrennyaya-optimizacziya-sajta.html">SEO-оптимизации</a>, с <a href="../uslugi/prodvizhenie-sajtov/kontekstnaya-reklama.html">контекстной рекламой</a>, а также в техническом аудите сайта.</p>
<p> </p>
			  <p><a class="button" onclick="sub_name('Строение сайта и отдельных страниц на основе Yandex.Wordstat','pikt')" href="#modalWindow">Проконсультироваться у специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="stroenie-sajta-i-otdelnyix-stranicz-na-osnove-yandex.wordstat.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Строение сайта и отдельных страниц на основе Yandex.Wordstat">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='stroenie-sajta-i-otdelnyix-stranicz-na-osnove-yandex.wordstat.html';
