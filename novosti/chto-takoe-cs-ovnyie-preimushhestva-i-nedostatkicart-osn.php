...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="CS-Cart – это профессиональный скрипт, который ориентирован на управление интернет-магазинами. Данная система, также как и Simpla, имеет открытый исходный код и распространяется на платной основе" />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>CS-Cart - основные преимущества и недостатки создания веб сайтов на CS-Cart | Студия веб дизайна REDLINE</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/cscart.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="CS-Cart"/>
<meta property="og:url" content="http://redline.by/novosti/chto-takoe-cs-ovnyie-preimushhestva-i-nedostatkicart-osn.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="CS-Cart" href="chto-takoe-cs-ovnyie-preimushhestva-i-nedostatkicart-osn.html"><span itemprop="title">CS-Cart</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Что такое CS-Cart? Основные преимущества и недостатки.</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-takoe-cs-ovnyie-preimushhestva-i-nedostatkicart-osn.html'>
                  <img alt='CS-Cart' src='../assets/cache_image/resources/cscart_1600x487_490.jpg'>
                </a>
              </p>
              <p><strong>Что такое </strong><strong>CS</strong><strong>-</strong><strong>Cart</strong></p>
<p>CS-Cart – это профессиональный скрипт, который ориентирован на управление <a href="../uslugi/razrabotka-sajtov/internet-magazin.html" target="_blank">интернет-магазинами</a>. Данная система, также как и Simpla, имеет открытый исходный код и распространяется на платной основе. CS-Cart разработана с использованием PHP и Smarty, кроме того используются Ajax элементы. Главным плюсом является наличие разнообразных платежных систем (более 50). Как и большинство других CMS она мультиязычна, а также предусматривает возможность расширения функционала посредством внедрения дополнительных модулей от сторонних разработчиков. Кроме того, система отлично интегрирована с 1C, Товары mail.ru и Яндекс.Маркет.</p>
<p><strong>Преимущества сайта на </strong><strong>CS</strong><strong>-</strong><strong>Cart</strong></p>
<p>1) Комфортная работа с товарами и заказами, с которой справится даже человек не имеющий навыков управления интернет-магазином.</p>
<p>2) Вы можете редактировать дизайн сайта, а также его отдельные элементы (например, карточку товара).</p>
<p>3) Удобная система наполнения контентом, реализованная с помощью фреймворка 960 Grid System.</p>
<p>4) Сайты на CS-Cart <a href="../uslugi/prodvizhenie-sajtov/default.htm">оптимизированы</a> по умолчанию, благодаря возможности простановки мета-тегов и использованию ЧПУ.</p>
<p>5) Широкие возможности предоставляемые конструктором отчетов, позволят настроить их с учетом всех Ваших потребностей.</p>
<p>6) Возможность создания резервных копий на тот случай, если произойдет технический сбой или Вы решите сменить хостинг.</p>
<p>7) В систему можно интегрировать любую из 50 доступных платежных систем, что, несомненно, добавит удобства для Ваших клиентов.</p>
<p>8) Сайты на CS-Cart обладают адаптивным дизайном, а это значит, что они будут одинаково хорошо отображаться, как с мобильных устройств, так и с ПК.</p>
<p>9) Развитое русскоязычное сообщество и форум, благодаря которому ни один Ваш вопрос не останется без ответа.</p>
<p><strong>Недостатки сайта на </strong><strong>CS</strong><strong>-</strong><strong>Cart</strong></p>
<p>Основным недостатком создания интернет-магазина на CS-Cart является высокая стоимость. Не все готовы платить за данный скрипт, с учетом того, что существуют более дешевые аналоги.</p>
<p><strong>Разработка сайта на </strong><strong>CS</strong><strong>-</strong><strong>Cart</strong><strong> в веб-студии </strong><strong>RedLine</strong></p>
<p>Специалисты <a href="../default.htm">веб-студии RedLine</a> имеют большой опыт разработки интернет-магазинов с использованием CS-Cart. Обратившись к нам, мы поможем разобраться с функционалом сайта, который необходим для решения задач Вашего проекта. Кроме того, мы тщательно проработаем несколько вариантов дизайна, а Вам, в свою очередь, останется выбрать наиболее привлекательный из них. В результате Вы получите современный интернет-магазин, который станет источником стабильного дохода.</p>
			  <p><a class="button" onclick="sub_name('CS-Cart','pikt')" href="#modalWindow">Заказать интернет-магазин на CS-Cart</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-takoe-cs-ovnyie-preimushhestva-i-nedostatkicart-osn.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="CS-Cart">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-takoe-cs-ovnyie-preimushhestva-i-nedostatkicart-osn.html';
