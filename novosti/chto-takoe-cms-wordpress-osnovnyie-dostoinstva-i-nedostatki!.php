...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Wordpress – это наиболее используемая система администрирования сайта. По популярности с ним может тягаться разве что Joomla. Распространенность данного движка оправдана, так как он обладает широким функционалом, который позволят реализовать любую задачу и создавать сайты различной сложности." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Что такое CMS Wordpress? Основные достоинства и недостатки!</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/wordpress.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Wordpress"/>
<meta property="og:url" content="http://redline.by/novosti/chto-takoe-cms-wordpress-osnovnyie-dostoinstva-i-nedostatki!.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Wordpress" href="chto-takoe-cms-wordpress-osnovnyie-dostoinstva-i-nedostatki!.html"><span itemprop="title">Wordpress</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Что такое CMS Wordpress? Основные достоинства и недостатки!</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-takoe-cms-wordpress-osnovnyie-dostoinstva-i-nedostatki!.html'>
                  <img alt='Wordpress' src='../assets/cache_image/resources/wordpress_1600x487_490.jpg'>
                </a>
              </p>
              <h2><strong>Что такое CMS </strong><strong>Wordpress</strong><strong>?</strong></h2>
<p>Wordpress – это наиболее используемая система администрирования сайта. По популярности с ним может тягаться разве что Joomla. Распространенность данного движка оправдана, так как он обладает широким функционалом, который позволят реализовать любую задачу и <a href="../uslugi/razrabotka-sajtov/default.htm">создавать сайты</a> различной сложности. Кроме того, его административная панель интуитивно понятна, а это значит, что с управлением сайта справится даже человек далекий от веб-разработки и программирования. Для работы Wordpress использует HTML, CSS, PHP, а также MySQL. Благодаря этому Вы сможете создать сайт на Wordpress на любом хостинге.</p>
<h3><strong>Достоинства сайта на </strong><strong>Wordpress</strong></h3>
<p>Открытый исходный код обеспечивает гибкость системы. На базе Wordpress Вы можете <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">создать интернет-магазин</a>, а также сайты, обладающие менее сложной структурой (например, <a href="../uslugi/razrabotka-sajtov/sajt-vizitka.html">сайт-визитка</a> или <a href="../uslugi/razrabotka-sajtov/korporativnyij-sajt/default.htm">корпоративный сайт</a>). Для данной системы администрирования создано огромное количество плагинов, которые, в большинстве своем, бесплатны и позволяют реализовать любой функционал в несколько кликов. Кроме того, существуют различные темы оформления, позволяющие оформить сайт в соответствии с Вашими потребностями. Стоит отметить, что сам движок абсолютно бесплатен, что является несомненным плюсом.</p>
<p>Как уже говорилось выше, с управлением сайта на Wordpress справится любой человек. Все разделы системы логически упорядочены, а наполнение сайта контентом осуществляется в 2 клика.</p>
<h3><strong>Варианты создания сайта на </strong><strong>Wordpress</strong></h3>
<p>Существует несколько путей создания веб-ресурса на данной CMS:</p>
<ol>
<li>Создание сайта с бесплатной темой оформления, переработанной под Ваши потребности;</li>
<li>Приобретение премиум-темы;</li>
<li>Разработка <a href="../uslugi/razrabotka-firmennogo-stilya.html">дизайна сайта</a> и функционала с учетом Ваших потребностей.</li>
</ol>
<p>Остановимся более подробно на каждом варианте.</p>
<p><strong>1) Бесплатная тема.</strong></p>
<p>Данный вариант предполагает использование бесплатной темы оформления. Однако не стоит беспокоиться о том, что Вы встретите на просторах интернета сайт, идентичный Вашему, так как мы производим его уникализацию в зависимости от целей и задач Вашего бизнеса. Установка бесплатной темы – наиболее дешевый способ создания сайта на Wordpress.</p>
<p>Однако бесплатные темы имеют множество неприятных минусов. Во-первых, как правило, их функционал достаточно скромен. И, зачастую, проще разработать тему с нуля, чем внедрить конкретный функционал в определенную тему. Во-вторых, Вы можете столкнуться с некорректной локализацией, так как большинство тем англоязычные. В-третьих, распространенной практикой является размещение скрытых ссылок в коде шаблона или и того хуже – вредоносного кода.</p>
<p><strong>2) Премиум-тема.</strong></p>
<p>Премиум-темы используются гораздо реже бесплатных шаблонов, а значит Вы вряд ли найдете сайт, который будет похож на Ваш. Шаблоны данного вида оснащены мощными инструментами, которые позволяют изменить их до неузнаваемости. Кроме того, большинство таких тем <a href="../uslugi/prodvizhenie-sajtov/default.htm">СЕО оптимизированы</a>, а это положительно отразится на ранжировании сайта.</p>
<p>Еще один плюсом премиум-тем можно считать более качественное исполнение, чем у бесплатных шаблонов, так как их разработкой занимаются профессионалы. Зачастую, современные премиум-темы имеют встроенный функционал, который обошелся бы гораздо дороже при создании сайта с нуля.</p>
<p>Но и у шаблонов данного вида есть свои минусы. Во-первых, опять-таки проблемы с русификацией, а во-вторых, благодаря огромному функционалу их настройка становится под силу лишь специалистам.</p>
<p><strong>3) Создание уникальной темы.</strong></p>
<p>Самый подходящий вариант, для проектов с широкими финансовыми возможностями. При создании темы с нуля будут учитываться все Ваши пожелания, а это позволит получить на выходе сайт, который будет иметь функционал соответствующий целям и задачам Вашего бизнеса. Само собой, Ваш сайт будет абсолютно уникальным и непохожим на другие веб-ресурсы.</p>
<p>Первым этапом создания уникальной темы является разработка нескольких вариантов макета. После чего утверждается один из них и наши специалисты приступают к верстке. Именно это позволяет достичь максимальной уникальности. Кроме того, при создании темы с нуля появляется возможность реализовывать нестандартные задачи недоступные на готовых шаблонах.</p>
<h2><strong>Что Вас ждет при создании сайта на </strong><strong>Wordpress</strong><strong> в студии </strong><strong>RedLine</strong><strong>?</strong></h2>
<p><strong>1) Уменьшение затраченных средств. </strong></p>
<p>Выбирая готовый шаблон, Вы затратите гораздо меньше средств, нежели при разработке темы с нуля.</p>
<p><strong>2) Сокращение время исполнения.</strong></p>
<p>Не нужно заниматься дополнительной работой, так как существует огромное количество готовых решений, которые помогут внедрить практически любой функционал.</p>
<p><strong>3) Возможность взглянуть на сайт до разработки.</strong></p>
<p>Все шаблоны можно предварительно увидеть и протестировать. Это очень удобно, так как можно досконально изучить все плюсы и минусы, которые можно не учесть глядя на картинку.</p>
<p><strong>4) Возможность исправления шаблона.</strong></p>
<p>Если Вам потребуется что-то изменить, то мы с легкостью внесем любые поправки в код.</p>
<p>Обратившись в <a href="../default.htm">студию веб-дизайна RedLine</a>, Вы получите в свое распоряжение сайт на Wordpress, который позволит с легкостью управлять Вашим бизнесом и вносить необходимые изменения в любой момент.</p>
			  <p><a class="button" onclick="sub_name('Wordpress','pikt')" href="#modalWindow">Заказать Сайт на CMS Wordpress</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-takoe-cms-wordpress-osnovnyie-dostoinstva-i-nedostatki!.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Wordpress">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-takoe-cms-wordpress-osnovnyie-dostoinstva-i-nedostatki!.html';
