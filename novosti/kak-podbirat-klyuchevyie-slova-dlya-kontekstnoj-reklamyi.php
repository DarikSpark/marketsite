...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/keywords-2.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Как подбирать ключевые слова для контекстной рекламы?"/>
<meta property="og:url" content="http://redline.by/novosti/kak-podbirat-klyuchevyie-slova-dlya-kontekstnoj-reklamyi.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Как подбирать ключевые слова для контекстной рекламы?" href="kak-podbirat-klyuchevyie-slova-dlya-kontekstnoj-reklamyi.html"><span itemprop="title">Как подбирать ключевые слова для контекстной рекламы?</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Как подбирать ключевые слова для контекстной рекламы?</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='kak-podbirat-klyuchevyie-slova-dlya-kontekstnoj-reklamyi.html'>
                  <img alt='Как подбирать ключевые слова для контекстной рекламы?' src='../assets/cache_image/resources/keywords-2_1600x487_490.jpg'>
                </a>
              </p>
              <h2>Что такое ключевые слова?</h2>
<p>Ключевые слова – это самый важный элемент, который определяет успешность <a href="../uslugi/kontekstnaya-reklama/default.htm">настройки контекстной рекламы</a>. При их неправильном подборе высока вероятность получить некачественный и нецелевой трафик, который будет иметь слабую конверсию. Для их грамотного составления необходимо учитывать какие запросы вводят посетители для того, чтобы найти Ваш товар или услугу. </p>
<h2><strong>Как не ошибиться с выбором ключевых слов?</strong></h2>
<p>Для того, чтобы правильно подобрать ключевые слова для контекстной рекламы и не спустить впустую весь бюджет, необходимо придерживаться некоторых правил.</p>
<p>1) Проанализировать статистику поисковых запросов за предыдущий месяц.</p>
<p>2) Стараться не использовать широкие запросы. Например, вместо «создать магазин» эффективнее будет использование запроса «<a href="../uslugi/razrabotka-sajtov/internet-magazin.html">заказать интернет-магазин в Минске</a>»</p>
<p>3) Стоит помнить, что очень часто пользователи вводят слова с ошибками. К примеру, согласно сервису подбора ключевиков, слово «видеорегистратор» имеет несколько ошибочных запросов: «видиорегистратор», «видеорегестратор» и «dbltjhtubcnhfnjh» (последний вариант будет в том случае, когда пользователь забыл переключить раскладку клавиатуры на русский язык). Кроме того, не стоит забывать о разговорных выражениях. Например, вместо слова «ресторан» многие люди употребляют «кабак» и т.д.</p>
<p>4) Также стоит сужать список запросов путем удаления ненужных слов. Если Вы занимаетесь продажей телевизоров и указываете в заголовке слово «телевизор», то <a href="../uslugi/kontekstnaya-reklama/default.htm">контекстная реклама</a> будет показываться для всех словосочетаний, которые содержат в себе данное слово («продать телевизор», «как починить телевизор», «телевизор LG» и т.д.)</p>
<p>На заключительном этапе определяются продвигаемые страницы, а также окончательный список запросов, по которым будут показываться контекстные объявления. Длина списка ключевиков определяется тем, насколько точно нацелена Ваша кампания.</p>
<h2><strong>Примеры подбора ключевых слов</strong></h2>
<p>Для большей наглядности приведем некоторые примеры. Предположим, что Ваша компания занимается предоставлением автомобилей на прокат в Минске.</p>
<table width="633" border="1" cellspacing="0" cellpadding="0">
<tbody>
<tr>
<td valign="top" width="311">
<p><strong>Неправильный вариант</strong></p>
</td>
...
<td valign="top" width="321">
<p>Взять напрокат автомобиль BMW</p>
</td>
</tr>
<tr>
<td valign="top" width="311">
<p>Взять автомобиль напрокат</p>
</td>
<td valign="top" width="321">
<p>Взять напрокат автомобиль в Минске</p>
</td>
</tr>
</tbody>
</table>
<p> </p>
<p>Таким образом, при использовании широких запросов, Вы получите кучу нецелевых посетителей, которым будут интересны темы несвязанные с деятельностью Вашей компании. Например, «починить автомобиль», «как покрасить автомобиль», «как заменить масло в BMW» и так далее.</p>
<p>Все это приводит к тому, что эффективность падает, а цена перехода заметно увеличивается. Если Вы все-таки решитесь использовать широкий вариант запроса, то необходимо прибегнуть к минус-словам. Например, добавьте в список: «покрасить», «починить», «заменить масло» и другие слова, которые напрямую не связаны с Вашей деятельностью. Хотя, чаще всего, первый вариант гораздо проще в реализации.</p>
<p>Минус-слова – это слова или словосочетания, по которым не будет показываться реклама. Их использование значительно увеличивает кликабельность объявления, что положительно сказывается на конверсии ресурса.</p>
<p>Как видите, подбор ключевых слов для контекстной рекламы достаточно сложный процесс, который требует наличие навыков работы с сервисом статистики ключевых слов, а также знаний основных принципов работы контекстных объявлений. Обратившись в <a href="../default.htm">веб-студию RedLine</a>, наши специалисты не только помогут подобрать ключевые слова, но и займутся комплексным ведением рекламной кампании, что положительно отразится на количестве заинтересованных посетителей.</p>
<p> </p>
			  <p><a class="button" onclick="sub_name('Как подбирать ключевые слова для контекстной рекламы?','pikt')" href="#modalWindow">Бесплатная консультация специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="kak-podbirat-klyuchevyie-slova-dlya-kontekstnoj-reklamyi.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Как подбирать ключевые слова для контекстной рекламы?">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='kak-podbirat-klyuchevyie-slova-dlya-kontekstnoj-reklamyi.html';
