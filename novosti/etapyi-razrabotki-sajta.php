...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Общие шаги при создании всех веб ресурсов - разработка технического задания,  разработка дизайна, верстка и программинг, размещение сайта в сети, наполнение сайта и техническая поддержка. " />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Этапы создания веб сайтов - основные шаги</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news4.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Этапы разработки веб  сайта"/>
<meta property="og:url" content="http://redline.by/novosti/etapyi-razrabotki-sajta.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Этапы разработки веб  сайта" href="etapyi-razrabotki-sajta.html"><span itemprop="title">Этапы разработки веб  сайта</span></a></li>
</ul>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='etapyi-razrabotki-sajta.html'>
                  <img alt='Этапы разработки веб  сайта' src='../assets/cache_image/resources/news4_1600x487_490.jpg'>
                </a>
              </p>
              <h2>КАК ПРОИСХОДИТ РАЗРАБОТКА САЙТА?</h2>
<p>Не все, желающие создать интернет-сайт, представляют <strong>процесс</strong> его разработки. Опишем подробно этапы. Хотя работа по <a href="../uslugi/razrabotka-sajtov/default.htm">разработке сайтов</a> для каждого нашего клиента процесс индивидуальный, есть <strong>общие шаги</strong> при создании всех веб ресурсов.</p>
<h3> <span style="font-size: 1.17em; line-height:../1.5em;">ТЕХНИЧЕСКОЕ ЗАДАНИЕ ДЛЯ САЙТА</span></h3>
<p><span style="line-height:../1.5em;">Прежде, чем что-то начинать, необходимо определиться с конечным результатом. На первом этапе мы выясняем все пожелания относительно проекта, для этого </span><strong style="line-height: 1.5em;">составляем техническое задание</strong><span style="line-height:../1.5em;"> (ТЗ). В ТЗ подробно описывается:</span></p>
<ul>
<li><span style="line-height:../1.5em;"><strong>цели веб-сайта</strong> и его целевая аудитория;</span></li>
<li><span style="line-height:../1.5em;"><strong>структура</strong> и количество страниц;</span></li>
<li><span style="line-height:../1.5em;">пожелания по <strong>дизайну</strong> (цвета, использование фирменного стиля и т.д.);</span></li>
<li><span style="line-height:../1.5em;">используемые технологии и <strong>функционал</strong>;</span></li>
<li><span style="line-height:../1.5em;">порядок предоставления, обработки или создания графической и текстовой информации;</span></li>
<li><span style="line-height:../1.5em;"><strong>технические требования</strong> к интернет-сайту.</span></li>
<li><span style="line-height:../1.5em;">На основе технического задания осуществляются все последующие этапы разработки веб-проекта, поэтому </span>тесное<strong style="line-height: 1.5em;"> сотрудничество</strong><span style="line-height:../1.5em;"> клиента и исполнителя в это время – залог успеха. Составление технического задания занимает 5-10 дней.</span></li>
</ul>
<h3><span style="font-size: 1.17em; line-height:../1.5em;"> РАЗРАБОТКА ДИЗАЙНА</span></h3>
<p><span style="line-height:../1.5em;">После утверждения технического задания, приступаем ко второму этапу - </span><a style="line-height: 1.5em;" href="../uslugi/dizajn-i-grafika/razrabotka-dizajn-maketa-v-psd.html">разработки дизайна</a><span style="line-height:../1.5em;"> веб-ресурса. На сроки и цену в этом случае влияет создание </span><strong style="line-height: 1.5em;">уникального</strong><span style="line-height:../1.5em;"> дизайна или использование </span>готового<span style="line-height:../1.5em;"><strong> шаблона</strong>, который адаптируется под тематику Вашей компании. В первом случае время на разработку дизайна занимает 1-2 недели, в случае готового шаблона – 2-3 дня.</span></p>
<h3><span style="font-size: 1.17em; line-height:../1.5em;">ВЕРСТКА И ПРОГРАММИРОВАНИЕ WEB-САЙТА</span></h3>
<p><span style="line-height:../1.5em;">После утверждения дизайн-макета начинается верстка веб-сайта – перевод дизайн-макета на язык HTML. На этапе программирования необходимо определить, на </span>какой <span style="line-height:../1.5em;"><strong>системе администрирования</strong> (</span><a style="line-height: 1.5em;" href="chto-vyibrat-cms-ili-framework.html">Content Management Site</a><span style="line-height:../1.5em;">) будет работать ваш сайт, говоря языком программистов - выбрать «<strong>движок</strong>». CMS может быть платной и бесплатной, решать большое количество задач по работе интернет-ресурсом и его содержимым. Этот этап занимает от 7 дней.</span></p>
<h3><span style="font-size: 1.17em; line-height:../1.5em;">РАЗМЕЩЕНИЕ WEB-САЙТА В СЕТИ</span></h3>
<p><span style="line-height:../1.5em;">Для публикации веб-ресурса </span>необходимо<span style="line-height:../1.5em;">: - приобрести <strong>доменное имя</strong> (адрес сайта) - выбрать </span><a style="line-height: 1.5em;" href="../publichnyij-dogovor/publichnyij-dogovor-okazaniya-uslug-xostinga.html">хостинг</a><span style="line-height:../1.5em;"> для веб-сайта – место, где Ваш сайт будет располагаться физически. Web-cтудия REDLINE сотрудничает с компанией, занимающейся хостингом сайтов.  Также мы </span><strong style="line-height: 1.5em;">оказываем поддержку</strong><span style="line-height:../1.5em;"> при выборе и покупке </span><a style="line-height: 1.5em;" href="vliyanie-domennogo-imeni-na-seo-sajta.html">доменного имени</a><span style="line-height:../1.5em;">.</span></p>
<h3><span style="font-size: 1.17em; line-height:../1.5em;">НАПОЛНЕНИЕ WEB-САЙТА</span></h3>
<p><a style="line-height: 1.5em;" href="napolnenie-sajta-kontentom.html">Наполнение сайта информацией</a><span style="line-height:../1.5em;"> – следующий важный этап в создании сайта. Клиент предоставляет </span><strong style="line-height: 1.5em;">имеющиеся материалы</strong><span style="line-height:../1.5em;"> (готовые рекламные буклеты, статьи, сертификаты, материалы для выставок и т.д.) и эта информация заносится на страницы ресурса. В случае, когда готовые материалы отсутствуют, мы </span><strong style="line-height: 1.5em;">можем помочь</strong><span style="line-height:../1.5em;"> с их составлением. Для этого оплачиваются услуги копирайтеров, которые пишут статьи под Вашу тематику, отвечающие всем требованиям качественного контента сайта. В целом, этот вариант выгоднее, чем трата времени своих сотрудников.</span></p>
<h3><span style="font-size: 1.17em; line-height:../1.5em;">ПОДДЕРЖКА WEB-САЙТА</span></h3>
<p><span style="line-height:../1.5em;">Поддержка сайта подразумевает под собой работу по </span><strong style="line-height: 1.5em;">своевременному обновлению</strong><span style="line-height:../1.5em;"> сайта и </span><strong style="line-height: 1.5em;">добавлению</strong><span style="line-height:../1.5em;"> на него информации, способствующей </span><a style="line-height: 1.5em;" href="../uslugi/prodvizhenie-sajtov/default.htm">продвижению</a><span style="line-height:../1.5em;"> его в поисковых системах, что позволяет приводить на сайт </span><strong style="line-height: 1.5em;">больше</strong><span style="line-height:../1.5em;"> посетителей и клиентов.</span></p>
<p>Web-cтудия <a href="../default.htm">REDLINE</a> сделает все, чтобы сайт был удобным и полезным как для посетителей, так и для сотрудников Вашей компании!</p>
			  <p><a class="button" onclick="sub_name('Этапы разработки веб  сайта','pikt')" href="#modalWindow">Заказать разработку сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="etapyi-razrabotki-sajta.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Этапы разработки веб  сайта">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='etapyi-razrabotki-sajta.html';
