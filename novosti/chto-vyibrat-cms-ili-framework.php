...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Content Management System – софт, используемый для создания сайта и управления его содержимым. С помощью CMS осуществляется наполнение и редактирование материалов.Framework – это платформа для создания сайтов в виде набора библиотек. Если CMS соответствует конструктору, то Framework скорее является 3D принтером, который позволяет воплотить в жизнь любую функциональную деталь." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Что выбрать для разработки сайта - CMS или Framework? | веб студия Редлайн</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/03/01/CMS-or-Framework-578x269.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Что выбрать: CMS или Framework?"/>
<meta property="og:url" content="http://redline.by/novosti/chto-vyibrat-cms-ili-framework.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Что выбрать: CMS или Framework?" href="chto-vyibrat-cms-ili-framework.html"><span itemprop="title">Что выбрать: CMS или Framework?</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Что выбрать для разработки сайта - CMS или Framework?</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='chto-vyibrat-cms-ili-framework.html'>
                  <img alt='Что выбрать: CMS или Framework?' src='../assets/cache_image/resources/news/16/03/01/CMS-or-Framework-578x269_1600x487_490.jpg'>
                </a>
              </p>
              <p align="justify">Content Management System – софт, используемый для <a href="../uslugi/razrabotka-sajtov/default.htm">создания сайта</a> и управления его содержимым. С помощью <a href="../tegi/populyarnie-cms.html">CMS</a> осуществляется наполнение и редактирование материалов. Любая CMS подобна детскому конструктору: она имеет множество разных по функционалу деталей, компонуя которые, можно добиться желаемого результата.</p>
<p align="justify">Каждая система имеет свои возможности и варианты дополнений, но все они ограничены рамками готового шаблона. Бывают узкоспециализированные CMS – укомплектованные <a href="../uslugi/razrabotka-sajtov/internet-magazin.html">интернет-магазины</a> или блоги. Некоторые системы универсальны: их можно адаптировать под любой проект. Движки могут быть платными и на бесплатной основе, но дополнительные функции и плагины в любом случае потребуют финансовых вложений.</p>
<p align="justify">Наиболее популярные бесплатные CMS:</p>
<ul>
<li><a href="chto-takoe-joomla-osnovnyie-preimushhestva-i-nedostatki!.html">Joomla</a> – довольно простая в изучении и использовании. Имеет большое количество готовых модулей не всегда хорошего качества. Часто обновляется.</li>
<li><a href="chto-takoe-cms-wordpress-osnovnyie-dostoinstva-i-nedostatki!.html">WordPress </a>– наиболее доступная система, легкая в изучении и применении. Огромное количество платный и бесплатных плагинов не всегда могут похвастаться корректной работой.</li>
<li><a href="chto-takoe-drupal-osnovnyie-preimushhestva-i-nedostatki!.html">Drupal</a> – универсальная CMS, требующая определенных знаний и опыта работы.</li>
<li><a href="chto-takoe-cms-modx.html">MODx </a>– достаточно эффективная система. Подходит для умелого подхода грамотного специалиста.</li>
<li><a href="chto-takoe-opencart-osnovnyie-preimushhestva-i-nedostatki.html">Open Cart</a> – специализированная программа для создания интернет-магазинов. Имеет готовые сборки, но требует определенных навыков в настройке.</li>
</ul>
<p>Часто используемые платные CMS:</p>
<ul>
<li><a href="razrabotka-sajtov-na-cms-1c-bitriks.html">1С Битрикс </a>– CMS от 1С, что обещает свободную интеграцию между этими программами. Однако разные модификации и версии не всегда работают совместно, может потребоваться их нештатная интеграция.</li>
<li>UMI.CMS – имеет несколько основных направлений, по которым созданы готовые сборки. <a href="../uslugi/razrabotka-sajtov/adaptivnaya-verstka.html">Адаптируется под мобильные устройства</a>.</li>
</ul>
<p style="text-align: center;"><img title="Наиболее популярные бесплатные CMS" src="../resources/news/16/03/01/gps_monitoring.png" alt="Наиболее популярные бесплатные CMS" width="700" height="295" /></p>
<h2>Плюсы и минусы CMS</h2>
<p align="justify">Мы перечислили далеко не полный список CMS, но все они имеют схожие характеристики. Независимо от возлагаемых надежд и ценности будущего сайта, чтобы сделать окончательный выбор, следует разобраться с тем, какие возможности предоставляют CMS и чего следует опасаться.</p>
<p><strong>Преимущества CMS</strong>:</p>
<ul>
<li>Скорость – готовый работающий шаблон с определенным набором функций можно создать за полчаса.</li>
<li>Простота – работа с CMS доступна даже программисту с небольшим опытом работы.</li>
<li>Доступность – невысокая планка специалиста делает создание сайтов с помощью CMS недорогим. В то же время, при расширении функционала Вам может понадобиться дорогостоящая помощь специалиста.</li>
<li>Схожесть – создав в выбранной Вами CMS один проект, Вы с легкостью сможете настроить следующий сайт. А имея соответствующий опыт, разберетесь и в работе других систем, поскольку функционал разных CMS перекликается друг с другом.</li>
</ul>
<p><strong>Недостатки CMS</strong>:</p>
<ul>
<li>Шаблонность – одинаковые блоки предоставляются всем пользователям. Разница лишь в том, как Вы их совместите. Впрочем, многие CMS предлагают готовые сборки для создания сайтов определенного назначения и тематики, что по-своему удобно, но ничем не выделит Вас на фоне других.</li>
<li>Ограниченность – готовые детали конструктора решают свой ограниченный функционал. Если Вы хотите большего, придется искать компромиссы или смириться с тем, что есть.</li>
<li>Неоптимизированный код – некоторые CMS генерируют ненужные строки кода, которые изрядно замусоривают конечный результат. Чистить код от лишнего – дело долгое и требует определенной подготовки, поэтому зачастую Вы получаете совершенно неоптимизированный код. Это увеличивает время загрузки сайта и понижает его выдачу в поисковых системах.</li>
<li>Отсутствие гибкости – Вам необходимо сразу создать структуру, подходящую контенту и целям. В дальнейшем можно вносить только незначительные изменения, а любой шаг в сторону уникальности превратиться в головную боль.</li>
</ul>
<h3>Когда на помощь приходит Framework?</h3>
<p align="justify">Framework – это платформа для создания сайтов в виде набора библиотек. Если CMS соответствует конструктору, то Framework скорее является 3D принтером, который позволяет воплотить в жизнь любую функциональную деталь. Существуют каркасы Framework для разных языков программирования: Java, Python, Ruby и т.д.</p>
<p align="justify">Виды бесплатных Framework, которые работают на PHP:</p>
<ul>
<li>Yii – имеет большое количество библиотек, что позволяет экономить время разработки, поэтому используется преимущественно для больших проектов.</li>
<li>Zend Framework – данный софт позволяет свободно редактировать отдельные части проекта, благодаря их минимальной взаимозависимости.</li>
<li><a href="sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-laravel.html">Laravel</a> и <a href="sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-codeigniter.html">CodeIgniter</a>  –  имеет качественный исходный код и широкую подборку готовых решений.</li>
</ul>
<p style="text-align: center;"><img title="Framework – это платформа для создания сайтов" src="../resources/news/16/03/01/framework.png" alt="Framework – это платформа для создания сайтов" width="500" height="383" /></p>
<h2>Плюсы и минусы Framework</h2>
<p><strong>Преимущества использования Framework</strong>:</p>
<ul>
<li>Высокая производительность – сайты загружаются быстро и оперативно реагируют на производимые действия.</li>
<li>Уникальность – Framework позволяет выполнить любое требование заказчика, реализовать самые смелые задумки.</li>
<li>Безопасность – процесс сборки сайта с помощью Framework дает возможность обнаружить и устранить все потенциально опасные дыры в безопасности.</li>
</ul>
<p align="justify">К недостаткам Framework можно отнести требовательность к исполнителю – для качественной работы с библиотеками нужны квалификация и опыт. Индивидуальных подход и решение нестандартных задач может потребовать определенное время и стоить дороже шаблонных решений.</p>
<h3>Делаем выбор между CMS и Framework</h3>
<p>Чтобы найти золотую середину между стоимостью проекта, дизайном и функциональностью, необходимо четко представлять, какой результат Вас устроит. Будет ли Вам достаточно шаблонного решения или Вы хотите представлять свою продукцию ресурсом высокого уровня? Насколько сложной и гибкой архитектуры требует специализация Вашего сайта?</p>
<p>Для предприятий малого и среднего бизнеса подойдет статичный недорогой CMS проект с типовым функционалом. Это может быть:</p>
<ul>
<li><a href="../uslugi/razrabotka-sajtov/sajt-vizitka.html">сайт-визитка</a>;</li>
<li><a href="../uslugi/razrabotka-sajtov/korporativnyij-sajt/default.htm">интернет-витрина</a>;</li>
<li>интернет-магазин с небольшим количеством клиентов.</li>
</ul>
<p>Если Ваш проект:</p>
<ul>
<li>требует нестандартных решений;</li>
<li>нуждается в нешаблонной верстке;</li>
<li>имеет высокую посещаемость;</li>
<li>активно развивается, изменяясь согласно рынку -</li>
</ul>
<p>стоит использовать <a href="../tegi/frejmvorki.html">Framework</a>, способный справится со всеми перечисленными задачами.</p>
<p>Разработку сайта на CMS или Фреймворке Вы можете в <a href="../default.htm">нашей </a>веб студии.</p>
<p> </p>
			  <p><a class="button" onclick="sub_name('Что выбрать: CMS или Framework?','pikt')" href="#modalWindow">Заказать разработку сайта</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="chto-vyibrat-cms-ili-framework.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Что выбрать: CMS или Framework?">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='chto-vyibrat-cms-ili-framework.html';
