...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Возможность выявлять живую аудиторию. Создавая группы ретаргетинга, повысить показатель кликабельности (CTR)." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Как повысить CTR (показатель кликабельности) в ВКонтакте</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/news/16/7/first.png"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Как повысить CTR (показатель кликабельности) в ВКонтакте"/>
<meta property="og:url" content="http://redline.by/novosti/kak-povyisit-ctr-(pokazatel-klikabelnosti)-v-vkontakte.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Возможность выявлять живую аудиторию. Создавая группы ретаргетинга, повысить показатель кликабельности (CTR)." href="kak-povyisit-ctr-(pokazatel-klikabelnosti)-v-vkontakte.html"><span itemprop="title">Как повысить CTR (показатель кликабельности) в ВКонтакте</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>Как повысить CTR (показатель кликабельности)  в ВКонтакте</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            <!--<div class='info'>
              <h1>
                Как повысить CTR (показатель кликабельности) в ВКонтакте
              </h1>
            ...
            <div class='content'>
              <p class='image'>
                <a href='kak-povyisit-ctr-(pokazatel-klikabelnosti)-v-vkontakte.html'>
                  <img alt='Как повысить CTR (показатель кликабельности) в ВКонтакте' src='../assets/cache_image/resources/news/16/7/first_1600x487_9c7.png'>
                </a>
              </p>
              <p>В данный момент социальная сеть <span class="wo fr-2" data-num="2">ВКонтакте</span> насчитывает около 350 миллионов пользователей. Сайт, который является первым по популярности в России, всё больше набирает обороты. Естественно, любая фирма, предлагающая свои услуги и товары, имеет желание сотрудничать с ним. Наверное, ваша реклама уже есть на этом сайте, поэтому вы и заинтересовались этой статьей.<br />Даже если у вас настройки <span class="wo fr-3" data-num="3">таргетинга</span> стоят правильно, CTR может не расти. При этом вы тратите всё больше денег. Есть для вас отличное решение. Немного усилий и времени – и ваша <a href="../uslugi/prodvizhenie-sajtov/targetingovaya-reklama-v-vk.com,-facebook.html">реклама</a> будет эффективно расти!</p>
<h2 style="text-align: center;"><br /><span>Подбор целевой аудитории</span></h2>
<p><br /><span>Скорее всего вам уже известно, кто ваша целевая аудитория, где этих людей можно найти. Эта информация важна для нас и она нам понадобится. Для начала найдите группы, в которых эти люди состоят. Сообщества отберите по принципу <strong>активности</strong>. В них должно быть много постов, комментариев к ним и лайков.</span><br /><span>Как понять, какая группа вам подходит? В ней должны быть постоянные обновления, желательно каждый день по несколько постов. Их должны комментировать и ставить к ним лайки. Комментариев должно быть более двух, лайков более 15. В общем, группа должна быть живой.</span><br /><br /><strong>Приведем пример</strong><br /><br /><img style="display: block; margin-left: auto; margin-right: auto;" title="Пример активной группы" src="../resources/news/16/7/_25D0_25A1_25D0_25BD_25D0_25B8_25D0_25BC_25D0_25BE_25D0_25BA.PNG" alt="" width="782" height="901" /><img style="display: block; margin-left: auto; margin-right: auto;" title="Пример активной группы" src="../resources/news/16/7/_25D0_25A1_25D0_25BD_25D0_25B8_25D0_25BC_25D0_25BE_25D0_25BA2.PNG" alt="" width="775" height="883" /></p>
<p><span>Яркий пример активной группы про моделей </span><em><span class="wo fr-4" data-num="4">Victoria</span>’s <span class="wo fr-5" data-num="5">Secret</span></em><span>. В данном случае мы видим всё: лайки, </span><span class="wo fr-6" data-num="6">репосты</span><span>, комментарии, обновления каждый день по 20 постов. Но внимательно относитесь к своей ЦА. Сообщества должны быть подобраны разумно.</span><br /><br /></p>
<h2 style="text-align: center;"><span>Приложение </span><span class="wo fr-7" data-num="7">Церебро</span><span> </span><span class="wo fr-8" data-num="8">Таргет</span></h2>
<p><span class="wo fr-8" data-num="8"><img style="display: block; margin-left: auto; margin-right: auto;" title="Приложение Церебро Таргет" src="../resources/news/16/7/xFYRIreOG6g.jpg" alt="" width="604" height="276" /></span></p>
<p> </p>
<p> </p>
<p><span>В </span><span class="wo fr-9" data-num="9">Вконтакте</span><span> есть интересное приложение - </span><span class="wo fr-10" data-num="10">Церебро</span><span> </span><span class="wo fr-11" data-num="11">таргет</span><span>.  Оно помогает отобрать активных пользователей из различных групп.</span><br /><span class="wo fr-12" data-num="12">Церебро</span><span> — инструмент, который используется для настройки </span><span class="wo fr-13" data-num="13">таргетированой</span><span> рекламы. Он дает возможность собрать аудиторию по самым разным параметрам. В приложении есть много возможностей для поиска различной информации: активные пользователи, обсуждения, фильтры и другое.</span><br /><span>В группе, которую мы выбрали в качестве примера, 14 930 участников.</span></p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" title="Количество участников группы" src="../resources/news/16/7/_25D0_25A1_25D0_25BD_25D0_25B8_25D0_25BC_25D0_25BE_25D0_25BA3.PNG" alt="" width="252" height="222" /><br /><span>Она нам отлично подходит, так как желательно выбрать группы где от 5 до 20 тысяч подписчиков. Затем копируем ссылку на нее и вставляем в </span><span class="wo fr-14" data-num="14">Церебро</span><span>. Количество активностей можем поставить для примера 3. И нажимаем «<em>Анализировать группу</em>».</span><br /><span>Получаем результат – 3 049 активных подписчиков! Получается, что из 14 тысяч данной группой интересуются всего лишь 3 тысячи. Разница достаточно велика. Нам нужны лишь эти активные 3 тысячи. Теперь этот список можно сохранить на компьютер. Он содержит </span><span class="wo fr-15" data-num="15">id</span><span> активных пользователей, которые нам понадобятся.</span></p>
<h2 style="text-align: center;"><br /><span class="wo fr-16" data-num="16">Ретаргетинг</span></h2>
<p><br /><span>Теперь из списка активных пользователей мы можем создать группу </span><span class="wo fr-17" data-num="17">ретаргетинга</span><span>. В нее загружаем один список или несколько сразу. Это делается следующим образом: «</span><em><span class="wo fr-18" data-num="18">Ретаргетинг</span></em><span><em> – Создать группу – Загрузить и сохранить»</em>. В дополнительных параметрах нужно добавить вашу группу, когда будете создавать объявления.</span></p>
<p><img style="display: block; margin-left: auto; margin-right: auto;" title="Ретаргетинг " src="../resources/news/16/7/05-11-201419-46-55.png" alt="" width="669" height="366" /><br /><span>Теперь нажимаем «<em>Сохранить»</em>. Запускаем рекламу. Можете быть уверены – теперь CTR будет только расти!</span><br /><br /><strong>Подведем итог:</strong><br /><span>• Всегда нужно тщательно подбирать ЦА. Ведь именно от нее зависит количество продаж.</span><br /><span>• Приложение</span><span class="wo fr-19" data-num="19"> </span><strong><span class="wo fr-20" data-num="20">Церебро</span> <span class="wo fr-21" data-num="21">Таргет</span></strong><span> дает уникальную возможность выявлять живую аудиторию, т. е. поможет создать список <em>только</em> активных людей в группах по интересам.</span><br /><span>• Создавая <strong>группы </strong></span><strong><span class="wo fr-22" data-num="22">ретаргетинга</span></strong><span>, вы сможете повысить показатель </span><span class="wo fr-23" data-num="23">кликабельности</span><span> (CTR), вместе с тем снизив цену клика в 3-5 раз.</span></p>
			  <p><a class="button" onclick="sub_name('Как повысить CTR (показатель кликабельности) в ВКонтакте','pikt')" href="#modalWindow">Проконсультироваться у специалиста</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="kak-povyisit-ctr-(pokazatel-klikabelnosti)-v-vkontakte.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Как повысить CTR (показатель кликабельности) в ВКонтакте">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='kak-povyisit-ctr-(pokazatel-klikabelnosti)-v-vkontakte.html';
