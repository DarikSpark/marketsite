...
<html class='no-js'>
  ...
  <head>
	...
	<base  />
     ...
     <meta name="description" content="Laravel – это мощная надстройка написанная на языке программирования PHP, которая позволяет разрабатывать сайты и различные веб-приложения. Данная надстройка имеет открытый исходный код и предоставляется бесплатно. В наше время Laravel считается одним из наиболее перспективных фреймворков, и множество веб-разработчиков останавливают свой выбор именно на нем, а не на Yii, который имеет статус самого распространенного русскоязычного PHP фреймворка." />
    <meta name="keywords" content="" />
    <!--
      hash is 464e0fb146194482a3ab153fc11e6346175a63f0
    -->
    <title>Разработка на фреймворке Laravel сайтов, порталов, CRM систем по индивидуальным пректам</title>
...
.top-bar .name h1 a, .top-bar .name .logo a {
    ...
    background-position: 17px 0px ;
		...
		<meta property="og:image" content="http://redline.by/resources/laravel.jpg"/>
<meta property="og:site_name" content="Red Line"/>
<meta property="og:title" content="Фреймворк Laravel"/>
<meta property="og:url" content="http://redline.by/novosti/sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-laravel.html"/>
...
<a href="../akcii.html" class="action-btn">Акции!</a>
 ...
 &rarr; <li class="B_lastCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb"><a class="B_currentCrumb" itemprop="url" rel="Фреймворк Laravel" href="sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-laravel.html"><span itemprop="title">Фреймворк Laravel</span></a></li>
</ul>

		 <div class='special-title centered-text'>
          <!--<i class='fa fa-newspaper-o'></i>-->
		 <div class="main-title">
			  <h1>В чем преимущество разработки сайтов на фреймворке Laravel</h1>
		</div>
		...
		<div class='large-12 columns news-block'>
		  ...
		  <div class='post'>
            ...
            <div class='content'>
              <p class='image'>
                <a href='sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-laravel.html'>
                  <img alt='Фреймворк Laravel' src='../assets/cache_image/resources/laravel_1600x487_490.jpg'>
                </a>
              </p>
              <h2><strong style="line-height: 1.5em;">Что такое фреймворк </strong><strong style="line-height: 1.5em;">Laravel?</strong></h2>
<p>Laravel – это мощная надстройка написанная на языке программирования PHP, которая позволяет разрабатывать сайты и различные веб-приложения. Данная надстройка имеет открытый исходный код и предоставляется бесплатно. В наше время Laravel считается одним из наиболее перспективных фреймворков, и множество веб-разработчиков останавливают свой выбор именно на нем, а не на Yii, который имеет статус самого распространенного русскоязычного PHP фреймворка. Данный программный каркас идеально подойдет для создания <a href="../uslugi/razrabotka-sajtov/korporativnyij-sajt/default.htm">корпоративных сайтов</a>, а также личных проектов.</p>
<h2><strong>Преимущества сайта на </strong><strong>Laravel</strong></h2>
<p><strong>1) Функциональность.</strong></p>
<p>Создание сайта на Laravel позволяет учесть даже самые мелкие пожелания по функциональности ресурса. С помощью данного PHP фреймворка возможно реализовать не только простые сайты (например, <a href="../uslugi/razrabotka-sajtov/lending.html" target="_blank">одностраничный сайт</a>), но и нестандартные проекты.</p>
<p><strong>2) Простота.</strong></p>
<p>Административная панель может изменяться в зависимости от конкретных пожеланий заказчика, что, в свою очередь, позволяет добиться максимального комфорта при управлении Вашим проектом.</p>
<p><strong>3) Несколько версий сайта.</strong></p>
<p>Большим преимуществом сайта на Laravel является возможность поддержки нескольких версий проекта. Это продиктовано тем, что зачастую нужна дополнительная версия сайта на которой можно проводить тестирование различных нововведений.</p>
<p><strong>4) Поддержка.</strong></p>
<p>Фреймворк постоянно обновляется создателями с учетом последних изменений в PHP, а также учитывая потребности веб-разработчиков, обусловленные появлением новых технологий.</p>
<p><strong>5) Масштабируемость.</strong></p>
<p>Большое внимание уделяется масштабируемости сайтов. Это значит, что Вы можете в любой момент вернуться к предыдущей версии проекта, если что-то пойдет не так как планировалось.</p>
<p><strong>6) Безопасность.</strong></p>
<p>Проектам разработанным на фреймворке Laravel не страшны SQL инъекции, а также имеется защита от CSRF и XSS атак. Благодаря этому Вы можете не беспокоиться за свою базу данных.</p>
<p><strong>Недостатки сайта на </strong><strong>Laravel</strong></p>
<p>Основным недостатком можно считать сырость данного фреймворка, что выражается отсутствии некоторых необходимых функций, а также плохой документации, которая не способствует быстрому изучению данной системы.</p>
<h2><strong>Разработка сайта на </strong><strong>Laravel</strong><strong> в веб-студии </strong><strong>RedLine</strong></h2>
<p>Специалисты <a href="../default.htm" target="_blank">студии веб-дизайна RedLine</a> хорошо знакомы со всеми особенностями данного программного каркаса, что, в свою очередь, гарантирует качественную реализацию всех поставленных задач.</p>
<p>При выполнении работ наши программисты учтут все особенности Вашего бизнеса и реализуют необходимый функционал отвечающий их требованиям. Кроме того, мы разработаем <a href="../uslugi/razrabotka-firmennogo-stilya.html" target="_blank">уникальный дизайн</a>, который будет не только эстетически привлекателен для посетителя, но и подтолкнет его на совершение необходимых действий.</p>
<p>Обращаясь в веб-студию RedLine, Вы получаете <a href="../uslugi/razrabotka-sajtov/default.htm" target="_blank">качественный сайт</a>, разработанный с использованием новейших веб-технологий.</p>
			  <p><a class="button" onclick="sub_name('Фреймворк Laravel','pikt')" href="#modalWindow">Заказать Сайт на Laravel</a></p>
  ...
  <div id="signup">
	<div id="signup-ct">
	  <div id="signup-header">
		...
		<a href="sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-laravel.html" class="modal_close" id="close" onclick="resets()"><i class="fa fa-times"></i></a>
	  </div>
	  <div id="result"></div>
		...
		<form method="post" id="form" action="../default.htm">
		  ...
		  <input type="hidden" name="place" value="Фреймворк Laravel">
...
<script type="text/javascript">
	  function sub_name(sub,refer)
	  {
		...
		var ref ='sozdanie-i-razrabotka-sajtov,-portalov,-crm-sistem-na-frejmvorke-laravel.html';
